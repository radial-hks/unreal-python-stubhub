## ResonanceAudioSpatializationSourceSettingsFactory Objects

```python
class ResonanceAudioSpatializationSourceSettingsFactory(Factory)
```

Resonance Audio Spatialization Source Settings Factory

**C++ Source:**

- **Plugin**: ResonanceAudio
- **Module**: ResonanceAudioEditor
- **File**: ResonanceAudioSpatializationSourceSettingsFactory.h
