## DMMaterialPropertySubsurfaceColor Objects

```python
class DMMaterialPropertySubsurfaceColor(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertySurfaceThickness"></a>