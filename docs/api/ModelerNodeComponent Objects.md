## ModelerNodeComponent Objects

```python
class ModelerNodeComponent(ModelerComponent)
```

Modeler Node Component

**C++ Source:**

- **Plugin**: AesModeler
- **Module**: AesModeler
- **File**: ModelerComponent.h
...
<a id="unreal.UrbanEntityModelerActor"></a>