## AnimGraphNode\_BlendSpaceEvaluator Objects

```python
class AnimGraphNode_BlendSpaceEvaluator(AnimGraphNode_BlendSpaceBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendSpaceEvaluator.h
...
- ``node`` (AnimNode_BlendSpaceEvaluator):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BlendSpaceGraphBase"></a>