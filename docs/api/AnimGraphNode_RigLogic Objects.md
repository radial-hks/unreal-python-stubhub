## AnimGraphNode_RigLogic Objects

```python
class AnimGraphNode_RigLogic(AnimGraphNode_Base)
```

Anim Graph Node Rig Logic

**C++ Source:**

- **Plugin**: RigLogic
- **Module**: RigLogicDeveloper
- **File**: AnimGraphNode_RigLogic.h
...
- ``node`` (AnimNode_RigLogic):  [Read-Write]
...
<a id="unreal.AnimationSharingStateProcessor"></a>