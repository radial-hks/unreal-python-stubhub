## BaseDaySequenceActor Objects

```python
class BaseDaySequenceActor(DaySequenceActor)
```
...
- ``day_sequence_collection`` (DaySequenceCollectionAsset):  [Read-Write]
...
- ``exponential_height_fog_component`` (ExponentialHeightFogComponent):  [Read-Only] Optional Components *
...
- ``sky_atmosphere_component`` (SkyAtmosphereComponent):  [Read-Only]
- ``sky_light_component`` (SkyLightComponent):  [Read-Only]
- ``sky_sphere_component`` (StaticMeshComponent):  [Read-Only]
- ``spawn_collision_handling_method`` (SpawnActorCollisionHandlingMethod):  [Read-Write] Controls how to handle spawning this actor in a situation where it's colliding with something else. "Default" means AlwaysSpawn here.
- ``sprite_scale`` (float):  [Read-Write] The scale to apply to any billboard components in editor builds (happens in any WITH_EDITOR build, including non-cooked games).
- ``sun_component`` (DirectionalLightComponent):  [Read-Only]
- ``sun_root_component`` (SceneComponent):  [Read-Only] Standard Components *
...
- ``volumetric_cloud_component`` (VolumetricCloudComponent):  [Read-Only]

<a id="unreal.BaseDaySequenceActor.sun_root_component"></a>

#### sun_root_component

```python
@property
def sun_root_component() -> SceneComponent
```

(SceneComponent):  [Read-Only] Standard Components *

<a id="unreal.BaseDaySequenceActor.sun_component"></a>

#### sun_component

```python
@property
def sun_component() -> DirectionalLightComponent
```

(DirectionalLightComponent):  [Read-Only]

<a id="unreal.BaseDaySequenceActor.sky_atmosphere_component"></a>

#### sky_atmosphere_component

```python
@property
def sky_atmosphere_component() -> SkyAtmosphereComponent
```

(SkyAtmosphereComponent):  [Read-Only]

<a id="unreal.BaseDaySequenceActor.sky_light_component"></a>

#### sky_light_component

```python
@property
def sky_light_component() -> SkyLightComponent
```

(SkyLightComponent):  [Read-Only]

<a id="unreal.BaseDaySequenceActor.exponential_height_fog_component"></a>

#### exponential_height_fog_component

```python
@property
def exponential_height_fog_component() -> ExponentialHeightFogComponent
```

(ExponentialHeightFogComponent):  [Read-Only] Optional Components *

<a id="unreal.BaseDaySequenceActor.volumetric_cloud_component"></a>

#### volumetric_cloud_component

```python
@property
def volumetric_cloud_component() -> VolumetricCloudComponent
```

(VolumetricCloudComponent):  [Read-Only]

<a id="unreal.BaseDaySequenceActor.sky_sphere_component"></a>

#### sky_sphere_component

```python
@property
def sky_sphere_component() -> StaticMeshComponent
```

(StaticMeshComponent):  [Read-Only]

<a id="unreal.DaySequenceCheatManagerExtension"></a>