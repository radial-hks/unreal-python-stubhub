## EarthDemOverlayerSettings Objects

```python
class EarthDemOverlayerSettings(EarthTextureOverlayerSettings)
```

Earth Dem Overlayer Settings
...
<a id="unreal.EarthDemOverlayerSettings.__init__"></a>
