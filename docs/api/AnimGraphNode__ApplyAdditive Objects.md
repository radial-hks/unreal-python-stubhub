## AnimGraphNode\_ApplyAdditive Objects

```python
class AnimGraphNode_ApplyAdditive(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_ApplyAdditive.h
...
- ``node`` (AnimNode_ApplyAdditive):  [Read-Write]
...
<a id="unreal.AnimGraphNode_ApplyLimits"></a>