## CreateParticleParams Objects

```python
class CreateParticleParams(ParamsBase)
```
...
<a id="unreal.CreateParticleParams.__init__"></a>
...
<a id="unreal.CreateParticleParams.particle_type"></a>
...
<a id="unreal.CreateParticleParams.point_entity_eid"></a>
...
<a id="unreal.CreateParticleParams.coord_z_ref"></a>
...
<a id="unreal.GetParticleParams"></a>