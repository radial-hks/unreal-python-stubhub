## AesEditorContextMenuItemWidget Objects

```python
class AesEditorContextMenuItemWidget(UserWidget)
```

Aes Editor Context Menu Item Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorMode
- **File**: AesEditorContextMenuItemWidget.h
...
- ``item_text`` (TextBlock):  [Read-Write]
- ``item_text_string`` (str):  [Read-Write]
...
<a id="unreal.AesEditorContextMenuItemWidget.item_text"></a>

#### item\_text

```python
@property
def item_text() -> TextBlock
```
...
```python
@item_text.setter
def item_text(value: TextBlock) -> None
```

<a id="unreal.AesEditorContextMenuItemWidget.item_text_string"></a>

#### item\_text\_string

```python
@property
def item_text_string() -> str
```
...
```python
@item_text_string.setter
def item_text_string(value: str) -> None
```

<a id="unreal.AesEditorContextMenuItemWidget.execute_command"></a>
...
x.execute_command() -> None
Execute Command

<a id="unreal.AesEditorContextMenuItemWidget.can_execute_command"></a>

#### can\_execute\_command

```python
def can_execute_command() -> bool
```

x.can_execute_command() -> bool
Can Execute Command

Returns:
    bool:

<a id="unreal.AesEditorContextMenuWidget"></a>