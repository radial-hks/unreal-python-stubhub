## ControlRigControlActor Objects

```python
class ControlRigControlActor(Actor)
```
...
- ``actor_to_track`` (Actor):  [Read-Write]
...
- ``cast_shadows`` (bool):  [Read-Write]
- ``color_parameter`` (str):  [Read-Write]
...
- ``refresh_on_tick`` (bool):  [Read-Write]
...
def refresh_on_tick(value: bool) -> None
```
...
def is_selectable(value: bool) -> None
```
...
def color_parameter(value: str) -> None
```
...
```python
@cast_shadows.setter
def cast_shadows(value: bool) -> None
```
...
x.reset_control_actor() -> None
Reset Control Actor

<a id="unreal.ControlRigControlActor.refresh"></a>
...
<a id="unreal.ControlRigControlActor.clear"></a>
...
<a id="unreal.ControlRigShapeActor"></a>