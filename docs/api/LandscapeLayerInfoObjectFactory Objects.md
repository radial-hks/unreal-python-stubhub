## LandscapeLayerInfoObjectFactory Objects

```python
class LandscapeLayerInfoObjectFactory(Factory)
```

Landscape Layer Info Object Factory

**C++ Source:**

- **Module**: LandscapeEditor
- **File**: LandscapeLayerInfoObjectFactory.h
...
<a id="unreal.LandscapePlaceholder"></a>