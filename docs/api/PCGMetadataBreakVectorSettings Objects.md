## PCGMetadataBreakVectorSettings Objects

```python
class PCGMetadataBreakVectorSettings(PCGMetadataSettingsBase)
```
...
<a id="unreal.PCGMetadataCompareSettings"></a>