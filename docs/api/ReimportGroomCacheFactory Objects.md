## ReimportGroomCacheFactory Objects

```python
class ReimportGroomCacheFactory(HairStrandsFactory)
```

Reimport Groom Cache Factory

**C++ Source:**

- **Plugin**: HairStrands
- **Module**: HairStrandsEditor
- **File**: ReimportGroomCacheFactory.h
...
<a id="unreal.ReimportHairStrandsFactory"></a>