## TextureRenderTargetVolumeFactoryNew Objects

```python
class TextureRenderTargetVolumeFactoryNew(Factory)
```
...
- **Module**: UnrealEd
- **File**: TextureRenderTargetVolumeFactoryNew.h
...
<a id="unreal.SkeletalMeshActor"></a>