## ChaosVDStaticMeshComponent Objects

```python
class ChaosVDStaticMeshComponent(StaticMeshComponent)
```
...
- **Plugin**: ChaosVD
- **Module**: ChaosVD
- **File**: ChaosVDStaticMeshComponent.h
...
<a id="unreal.ChaosVDRuntimeBlueprintLibrary"></a>