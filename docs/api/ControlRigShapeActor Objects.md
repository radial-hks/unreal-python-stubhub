## ControlRigShapeActor Objects

```python
class ControlRigShapeActor(Actor)
```
...
- ``hovered`` (bool):  [Read-Write] Whether this control is hovered
...
- ``selected`` (bool):  [Read-Write] Whether this control is selected
- ``spawn_collision_handling_method`` (SpawnActorCollisionHandlingMethod):  [Read-Write] Controls how to handle spawning this actor in a situation where it's colliding with something else. "Default" means AlwaysSpawn here.
- ``sprite_scale`` (float):  [Read-Write] The scale to apply to any billboard components in editor builds (happens in any WITH_EDITOR build, including non-cooked games).
- ``static_mesh_component`` (StaticMeshComponent):  [Read-Only] this is visual representation of the transform
...
```python
@property
def static_mesh_component() -> StaticMeshComponent
```

(StaticMeshComponent):  [Read-Only] this is visual representation of the transform

<a id="unreal.ControlRigShapeActor.selected"></a>
...
(bool):  [Read-Write] Whether this control is selected
...
<a id="unreal.ControlRigShapeActor.hovered"></a>
...
(bool):  [Read-Write] Whether this control is hovered
...
x.set_global_transform(transform) -> None
...
x.on_transform_changed(new_transform) -> None
...
x.on_selection_changed(is_selected) -> None
...
x.on_manipulating_changed(is_manipulating) -> None
...
x.on_hovered_changed(is_selected) -> None
...
x.on_enabled_changed(is_enabled) -> None
...
x.get_global_transform() -> Transform
Get Global Transform

Returns:
    Transform:

<a id="unreal.ControlRigGizmoActor"></a>