## AesPOIUserWidget Objects

```python
class AesPOIUserWidget(UserWidget)
```
...
- ``image`` (Image):  [Read-Write] End UUserWidget interface
...
<a id="unreal.AesPOIUserWidget.image"></a>
...
(Image):  [Read-Only] End UUserWidget interface

<a id="unreal.AesPOIUserWidget.text"></a>
