## InstancedStaticMeshComponent Objects
...
x.set_lod_distance_scale(lod_distance_scale) -> None
Sets the LOD scale.
...
x.add_instances(instance_transforms, should_return_indices, world_space=False, update_navigation=True) -> Array[int32]
