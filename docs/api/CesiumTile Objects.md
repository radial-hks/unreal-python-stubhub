...
```python
class CesiumTile(PrimitiveComponent)
```
...
<a id="unreal.CesiumTile.tile_bounds_overlaps_primitive"></a>

#### tile\_bounds\_overlaps\_primitive

```python
def tile_bounds_overlaps_primitive(other: PrimitiveComponent) -> bool
```

x.tile_bounds_overlaps_primitive(other) -> bool
...
<a id="unreal.CesiumTile.primitive_box_fully_contains_tile_bounds"></a>

#### primitive\_box\_fully\_contains\_tile\_bounds

```python
def primitive_box_fully_contains_tile_bounds(
        other: PrimitiveComponent) -> bool
```

x.primitive_box_fully_contains_tile_bounds(other) -> bool
...
<a id="unreal.CesiumTileExcluder"></a>