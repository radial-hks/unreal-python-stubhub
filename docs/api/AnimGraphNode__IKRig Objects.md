## AnimGraphNode\_IKRig Objects

```python
class AnimGraphNode_IKRig(AnimGraphNode_CustomProperty)
```
...
- ``node`` (AnimNode_IKRig):  [Read-Write]
...
<a id="unreal.AnimGraphNode_RetargetPoseFromMesh"></a>