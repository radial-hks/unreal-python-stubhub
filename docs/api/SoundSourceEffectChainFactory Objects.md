## SoundSourceEffectChainFactory Objects

```python
class SoundSourceEffectChainFactory(Factory)
```

Sound Source Effect Chain Factory
...
<a id="unreal.SoundSubmixEffectFactory"></a>