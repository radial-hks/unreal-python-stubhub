## EarthCameraComponent Objects

```python
class EarthCameraComponent(CameraComponent)
```

Earth Camera Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: EarthControl
- **File**: EarthCameraComponent.h
...
<a id="unreal.EarthCameraComponent.flying"></a>
...
```python
@flying.setter
def flying(value: bool) -> None
```

<a id="unreal.EarthCameraComponent.turn_rate"></a>

#### turn\_rate

```python
def turn_rate(axis_value: float) -> None
```

x.turn_rate(axis_value) -> None
Turn Rate

Args:
    axis_value (float):

<a id="unreal.EarthCameraComponent.stop_fly"></a>
...
<a id="unreal.EarthCameraComponent.reset_state"></a>
...
<a id="unreal.EarthControlActor"></a>