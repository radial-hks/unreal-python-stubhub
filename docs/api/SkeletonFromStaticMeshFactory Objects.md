## SkeletonFromStaticMeshFactory Objects

```python
class SkeletonFromStaticMeshFactory(Factory)
```

Skeleton from Static Mesh Factory
...
<a id="unreal.SkeletalMeshFromStaticMeshFactory"></a>