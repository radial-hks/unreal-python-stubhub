## WebMPlatFileMediaSourceFactory Objects

```python
class WebMPlatFileMediaSourceFactory(Factory)
```
...
- **Plugin**: WebMMedia
- **Module**: WebMMediaEditor
- **File**: WebMFileMediaSourceFactory.h
...
<a id="unreal.WmfFileMediaSourceFactory"></a>