## AnimGraphNode\_BlendSpaceGraphBase Objects

```python
class AnimGraphNode_BlendSpaceGraphBase(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendSpaceGraphBase.h
...
<a id="unreal.AnimGraphNode_BlendSpaceGraph"></a>