## WaterBodyRiverComponent Objects

```python
class WaterBodyRiverComponent(WaterBodyComponent)
```
...
- **Plugin**: Water
- **Module**: Water
- **File**: WaterBodyRiverComponent.h
...
- ``lake_transition_material`` (MaterialInterface):  [Read-Write] Material used when a river is overlapping a lake.
- ``lake_transition_mid`` (MaterialInstanceDynamic):  [Read-Only]
...
- ``ocean_transition_material`` (MaterialInterface):  [Read-Write] This is the material used when a river is overlapping the ocean.
- ``ocean_transition_mid`` (MaterialInstanceDynamic):  [Read-Only]
...
```python
@property
def lake_transition_material() -> MaterialInterface
```

(MaterialInterface):  [Read-Only] Material used when a river is overlapping a lake.
...
```python
@property
def ocean_transition_material() -> MaterialInterface
```

(MaterialInterface):  [Read-Only] This is the material used when a river is overlapping the ocean.
...
x.set_ocean_transition_material(mat) -> None
...
x.set_lake_transition_material(mat) -> None
...
def set_lake_and_ocean_transition_materials(
        lake_transition: MaterialInterface,
        ocean_transition: MaterialInterface) -> None
```

x.set_lake_and_ocean_transition_materials(lake_transition, ocean_transition) -> None
Set Lake and Ocean Transition Materials

Args:
    lake_transition (MaterialInterface): 
    ocean_transition (MaterialInterface):

<a id="unreal.WaterMeshComponent"></a>