## AvaTextCharacterTransform Objects

```python
class AvaTextCharacterTransform(Text3DCharacterTransform)
```
...
- **File**: AvaTextCharacterTransform.h
...
<a id="unreal.AvaText3DCharacterTransform"></a>