## AnimGraphNode\_LocalToComponentSpace Objects

```python
class AnimGraphNode_LocalToComponentSpace(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_LocalToComponentSpace.h
...
- ``node`` (AnimNode_ConvertLocalToComponentSpace):  [Read-Write]
...
<a id="unreal.AnimGraphNode_LookAt"></a>