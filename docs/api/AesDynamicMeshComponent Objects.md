## AesDynamicMeshComponent Objects

```python
class AesDynamicMeshComponent(DynamicMeshComponent)
```

Aes Dynamic Mesh Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesRenderResource
- **File**: AesDynamicMeshComponent.h
...
- ``triangle_count`` (int32):  [Read-Only] 三角面数量
...
- ``uv_count`` (int32):  [Read-Only] UV通道数量
- ``vertex_count`` (int32):  [Read-Only] 顶点数量
...
<a id="unreal.AesDynamicMeshComponent.allow_create_physics_state"></a>
...
<a id="unreal.AesDynamicMeshComponent.vertex_count"></a>
...
(int32):  [Read-Only] 顶点数量

<a id="unreal.AesDynamicMeshComponent.triangle_count"></a>
...
(int32):  [Read-Only] 三角面数量

<a id="unreal.AesDynamicMeshComponent.uv_count"></a>
...
(int32):  [Read-Only] UV通道数量

<a id="unreal.AesInstancedStaticMeshComponent"></a>