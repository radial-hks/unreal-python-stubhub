## CameraRigProxyAssetFactory Objects

```python
class CameraRigProxyAssetFactory(Factory)
```
...
- **File**: CameraRigProxyAssetFactory.h
...
<a id="unreal.CameraVariableCollectionFactory"></a>