## ComputeKernelFactory Objects

```python
class ComputeKernelFactory(Factory)
```

Compute Kernel Factory

**C++ Source:**

- **Plugin**: ComputeFramework
- **Module**: ComputeFrameworkEditor
- **File**: ComputeKernelFactory.h
...
<a id="unreal.ComputeKernelFromTextFactory"></a>