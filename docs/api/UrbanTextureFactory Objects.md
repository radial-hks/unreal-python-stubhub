## UrbanTextureFactory Objects

```python
class UrbanTextureFactory(TextureFactory)
```

Urban Texture Factory

**C++ Source:**

- **Plugin**: AesBuilderCommon
- **Module**: UrbanDataProvider
- **File**: UrbanTextureFactory.h
...
<a id="unreal.UrbanEntityVariable"></a>