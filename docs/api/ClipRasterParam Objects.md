## ClipRasterParam Objects

```python
class ClipRasterParam(ParamsBase)
```
...
<a id="unreal.ClipRasterParam.__init__"></a>
...
<a id="unreal.ClipRasterParam.eid"></a>
...
<a id="unreal.ClipRasterParam.polygon_entity_eid"></a>
...
<a id="unreal.ClipRasterParam.color"></a>
...
<a id="unreal.CoverRealTimeVideoStyle"></a>