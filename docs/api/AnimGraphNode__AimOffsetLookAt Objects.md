## AnimGraphNode\_AimOffsetLookAt Objects

```python
class AnimGraphNode_AimOffsetLookAt(AnimGraphNode_BlendSpaceBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_AimOffsetLookAt.h
...
- ``node`` (AnimNode_AimOffsetLookAt):  [Read-Write]
...
<a id="unreal.AnimGraphNode_SkeletalControlBase"></a>