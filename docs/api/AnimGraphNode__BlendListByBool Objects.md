## AnimGraphNode\_BlendListByBool Objects

```python
class AnimGraphNode_BlendListByBool(AnimGraphNode_BlendListBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendListByBool.h
...
- ``node`` (AnimNode_BlendListByBool):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BlendListByEnum"></a>