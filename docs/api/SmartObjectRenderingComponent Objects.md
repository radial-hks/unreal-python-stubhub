## SmartObjectRenderingComponent Objects

```python
class SmartObjectRenderingComponent(PrimitiveComponent)
```
...
- **File**: SmartObjectRenderingComponent.h
...
<a id="unreal.SmartObjectSubsystem"></a>