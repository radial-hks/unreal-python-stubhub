## MaterialFunctionMaterialLayerBlendFactory Objects

```python
class MaterialFunctionMaterialLayerBlendFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: MaterialFunctionMaterialLayerBlendFactory.h
...
<a id="unreal.MaterialFunctionMaterialLayerFactory"></a>