## CustomPoiIconWidgetBase Objects

```python
class CustomPoiIconWidgetBase(CoveringWidgetBase)
```

Custom Poi Icon Widget Base

**C++ Source:**

- **Plugin**: CoveringAPI
- **Module**: CoveringAPIEntity
- **File**: CustomPoiIconWidgetBase.h
...
<a id="unreal.CustomPoiIconWidgetBase.set_poi_entity_actor"></a>
...
<a id="unreal.CustomPoiIconWidgetBase.set_icon_visible2d_atom"></a>

#### set\_icon\_visible2d\_atom

```python
def set_icon_visible2d_atom(visible2d_atom: Visible2DAtom) -> bool
```

x.set_icon_visible2d_atom(visible2d_atom) -> bool
Set Icon Visible 2DAtom

Args:
    visible2d_atom (Visible2DAtom): 

Returns:
    bool:

<a id="unreal.CustomPoiIconWidgetBase.set_icon_url"></a>

#### set\_icon\_url

```python
def set_icon_url(url: str) -> bool
```

x.set_icon_url(url) -> bool
Set Icon Url
...
<a id="unreal.CustomPoiIconWidgetBase.set_icon_size"></a>

#### set\_icon\_size

```python
def set_icon_size(size: Vector2D) -> bool
```

x.set_icon_size(size) -> bool
Set Icon Size
...
<a id="unreal.CustomPoiIconWidgetBase.create_icon"></a>

#### create\_icon

```python
def create_icon(widget_component: WidgetComponent,
                visible2d_atom: Visible2DAtom) -> bool
```

x.create_icon(widget_component, visible2d_atom) -> bool
Create Icon
...
<a id="unreal.CustomPoiWidgetBase"></a>