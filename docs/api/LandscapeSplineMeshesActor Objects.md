## LandscapeSplineMeshesActor Objects

```python
class LandscapeSplineMeshesActor(PartitionActor)
```
...
- **Module**: Landscape
- **File**: LandscapeSplineMeshesActor.h
...
- ``static_mesh_components`` (Array[StaticMeshComponent]):  [Read-Only]
...
(Array[StaticMeshComponent]):  [Read-Only]

<a id="unreal.MaterialExpressionLandscapeLayerSample"></a>