## GetRealTimeVideoParams Objects

```python
class GetRealTimeVideoParams(ResultBase)
```

Get Real Time Video Params
...
<a id="unreal.GetRealTimeVideoParams.__init__"></a>
...
<a id="unreal.GetRealTimeVideoParams.point_entity_eid"></a>
...
<a id="unreal.GetRealTimeVideoParams.real_time_video_style"></a>
...
<a id="unreal.GetRealTimeVideoParams.coord_z_ref"></a>
...
<a id="unreal.CreateRealTimeVideosParams"></a>