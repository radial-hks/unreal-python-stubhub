## AesTerrainQuadMeshComponent Objects

```python
class AesTerrainQuadMeshComponent(StaticMeshComponent)
```

Aes Terrain Quad Mesh Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEarth
- **File**: AesTerrainQuadMeshComponent.h
...
<a id="unreal.UAesTerrainQuadMeshComponent"></a>