## ActorModifierCoreBlueprintFactory Objects

```python
class ActorModifierCoreBlueprintFactory(Factory)
```
...
- **Module**: ActorModifierCoreEditor
- **File**: ActorModifierCoreBlueprintFactory.h
...
<a id="unreal.DMMaterialComponent"></a>