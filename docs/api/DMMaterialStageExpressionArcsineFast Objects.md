## DMMaterialStageExpressionArcsineFast Objects

```python
class DMMaterialStageExpressionArcsineFast(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionArctangent"></a>