## MovieSceneRotatorTrack Objects

```python
class MovieSceneRotatorTrack(MovieScenePropertyTrack)
```
...
<a id="unreal.MovieSceneScalabilityCondition"></a>