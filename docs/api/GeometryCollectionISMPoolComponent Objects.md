## GeometryCollectionISMPoolComponent Objects

```python
class GeometryCollectionISMPoolComponent(SceneComponent)
```
...
- **File**: GeometryCollectionISMPoolComponent.h
...
<a id="unreal.GeometryCollection"></a>