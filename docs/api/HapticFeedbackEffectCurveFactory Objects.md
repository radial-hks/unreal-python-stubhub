## HapticFeedbackEffectCurveFactory Objects

```python
class HapticFeedbackEffectCurveFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: HapticFeedbackEffectCurveFactory.h
...
<a id="unreal.HapticFeedbackEffectSoundWaveFactory"></a>