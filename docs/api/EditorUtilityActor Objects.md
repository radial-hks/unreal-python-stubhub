## EditorUtilityActor Objects

```python
class EditorUtilityActor(Actor)
```
...
- ``receives_editor_input`` (bool):  [Read-Write] If set to true, then this actor will be able to recieve input delegate callbacks when in the editor.
...
(bool):  [Read-Write] If set to true, then this actor will be able to recieve input delegate callbacks when in the editor.
...
<a id="unreal.EditorUtilityActor.run"></a>
...
<a id="unreal.EditorAutomationActor"></a>