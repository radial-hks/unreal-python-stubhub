## MoviePipelineDeferredPass_LightingOnly Objects

```python
class MoviePipelineDeferredPass_LightingOnly(MoviePipelineDeferredPassBase)
```
...
<a id="unreal.MoviePipelineDeferredPass_ReflectionsOnly"></a>