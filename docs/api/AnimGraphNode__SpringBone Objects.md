## AnimGraphNode\_SpringBone Objects

```python
class AnimGraphNode_SpringBone(AnimGraphNode_SkeletalControlBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_SpringBone.h
...
- ``node`` (AnimNode_SpringBone):  [Read-Write]
...
<a id="unreal.AnimGraphNode_StateMachineBase"></a>