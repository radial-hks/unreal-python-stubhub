## MassStationaryVisualizationTrait Objects

```python
class MassStationaryVisualizationTrait(MassVisualizationTrait)
```
...
- **File**: MassStationaryVisualizationTrait.h
...
<a id="unreal.MassVisualizationComponent"></a>