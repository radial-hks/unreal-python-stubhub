## AnimGraphNode\_LinkedAnimGraphBase Objects

```python
class AnimGraphNode_LinkedAnimGraphBase(AnimGraphNode_CustomProperty)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_LinkedAnimGraphBase.h
...
<a id="unreal.AnimGraphNode_SubInstanceBase"></a>