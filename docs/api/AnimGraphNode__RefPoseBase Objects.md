## AnimGraphNode\_RefPoseBase Objects

```python
class AnimGraphNode_RefPoseBase(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_RefPoseBase.h
...
<a id="unreal.AnimGraphNode_IdentityPose"></a>