## MovieSceneBindingLifetimeSection Objects

```python
class MovieSceneBindingLifetimeSection(MovieSceneSection)
```
...
- **Module**: MovieScene
- **File**: MovieSceneBindingLifetimeSection.h
...
<a id="unreal.MovieSceneHookSection"></a>