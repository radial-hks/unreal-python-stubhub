## HapticFeedbackEffectSoundWaveFactory Objects

```python
class HapticFeedbackEffectSoundWaveFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: HapticFeedbackEffectSoundWaveFactory.h
...
<a id="unreal.HierarchicalLODVolume"></a>