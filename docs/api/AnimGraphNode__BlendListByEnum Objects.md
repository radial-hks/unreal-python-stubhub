## AnimGraphNode\_BlendListByEnum Objects

```python
class AnimGraphNode_BlendListByEnum(AnimGraphNode_BlendListBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendListByEnum.h
...
- ``node`` (AnimNode_BlendListByEnum):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BlendListByInt"></a>