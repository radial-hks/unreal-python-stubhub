## CesiumGltfPointsComponent Objects

```python
class CesiumGltfPointsComponent(CesiumGltfPrimitiveComponent)
```

Cesium Gltf Points Component

**C++ Source:**

- **Plugin**: CesiumForUnreal
- **Module**: CesiumRuntime
- **File**: CesiumGltfPointsComponent.h
...
<a id="unreal.CesiumGltfInstancedComponent"></a>