...
```python
@property
def lookat_tracking_settings() -> CameraLookatTrackingSettings
```

(CameraLookatTrackingSettings):  [Read-Write]
...
def lookat_tracking_settings(value: CameraLookatTrackingSettings) -> None
```
