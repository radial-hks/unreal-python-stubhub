## ZoneGraphTestingComponent Objects

```python
class ZoneGraphTestingComponent(PrimitiveComponent)
```
...
- ``advance_distance`` (float):  [Read-Write]
...
- ``custom_tests`` (Array[ZoneLaneTest]):  [Read-Write]
- ``detail_mode`` (DetailMode):  [Read-Write] If detail mode is >= system detail mode, primitive won't be rendered.
- ``draw_bv_tree_query`` (bool):  [Read-Write]
- ``draw_lane_path`` (bool):  [Read-Write] Experimental
- ``draw_lane_smoothing`` (bool):  [Read-Write]
- ``draw_lane_tangent_vectors`` (bool):  [Read-Write]
- ``draw_linked_lanes`` (bool):  [Read-Write]
...
- ``nearest_test_offset`` (Vector):  [Read-Write]
...
- ``other_actor`` (ZoneGraphTestingActor):  [Read-Write]
...
- ``query_filter`` (ZoneGraphTagFilter):  [Read-Write]
...
- ``search_extent`` (Vector):  [Read-Write]
...
<a id="unreal.ZoneGraphTestingComponent.enable_custom_tests"></a>

#### enable\_custom\_tests

```python
def enable_custom_tests() -> None
```

x.enable_custom_tests() -> None
Allow custom tests to be notified when lane location is updated.

<a id="unreal.ZoneGraphTestingComponent.disable_custom_tests"></a>

#### disable\_custom\_tests

```python
def disable_custom_tests() -> None
```

x.disable_custom_tests() -> None
...
<a id="unreal.ZoneGraphTestingActor"></a>