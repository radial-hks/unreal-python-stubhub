## DMMaterialStageExpressionInverseLinearInterpolate Objects

```python
class DMMaterialStageExpressionInverseLinearInterpolate(
...
- **File**: DMMSEInverseLinearInterpolate.h
...
<a id="unreal.DMMaterialStageExpressionLightmapUVs"></a>