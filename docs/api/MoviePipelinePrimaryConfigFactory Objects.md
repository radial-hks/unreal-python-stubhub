## MoviePipelinePrimaryConfigFactory Objects

```python
class MoviePipelinePrimaryConfigFactory(Factory)
```
...
- **File**: MoviePipelineConfigFactory.h
...
<a id="unreal.MoviePipelineShotConfigFactory"></a>