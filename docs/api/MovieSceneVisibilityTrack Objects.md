## MovieSceneVisibilityTrack Objects

```python
class MovieSceneVisibilityTrack(MovieScenePropertyTrack)
```
...
- **File**: MovieSceneVisibilityTrack.h
...
<a id="unreal.EngineCustomTimeStep"></a>