## MaterialParameterCollectionFactoryNew Objects

```python
class MaterialParameterCollectionFactoryNew(Factory)
```
...
- **Module**: UnrealEd
- **File**: MaterialParameterCollectionFactoryNew.h
...
<a id="unreal.MirrorDataTableFactory"></a>