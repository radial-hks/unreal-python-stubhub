## MovieSceneLensComponentTrack Objects

```python
class MovieSceneLensComponentTrack(MovieSceneNameableTrack)
```
...
- **File**: MovieSceneLensComponentTrack.h
...
<a id="unreal.MovieSceneLensComponentTrackRecorder"></a>