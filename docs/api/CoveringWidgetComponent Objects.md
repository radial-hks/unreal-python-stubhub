## CoveringWidgetComponent Objects

```python
class CoveringWidgetComponent(Covering3DWidgetComponent)
```

Covering Widget Component

**C++ Source:**

- **Plugin**: CoveringAPI
- **Module**: CoveringAPIEntity
- **File**: CoveringWidgetComponent.h
