## TextureRenderTargetVolume Objects
...
- **Module**: Engine
- **File**: TextureRenderTargetVolume.h
...
- ``size_z`` (int32):  [Read-Write] The depth of the texture.
...
```python
@size_z.setter
def size_z(value: int) -> None
```

<a id="unreal.TextureRenderTargetVolume.hdr"></a>
...
<a id="unreal.TimelineTemplate"></a>