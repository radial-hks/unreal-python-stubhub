## SkyCreatorWeatherPresetFactory Objects

```python
class SkyCreatorWeatherPresetFactory(Factory)
```

Sky Creator Weather Preset Factory

**C++ Source:**

- **Plugin**: SkyCreatorPlugin
- **Module**: SkyCreatorEditorPlugin
- **File**: SkyCreatorWeatherPresetFactory.h
