## AnimGraphNode\_CustomProperty Objects

```python
class AnimGraphNode_CustomProperty(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_CustomProperty.h
...
<a id="unreal.AnimGraphNode_StateResult"></a>