## DMMaterialStageExpressionRound Objects

```python
class DMMaterialStageExpressionRound(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionSceneColor"></a>