## DMMaterialStageExpressionDotProduct Objects

```python
class DMMaterialStageExpressionDotProduct(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionFloatModulo"></a>