## Basic2DTriangleSetComponent Objects

```python
class Basic2DTriangleSetComponent(BasicTriangleSetComponentBase)
```
...
- **File**: BasicTriangleSetComponent.h
...
<a id="unreal.Basic3DTriangleSetComponent"></a>