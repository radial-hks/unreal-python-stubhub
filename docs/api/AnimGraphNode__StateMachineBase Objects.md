## AnimGraphNode\_StateMachineBase Objects

```python
class AnimGraphNode_StateMachineBase(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_StateMachineBase.h
...
<a id="unreal.AnimGraphNode_StateMachine"></a>