## ViewAdjustedStaticMeshGizmoComponent Objects

```python
class ViewAdjustedStaticMeshGizmoComponent(StaticMeshComponent)
```
...
- **File**: ViewAdjustedStaticMeshGizmoComponent.h
