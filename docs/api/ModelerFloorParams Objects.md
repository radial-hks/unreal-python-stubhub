## ModelerFloorParams Objects

```python
class ModelerFloorParams(ActionParamsBase)
```

Modeler Floor Params

**C++ Source:**

- **Plugin**: AesRuntimeModeler
- **Module**: WdpModelerEntity
- **File**: PlaceModelerFloorAction.h
...
<a id="unreal.ModelerFloorParams.inner_mat_name"></a>
...
<a id="unreal.ModelerFloorParams.outer_mat_name"></a>
...
<a id="unreal.ModelerFloorParams.inner_height"></a>
...
<a id="unreal.ModelerFloorParams.outer_height"></a>
...
<a id="unreal.ModelerFloorParams.outer_width"></a>
...
<a id="unreal.ModelerFloorParams.corner_radius"></a>
...
<a id="unreal.ModelerFloorParams.corner_split_num"></a>
...
<a id="unreal.ModelerFloorParams.outer_uv_transform"></a>
...
<a id="unreal.ModelerFloorParams.inner_uv_transform"></a>
...
<a id="unreal.ModelerFloorParams.align_z"></a>
...
<a id="unreal.ModelerFloorParams.inverse_normal"></a>
...
<a id="unreal.ModelerFloorParams.inner_roughness"></a>
...
<a id="unreal.ModelerFloorParams.outer_roughness"></a>
...
<a id="unreal.ModelerFloorParams.inner_normal"></a>
...
<a id="unreal.ModelerFloorParams.outer_normal"></a>
...
<a id="unreal.ModelerFloorParams.inner_brightness"></a>
...
<a id="unreal.ModelerFloorParams.outer_brightness"></a>
...
<a id="unreal.VegetationEntity"></a>