## SoundSourceBusFactory Objects

```python
class SoundSourceBusFactory(Factory)
```

Sound Source Bus Factory

**C++ Source:**

- **Module**: AudioEditor
- **File**: SoundSourceBusFactory.h
...
<a id="unreal.SoundSourceEffectFactory"></a>