## ChaosVDInstancedStaticMeshComponent Objects

```python
class ChaosVDInstancedStaticMeshComponent(InstancedStaticMeshComponent)
```
...
- **Plugin**: ChaosVD
- **Module**: ChaosVD
- **File**: ChaosVDInstancedStaticMeshComponent.h
...
<a id="unreal.ChaosVDParticleActor"></a>