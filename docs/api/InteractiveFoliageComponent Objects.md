## InteractiveFoliageComponent Objects

```python
class InteractiveFoliageComponent(StaticMeshComponent)
```
...
- **Module**: Foliage
- **File**: InteractiveFoliageComponent.h
...
<a id="unreal.FoliageStatistics"></a>