## VREditorTeleporter Objects

```python
class VREditorTeleporter(Actor)
```
...
<a id="unreal.VREditorTeleporter.shutdown"></a>
...
<a id="unreal.VREditorTeleporter.init"></a>

#### init

```python
def init(mode: VREditorMode) -> None
```
...
<a id="unreal.VRScoutingInteractor"></a>