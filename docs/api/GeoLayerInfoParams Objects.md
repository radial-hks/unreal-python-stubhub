## GeoLayerInfoParams Objects

```python
class GeoLayerInfoParams(ResultBase)
```

Geo Layer Info Params
...
<a id="unreal.GeoLayerInfoParams.__init__"></a>
...
def __init__(message: str = "",
             ...
             geo_layer_symbol: GeoLayerSymbol = ["", "", []]) -> None
```

<a id="unreal.GeoLayerInfoParams.geo_layer_url"></a>
...
<a id="unreal.GeoLayerInfoParams.geo_layer_type"></a>
...
<a id="unreal.GeoLayerInfoParams.geo_layer_params"></a>
...
<a id="unreal.GeoLayerInfoParams.geo_feature_style"></a>
...
<a id="unreal.GeoLayerInfoParams.geo_layer_symbol"></a>
...
<a id="unreal.GeoLayerActionParams"></a>