## glTFRuntimeAssetActorAsync Objects

```python
class glTFRuntimeAssetActorAsync(Actor)
```

Gl TFRuntime Asset Actor Async

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: glTFRuntime
- **File**: glTFRuntimeAssetActorAsync.h
...
- ``show_while_loading`` (bool):  [Read-Write]
...
<a id="unreal.glTFRuntimeAssetActorAsync.asset"></a>
...
<a id="unreal.glTFRuntimeAssetActorAsync.static_mesh_config"></a>
...
<a id="unreal.glTFRuntimeAssetActorAsync.skeletal_mesh_config"></a>
...
<a id="unreal.glTFRuntimeAssetActorAsync.show_while_loading"></a>

#### show\_while\_loading

```python
@property
def show_while_loading() -> bool
```
...
```python
@show_while_loading.setter
def show_while_loading(value: bool) -> None
```

<a id="unreal.glTFRuntimeAssetActorAsync.static_meshes_as_skeletal"></a>
...
<a id="unreal.glTFRuntimeAssetActorAsync.asset_root"></a>
...
<a id="unreal.glTFRuntimeAssetActorAsync.receive_on_scenes_loaded"></a>

#### receive\_on\_scenes\_loaded

```python
def receive_on_scenes_loaded() -> None
```

x.receive_on_scenes_loaded() -> None
Receive on Scenes Loaded

<a id="unreal.glTFRuntimeFunctionLibrary"></a>