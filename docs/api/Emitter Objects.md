...
```python
@property
def particle_system_component() -> ParticleSystemComponent
```

(ParticleSystemComponent):  [Read-Only]
...
```python
@property
def post_update_tick_group() -> bool
```
...
def post_update_tick_group(value: bool) -> None
```
...
<a id="unreal.Emitter.deactivate"></a>
...
<a id="unreal.Emitter.activate"></a>
...
<a id="unreal.EmitterSpawnable"></a>