## CreatePathsParams Objects

```python
class CreatePathsParams(StructBase)
```
...
<a id="unreal.CreatePathsParams.__init__"></a>
...
<a id="unreal.CreatePathsParams.polyline_entity_eid"></a>
...
<a id="unreal.CreatePathsParams.path_style"></a>
...
<a id="unreal.CreatePathsParams.coord_z_ref"></a>
...
<a id="unreal.CreatePathParams_Batch"></a>