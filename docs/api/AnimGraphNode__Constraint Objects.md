## AnimGraphNode\_Constraint Objects

```python
class AnimGraphNode_Constraint(AnimGraphNode_SkeletalControlBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_Constraint.h
...
- ``node`` (AnimNode_Constraint):  [Read-Write]
...
<a id="unreal.AnimGraphNode_CopyBone"></a>