## ProceduralFoliageVolume Objects

```python
class ProceduralFoliageVolume(Volume)
```
...
- **Module**: Foliage
- **File**: ProceduralFoliageVolume.h
...
- ``procedural_component`` (ProceduralFoliageComponent):  [Read-Only]
...
```python
@property
def procedural_component() -> ProceduralFoliageComponent
```

(ProceduralFoliageComponent):  [Read-Only]

<a id="unreal.ProceduralFoliageActor"></a>