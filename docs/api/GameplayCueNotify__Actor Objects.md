## GameplayCueNotify\_Actor Objects

```python
class GameplayCueNotify_Actor(Actor)
```
...
- **File**: GameplayCueNotify_Actor.h
...
<a id="unreal.GameplayCueNotify_Actor.on_become_relevant"></a>

#### on\_become\_relevant

```python
def on_become_relevant(my_target: Actor,
                       parameters: GameplayCueParameters) -> bool
```

x.on_become_relevant(my_target, parameters) -> bool
...
<a id="unreal.GameplayCueNotify_Actor.on_cease_relevant"></a>

#### on\_cease\_relevant

```python
def on_cease_relevant(my_target: Actor,
                      parameters: GameplayCueParameters) -> bool
```

x.on_cease_relevant(my_target, parameters) -> bool
...
<a id="unreal.GameplayCueNotify_Actor.on_execute"></a>
...
<a id="unreal.GameplayCueNotify_Actor.on_burst"></a>

#### on\_burst

```python
def on_burst(my_target: Actor, parameters: GameplayCueParameters) -> bool
```

x.on_burst(my_target, parameters) -> bool
...
<a id="unreal.GameplayCueNotify_Actor.handle_gameplay_cue"></a>
...
<a id="unreal.GameplayCueNotify_Actor.end_gameplay_cue"></a>

#### end\_gameplay\_cue

```python
def end_gameplay_cue() -> None
```

x.end_gameplay_cue() -> None
...
<a id="unreal.GameplayCueNotify_Burst"></a>