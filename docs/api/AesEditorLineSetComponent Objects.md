## AesEditorLineSetComponent Objects

```python
class AesEditorLineSetComponent(MeshComponent)
```

Aes Editor Line Set Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorMode
- **File**: AesEditorLineSetComponent.h
...
<a id="unreal.AesBuildingPropertyUtils"></a>