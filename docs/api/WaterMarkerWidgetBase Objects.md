## WaterMarkerWidgetBase Objects

```python
class WaterMarkerWidgetBase(UserWidget)
```

Water Marker Widget Base

**C++ Source:**

- **Plugin**: CoveringAPI
- **Module**: CoveringAPIEntity
- **File**: WaterMarkerWidgetBase.h
...
<a id="unreal.WaterMarkerWidgetBase.water_marker_event"></a>

#### water\_marker\_event

```python
def water_marker_event(water_marker: WdpWatermarker) -> None
```

x.water_marker_event(water_marker) -> None
Water Marker Event

Args:
    water_marker (WdpWatermarker):

<a id="unreal.WebToImage"></a>