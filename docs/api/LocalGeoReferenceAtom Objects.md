## LocalGeoReferenceAtom Objects

```python
class LocalGeoReferenceAtom(EntityAtomBase)
```

Local Geo Reference Atom

**C++ Source:**

- **Plugin**: WdpDataModel
- **Module**: WdpCoordinate
- **File**: LocalGeoReferenceAtom.h
...
<a id="unreal.LocalGeoReferenceAtom.coord_type"></a>
...
<a id="unreal.LocalGeoReferenceAtom.scene_crs"></a>
...
<a id="unreal.LocalGeoReferenceAtom.api_crs"></a>
...
<a id="unreal.LocalGeoReferenceAtom.origin_location"></a>
...
<a id="unreal.LocalGeoReferenceAtom.origin_rotation"></a>
...
<a id="unreal.LocalGeoReferenceAtom.origin_scale"></a>
