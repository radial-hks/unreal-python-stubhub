## UpdateDependency Objects

```python
class UpdateDependency(StructBase)
```
...
<a id="unreal.UpdateDependency.__init__"></a>
...
<a id="unreal.UpdateDependency.dependency_entity"></a>
...
<a id="unreal.UpdateDependency.linked_atom_class"></a>
...
<a id="unreal.UpdateDependency.linked_atom_prop_name"></a>
...
<a id="unreal.AtomChangedProperty"></a>