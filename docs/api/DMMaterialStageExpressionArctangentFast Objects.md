## DMMaterialStageExpressionArctangentFast Objects

```python
class DMMaterialStageExpressionArctangentFast(DMMaterialStageExpressionMathBase
                                              )
```
...
<a id="unreal.DMMaterialStageExpressionCameraPositionWS"></a>