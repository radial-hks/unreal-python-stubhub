## UrbanBuildTemplateMeshComponent Objects

```python
class UrbanBuildTemplateMeshComponent(MeshComponent)
```

Urban Build Template Mesh Component
...
<a id="unreal.UrbanBuildTemplateMeshComponentFast"></a>