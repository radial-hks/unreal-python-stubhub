## ScreenshotFunctionalTestBase Objects

```python
class ScreenshotFunctionalTestBase(FunctionalTest)
```
...
- **File**: ScreenshotFunctionalTestBase.h
...
<a id="unreal.ScreenshotFunctionalTestBase.notes"></a>
...
```python
@property
def screenshot_camera() -> CameraComponent
```
...
```python
@property
def screenshot_options() -> AutomationScreenshotOptions
```

(AutomationScreenshotOptions):  [Read-Only]

<a id="unreal.FunctionalUIScreenshotTest"></a>