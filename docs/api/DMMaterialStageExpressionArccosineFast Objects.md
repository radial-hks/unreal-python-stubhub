## DMMaterialStageExpressionArccosineFast Objects

```python
class DMMaterialStageExpressionArccosineFast(DMMaterialStageExpressionMathBase
                                             )
```
...
<a id="unreal.DMMaterialStageExpressionArcsine"></a>