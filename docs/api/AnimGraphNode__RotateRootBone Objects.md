## AnimGraphNode\_RotateRootBone Objects

```python
class AnimGraphNode_RotateRootBone(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_RotateRootBone.h
...
- ``node`` (AnimNode_RotateRootBone):  [Read-Write]
...
<a id="unreal.AnimGraphNode_RotationMultiplier"></a>