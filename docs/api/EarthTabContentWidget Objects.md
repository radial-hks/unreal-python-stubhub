## EarthTabContentWidget Objects

```python
class EarthTabContentWidget(UserWidget)
```

Earth Tab Content Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: EarthTabContent.h
...
<a id="unreal.EarthTabContentWidget.content_data"></a>

#### content\_data

```python
@property
def content_data() -> DataTable
```
...
```python
@content_data.setter
def content_data(value: DataTable) -> None
```

<a id="unreal.EarthTabContentWidget.set_content_data"></a>

#### set\_content\_data

```python
def set_content_data(content_data: DataTable) -> None
```

x.set_content_data(content_data) -> None
Set Content Data

Args:
    content_data (DataTable):

<a id="unreal.EarthTabContentWidget.post_set_content_data"></a>

#### post\_set\_content\_data

```python
def post_set_content_data() -> None
```

x.post_set_content_data() -> None
Post Set Content Data

<a id="unreal.EarthTabContent"></a>