## DisplayClusterWidgetComponent Objects

```python
class DisplayClusterWidgetComponent(WidgetComponent)
```
...
- **File**: DisplayClusterWidgetComponent.h
...
<a id="unreal.DisplayClusterXformComponent"></a>