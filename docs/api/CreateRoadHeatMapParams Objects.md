## CreateRoadHeatMapParams Objects

```python
class CreateRoadHeatMapParams(ParamsBase)
```

Create Road Heat Map Params
...
<a id="unreal.CreateRoadHeatMapParams.__init__"></a>
...
<a id="unreal.CreateRoadHeatMapParams.coord_z_ref"></a>
...
<a id="unreal.CreateRoadHeatMapParams.road_heat_map_style"></a>
...
<a id="unreal.CreateRoadHeatMapParams.road_heat_map_data"></a>
...
<a id="unreal.GetRoadHeatMapParams"></a>