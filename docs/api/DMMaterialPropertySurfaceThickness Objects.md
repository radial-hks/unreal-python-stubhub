## DMMaterialPropertySurfaceThickness Objects

```python
class DMMaterialPropertySurfaceThickness(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyTangent"></a>