## PointsWidget Objects

```python
class PointsWidget(UserWidget)
```
...
- ``container_panel`` (CanvasPanel):  [Read-Write]
...
- ``point_widgets`` (Map[Guid, PointWidget]):  [Read-Write]
...
<a id="unreal.PointsWidget.container_panel"></a>

#### container\_panel

```python
@property
def container_panel() -> CanvasPanel
```

(CanvasPanel):  [Read-Only]

<a id="unreal.PointsWidget.point_widgets"></a>

#### point\_widgets

```python
@property
def point_widgets() -> Map[Guid, PointWidget]
```

(Map[Guid, PointWidget]):  [Read-Only]

<a id="unreal.PointWidget"></a>