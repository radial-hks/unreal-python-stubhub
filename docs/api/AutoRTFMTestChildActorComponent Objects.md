## AutoRTFMTestChildActorComponent Objects

```python
class AutoRTFMTestChildActorComponent(ChildActorComponent)
```

Auto RTFMTest Child Actor Component

**C++ Source:**

- **Module**: Engine
- **File**: AutoRTFMTestChildActorComponent.h
...
<a id="unreal.AutoRTFMTestPrimitiveComponent"></a>