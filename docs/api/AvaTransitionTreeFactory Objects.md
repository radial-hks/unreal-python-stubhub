## AvaTransitionTreeFactory Objects

```python
class AvaTransitionTreeFactory(Factory)
```

Ava Transition Tree Factory

**C++ Source:**

- **Plugin**: Avalanche
- **Module**: AvalancheTransitionEditor
- **File**: AvaTransitionTreeFactory.h
