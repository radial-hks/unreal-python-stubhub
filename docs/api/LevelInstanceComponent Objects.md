## LevelInstanceComponent Objects

```python
class LevelInstanceComponent(SceneComponent)
```
...
- ``edit_filter`` (WorldPartitionActorFilter):  [Read-Write]
- ``editable_when_inherited`` (bool):  [Read-Write] True if this component can be modified when it was inherited from a parent actor class
- ``filter`` (WorldPartitionActorFilter):  [Read-Write]
...
<a id="unreal.LevelInstanceEditorInstanceActor"></a>