## DMMaterialStageExpressionPower Objects

```python
class DMMaterialStageExpressionPower(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionReflectionVectorWS"></a>