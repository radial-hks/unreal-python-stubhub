## RuntimeVirtualTextureFactory Objects

```python
class RuntimeVirtualTextureFactory(Factory)
```
...
- **File**: RuntimeVirtualTextureFactory.h
...
<a id="unreal.VirtualTextureBuilderFactory"></a>