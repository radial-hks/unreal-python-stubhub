## MoviePipelineDeferredPass_DetailLighting Objects

```python
class MoviePipelineDeferredPass_DetailLighting(MoviePipelineDeferredPassBase)
```
...
<a id="unreal.MoviePipelineDeferredPass_LightingOnly"></a>