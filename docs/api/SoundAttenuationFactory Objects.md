## SoundAttenuationFactory Objects

```python
class SoundAttenuationFactory(Factory)
```

Sound Attenuation Factory

**C++ Source:**

- **Module**: AudioEditor
- **File**: SoundAttenuationFactory.h
...
<a id="unreal.SoundClassFactory"></a>