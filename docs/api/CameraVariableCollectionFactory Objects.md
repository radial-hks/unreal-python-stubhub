## CameraVariableCollectionFactory Objects

```python
class CameraVariableCollectionFactory(Factory)
```
...
- **File**: CameraVariableCollectionFactory.h
...
<a id="unreal.MagicCesiumGeoreference"></a>