## AnimGraphNode\_Fabrik Objects

```python
class AnimGraphNode_Fabrik(AnimGraphNode_SkeletalControlBase)
```
...
- ``node`` (AnimNode_Fabrik):  [Read-Write]
...
<a id="unreal.AnimGraphNode_HandIKRetargeting"></a>