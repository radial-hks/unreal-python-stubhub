## DataRegistryFactory Objects

```python
class DataRegistryFactory(Factory)
```

Data Registry Factory

**C++ Source:**

- **Plugin**: DataRegistry
- **Module**: DataRegistryEditor
- **File**: DataRegistryFactory.h
...
- ``data_registry_class`` (type(Class)):  [Read-Write]
...
<a id="unreal.GameFrameworkComponent"></a>