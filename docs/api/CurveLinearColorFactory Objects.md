## CurveLinearColorFactory Objects

```python
class CurveLinearColorFactory(CurveFactory)
```
...
- ``curve_class`` (type(Class)):  [Read-Write] The type of blueprint that will be created
...
<a id="unreal.CurveVectorFactory"></a>