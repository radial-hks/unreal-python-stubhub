## LocationVolume Objects

```python
class LocationVolume(Volume)
```
...
<a id="unreal.LocationVolume.unload"></a>
...
<a id="unreal.LocationVolume.load"></a>
