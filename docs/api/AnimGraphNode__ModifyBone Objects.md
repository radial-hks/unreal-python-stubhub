## AnimGraphNode\_ModifyBone Objects

```python
class AnimGraphNode_ModifyBone(AnimGraphNode_SkeletalControlBase)
```
...
- ``node`` (AnimNode_ModifyBone):  [Read-Write]
...
<a id="unreal.AnimGraphNode_ModifyCurve"></a>