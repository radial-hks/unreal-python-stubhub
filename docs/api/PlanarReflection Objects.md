...
- ``planar_reflection_component`` (PlanarReflectionComponent):  [Read-Only] Planar reflection component.
...
```python
@property
def planar_reflection_component() -> PlanarReflectionComponent
```
...
<a id="unreal.SceneCaptureComponent"></a>