## SVGBaseDynamicMeshComponent Objects

```python
class SVGBaseDynamicMeshComponent(DynamicMeshComponent)
```
...
- **Plugin**: SVGImporter
- **Module**: SVGImporter
- **File**: SVGBaseDynamicMeshComponent.h
...
<a id="unreal.JoinedSVGDynamicMeshComponent"></a>