## CreateRasterParams Objects

```python
class CreateRasterParams(ParamsBase)
```

Create Raster Params
...
<a id="unreal.CreateRasterParams.__init__"></a>
...
<a id="unreal.CreateRasterParams.coord_z_ref"></a>
...
<a id="unreal.CreateRasterParams.coord_z"></a>
...
<a id="unreal.CreateRasterParams.raster_style"></a>
