## AesStaticMeshComponent Objects

```python
class AesStaticMeshComponent(StaticMeshComponent)
```

Aes Static Mesh Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesRenderResource
- **File**: AesStaticMeshComponent.h
...
<a id="unreal.AesStaticMeshComponent.allow_create_physics_state"></a>
...
<a id="unreal.TrafficSpawnActor"></a>