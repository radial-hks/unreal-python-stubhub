## AnimGraphNode\_CCDIK Objects

```python
class AnimGraphNode_CCDIK(AnimGraphNode_SkeletalControlBase)
```
...
- ``node`` (AnimNode_CCDIK):  [Read-Write]
...
<a id="unreal.AnimGraphNode_ComponentToLocalSpace"></a>