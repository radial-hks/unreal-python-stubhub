## PreviewMeshCollectionFactory Objects

```python
class PreviewMeshCollectionFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: PreviewMeshCollectionFactory.h
...
<a id="unreal.PropertyEditorTestObject"></a>