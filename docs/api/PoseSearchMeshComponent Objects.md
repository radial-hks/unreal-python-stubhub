## PoseSearchMeshComponent Objects

```python
class PoseSearchMeshComponent(PoseableMeshComponent)
```

Pose Search Mesh Component

**C++ Source:**

- **Plugin**: PoseSearch
- **Module**: PoseSearchEditor
- **File**: PoseSearchMeshComponent.h
...
<a id="unreal.PoseSearchNormalizationSetFactory"></a>