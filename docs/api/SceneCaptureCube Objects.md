...
- ``capture_component_cube`` (SceneCaptureComponentCube):  [Read-Only] Scene capture component.
...
```python
@property
def capture_component_cube() -> SceneCaptureComponentCube
```
...
<a id="unreal.ShadowMapTexture2D"></a>