## UrbanGeoEdEntityComponent Objects

```python
class UrbanGeoEdEntityComponent(UrbanGeoEdComponent)
```

Urban Geo Ed Entity Component

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanGeoEd
- **File**: UrbanGeoEdEntityComponent.h
...
<a id="unreal.UrbanGeoEdNodeComponent"></a>