## MeshWireframeComponent Objects

```python
class MeshWireframeComponent(MeshComponent)
```
...
- ``boundary_edge_color`` (Color):  [Read-Write]
- ``boundary_edge_thickness`` (float):  [Read-Write]
...
- ``color_seam_color`` (Color):  [Read-Write]
- ``color_seam_thickness`` (float):  [Read-Write]
...
- ``enable_boundary_edges`` (bool):  [Read-Write] Boundary Edge properties
- ``enable_color_seams`` (bool):  [Read-Write] color seam properties
- ``enable_material_parameter_caching`` (bool):  [Read-Write]
- ``enable_normal_seams`` (bool):  [Read-Write] normal seam properties
- ``enable_tangent_seams`` (bool):  [Read-Write] tangent seam properties
- ``enable_uv_seams`` (bool):  [Read-Write] UV seam properties
- ``enable_wireframe`` (bool):  [Read-Write] Wireframe properties
...
- ``line_depth_bias`` (float):  [Read-Write] Depth bias of the lines, used to offset in depth to avoid z-fighting
- ``line_depth_bias_size_scale`` (float):  [Read-Write] Target-size depth bias scale. This is multiplied by LineDepthBias.
...
- ``normal_seam_color`` (Color):  [Read-Write]
- ``normal_seam_thickness`` (float):  [Read-Write]
...
- ``tangent_seam_color`` (Color):  [Read-Write]
- ``tangent_seam_thickness`` (float):  [Read-Write]
- ``thickness_scale`` (float):  [Read-Write] Scaling factor applied to the per-edge-type thicknesses defined below
...
- ``uv_seam_color`` (Color):  [Read-Write]
- ``uv_seam_thickness`` (float):  [Read-Write]
...
- ``wireframe_color`` (Color):  [Read-Write]
- ``wireframe_thickness`` (float):  [Read-Write]

<a id="unreal.PointSetComponent"></a>