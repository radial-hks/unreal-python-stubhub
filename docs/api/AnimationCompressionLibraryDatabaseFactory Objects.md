## AnimationCompressionLibraryDatabaseFactory Objects

```python
class AnimationCompressionLibraryDatabaseFactory(Factory)
```

Animation Compression Library Database Factory

**C++ Source:**

- **Plugin**: ACLPlugin
- **Module**: ACLPluginEditor
- **File**: AnimationCompressionLibraryDatabaseFactory.h
