## CreateParabolaParams Objects

```python
class CreateParabolaParams(ParamsBase)
```

Create Parabola Params
...
<a id="unreal.CreateParabolaParams.__init__"></a>
...
<a id="unreal.CreateParabolaParams.start_point_entity_eid"></a>
...
<a id="unreal.CreateParabolaParams.end_point_entity_eid"></a>
...
<a id="unreal.CreateParabolaParams.parabola_style"></a>
...
<a id="unreal.CreateParabolaParams.coord_z_ref"></a>
...
<a id="unreal.GetParabolaParams"></a>