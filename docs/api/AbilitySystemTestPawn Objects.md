## AbilitySystemTestPawn Objects

```python
class AbilitySystemTestPawn(DefaultPawn)
```
...
- **File**: AbilitySystemTestPawn.h

**Editor Properties:** (see get_editor_property/set_editor_property)

- ``ability_system_component`` (AbilitySystemComponent):  [Read-Only] DefaultPawn collision component
...
<a id="unreal.AbilitySystemTestPawn.ability_system_component"></a>
...
(AbilitySystemComponent):  [Read-Only] DefaultPawn collision component

<a id="unreal.AbilitySystemTestPawn.forward_gameplay_cue_to_parent"></a>
...
<a id="unreal.AnimNotify_GameplayCue"></a>