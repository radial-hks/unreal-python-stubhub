## WorldPartitionMiniMapVolume Objects

```python
class WorldPartitionMiniMapVolume(Volume)
```

World Partition Mini Map Volume

**C++ Source:**

- **Module**: Engine
- **File**: WorldPartitionMiniMapVolume.h
...
<a id="unreal.WorldPartitionReplay"></a>