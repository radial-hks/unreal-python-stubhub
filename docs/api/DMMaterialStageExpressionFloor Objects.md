## DMMaterialStageExpressionFloor Objects

```python
class DMMaterialStageExpressionFloor(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionInverseLinearInterpolate"></a>