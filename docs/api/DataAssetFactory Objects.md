## DataAssetFactory Objects

```python
class DataAssetFactory(Factory)
```
...
- ``data_asset_class`` (type(Class)):  [Read-Write]
...
<a id="unreal.DebugSkelMeshComponent"></a>