## DisplayClusterStageActorComponent Objects

```python
class DisplayClusterStageActorComponent(ActorComponent)
```
...
- **File**: DisplayClusterStageActorComponent.h
...
<a id="unreal.DisplayClusterChromakeyCardStageActorComponent"></a>