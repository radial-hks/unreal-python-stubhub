## AesEditorContextMenuWidget Objects

```python
class AesEditorContextMenuWidget(UserWidget)
```

Aes Editor Context Menu Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorMode
- **File**: AesEditorContextMenuWidget.h
...
- ``menu_item_container`` (VerticalBox):  [Read-Write]
- ``menu_item_widget_class`` (SoftClassPath):  [Read-Write]
- ``menu_root`` (PanelWidget):  [Read-Write]
...
<a id="unreal.AesEditorContextMenuWidget.menu_item_container"></a>

#### menu\_item\_container

```python
@property
def menu_item_container() -> VerticalBox
```
...
```python
@menu_item_container.setter
def menu_item_container(value: VerticalBox) -> None
```

<a id="unreal.AesEditorContextMenuWidget.menu_root"></a>

#### menu\_root

```python
@property
def menu_root() -> PanelWidget
```
...
```python
@menu_root.setter
def menu_root(value: PanelWidget) -> None
```

<a id="unreal.AesEditorIndicatorWidget"></a>