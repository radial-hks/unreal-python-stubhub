## SparseVolumeTextureViewerComponent Objects

```python
class SparseVolumeTextureViewerComponent(PrimitiveComponent)
```
...
- ``apply_per_frame_transforms`` (bool):  [Read-Write]
...
- ``pivot_at_centroid`` (bool):  [Read-Write]
- ``playing`` (bool):  [Read-Write]
- ``preview_attribute`` (SparseVolumeTexturePreviewAttribute):  [Read-Write]
...
- ``reverse_playback`` (bool):  [Read-Write]
...
- ``sparse_volume_texture_preview`` (SparseVolumeTexture):  [Read-Write]
...
```python
@property
def sparse_volume_texture_preview() -> SparseVolumeTexture
```
...
def sparse_volume_texture_preview(value: SparseVolumeTexture) -> None
```

<a id="unreal.SparseVolumeTextureViewerComponent.frame"></a>
...
<a id="unreal.SparseVolumeTextureViewerComponent.playing"></a>
...
```python
@playing.setter
def playing(value: bool) -> None
```

<a id="unreal.SparseVolumeTextureViewerComponent.looping"></a>
...
```python
@property
def apply_per_frame_transforms() -> bool
```
...
```python
@property
def preview_attribute() -> SparseVolumeTexturePreviewAttribute
```

(SparseVolumeTexturePreviewAttribute):  [Read-Write]
...
def preview_attribute(value: SparseVolumeTexturePreviewAttribute) -> None
```
...
<a id="unreal.SparseVolumeTextureViewerComponent.extinction"></a>

#### extinction

```python
@property
def extinction() -> float
```
...
```python
@extinction.setter
def extinction(value: float) -> None
```
