## AnimGraphNode\_LiveLinkPose Objects

```python
class AnimGraphNode_LiveLinkPose(AnimGraphNode_Base)
```

Anim Graph Node Live Link Pose

**C++ Source:**

- **Plugin**: LiveLink
- **Module**: LiveLinkGraphNode
- **File**: AnimGraphNode_LiveLinkPose.h
...
- ``node`` (AnimNode_LiveLinkPose):  [Read-Write]
...
<a id="unreal.MovieSceneLiveLinkSection"></a>