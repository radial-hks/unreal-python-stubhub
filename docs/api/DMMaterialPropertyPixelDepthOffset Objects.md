## DMMaterialPropertyPixelDepthOffset Objects

```python
class DMMaterialPropertyPixelDepthOffset(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyRefraction"></a>