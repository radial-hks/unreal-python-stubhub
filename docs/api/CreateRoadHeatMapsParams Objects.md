## CreateRoadHeatMapsParams Objects

```python
class CreateRoadHeatMapsParams(StructBase)
```

Create Road Heat Maps Params
...
<a id="unreal.CreateRoadHeatMapsParams.__init__"></a>
...
<a id="unreal.CreateRoadHeatMapsParams.coord_z_ref"></a>
...
<a id="unreal.CreateRoadHeatMapsParams.road_heat_map_style"></a>
...
<a id="unreal.CreateRoadHeatMapsParams.road_heat_map_data"></a>
...
<a id="unreal.CreateRoadHeatMapParams_Batch"></a>