## GeometryCollectionISMPoolDebugDrawComponent Objects

```python
class GeometryCollectionISMPoolDebugDrawComponent(DebugDrawComponent)
```
...
- **File**: GeometryCollectionISMPoolDebugDrawComponent.h
...
- ``show_bounds`` (bool):  [Read-Write]
- ``show_global_stats`` (bool):  [Read-Write]
- ``show_stats`` (bool):  [Read-Write]
...
<a id="unreal.NavigationGraphNode"></a>