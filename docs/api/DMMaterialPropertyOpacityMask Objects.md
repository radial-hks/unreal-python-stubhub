## DMMaterialPropertyOpacityMask Objects

```python
class DMMaterialPropertyOpacityMask(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyPixelDepthOffset"></a>