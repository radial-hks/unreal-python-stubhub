## PropertyViewBase Objects

```python
class PropertyViewBase(Widget)
```
...
```python
@property
def on_property_changed() -> OnPropertyValueChanged
```
...
def on_property_changed(value: OnPropertyValueChanged) -> None
```
