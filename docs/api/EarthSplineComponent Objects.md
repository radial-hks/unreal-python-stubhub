## EarthSplineComponent Objects

```python
class EarthSplineComponent(SplineComponent)
```
...
- ``feature_id`` (int64):  [Read-Write] 实体识别码
...
- ``prefab_asset`` (EarthPrefabAsset):  [Read-Write] 匹配的预制体资产
...
- ``spatial_data`` (InstancedStruct):  [Read-Write] 空间预制体数据
- ``spatial_data_type`` (EarthSpatialDataType):  [Read-Write] 空间数据类型
...
<a id="unreal.EarthSplineComponent.spatial_data_type"></a>

#### spatial\_data\_type

```python
@property
def spatial_data_type() -> EarthSpatialDataType
```

(EarthSpatialDataType):  [Read-Write] 空间数据类型
...
```python
@spatial_data_type.setter
def spatial_data_type(value: EarthSpatialDataType) -> None
```

<a id="unreal.EarthSplineComponent.spatial_data"></a>

#### spatial\_data

```python
@property
def spatial_data() -> InstancedStruct
```

(InstancedStruct):  [Read-Write] 空间预制体数据
...
```python
@spatial_data.setter
def spatial_data(value: InstancedStruct) -> None
```

<a id="unreal.EarthSplineComponent.feature_id"></a>
...
<a id="unreal.EarthSplineComponent.prefab_asset"></a>
...
(EarthPrefabAsset):  [Read-Write] 匹配的预制体资产
...
<a id="unreal.EarthSplineComponent.update_spatial_data"></a>
...
<a id="unreal.EarthSplineComponent.set_spatial_data_type"></a>
...
<a id="unreal.EarthSplineComponent.set_spatial_data"></a>
...
<a id="unreal.EarthSplineComponent.get_spatial_data_type"></a>
...
<a id="unreal.EarthSplineComponent.get_spatial_data"></a>
...
<a id="unreal.EarthInstancedStaticMeshAlgorithm"></a>