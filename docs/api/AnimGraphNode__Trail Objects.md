## AnimGraphNode\_Trail Objects

```python
class AnimGraphNode_Trail(AnimGraphNode_SkeletalControlBase)
```
...
- ``node`` (AnimNode_Trail):  [Read-Write]
...
<a id="unreal.AnimGraphNode_TransitionPoseEvaluator"></a>