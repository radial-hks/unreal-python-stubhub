## WdpGravityMovementComponent Objects

```python
class WdpGravityMovementComponent(CharacterMovementComponent)
```

Wdp Gravity Movement Component

**C++ Source:**

- **Plugin**: WdpCamera
- **Module**: WdpCamera
- **File**: WdpGravityMovementComponent.h
...
- ``auto_update_gravity`` (bool):  [Read-Write] 是否自动更新重力方向
...
- ``show_debug_lines`` (bool):  [Read-Write] When moving debug lines are shown - velocity, acceleration
...
<a id="unreal.WdpGravityMovementComponent.world_origin_anchor"></a>
...
<a id="unreal.WdpGravityMovementComponent.set_wdp_gravity_direction"></a>

#### set\_wdp\_gravity\_direction

```python
def set_wdp_gravity_direction(new_gravity_direction: Vector) -> None
```

x.set_wdp_gravity_direction(new_gravity_direction) -> None
Set a custom gravity direction; use 0, 0, 0 to remove any custom direction.
note: It can be influenced by GravityScale.

Args:
    new_gravity_direction (Vector): New gravity direction, assumes it isn't normalize

<a id="unreal.WdpGravityMovementComponent.init_world_origin_anchor"></a>
...
<a id="unreal.WdpGravityMovementComponent.get_wdp_gravity_direction"></a>

#### get\_wdp\_gravity\_direction

```python
def get_wdp_gravity_direction(avoid_zero_gravity: bool = False) -> Vector
```

x.get_wdp_gravity_direction(avoid_zero_gravity=False) -> Vector
Return the normalized direction of the current gravity.
note: Could return zero gravity.

Args:
    avoid_zero_gravity (bool): If true, zero gravity isn't returned.

Returns:
    Vector: Normalized direction of current gravity

<a id="unreal.WdpGravityMovementComponent.auto_update_gravity_direction"></a>

#### auto\_update\_gravity\_direction

```python
def auto_update_gravity_direction() -> None
```

x.auto_update_gravity_direction() -> None
更新重力方向

<a id="unreal.WdpMath"></a>