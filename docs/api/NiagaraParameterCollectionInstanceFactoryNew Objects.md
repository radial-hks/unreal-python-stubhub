## NiagaraParameterCollectionInstanceFactoryNew Objects

```python
class NiagaraParameterCollectionInstanceFactoryNew(Factory)
```
...
- **File**: NiagaraParameterCollectionFactoryNew.h
...
<a id="unreal.NiagaraParameterDefinitionsFactory"></a>