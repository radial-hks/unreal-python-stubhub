## PCGMetadataTrigSettings Objects

```python
class PCGMetadataTrigSettings(PCGMetadataSettingsBase)
```
...
- ``operation`` (PCGMetadataTrigOperation):  [Read-Write]
...
<a id="unreal.PCGMetadataTrigSettings.operation"></a>

#### operation

```python
@property
def operation() -> PCGMetadataTrigOperation
```

(PCGMetadataTrigOperation):  [Read-Write]
...
```python
@operation.setter
def operation(value: PCGMetadataTrigOperation) -> None
```
...
<a id="unreal.PCGMetadataVectorSettings"></a>