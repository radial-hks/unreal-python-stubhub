## MovieSceneCustomPrimitiveDataSection Objects

```python
class MovieSceneCustomPrimitiveDataSection(MovieSceneParameterSection)
```
...
- **File**: MovieSceneCustomPrimitiveDataSection.h
...
<a id="unreal.MovieSceneCVarSection"></a>