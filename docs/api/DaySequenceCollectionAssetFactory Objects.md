## DaySequenceCollectionAssetFactory Objects

```python
class DaySequenceCollectionAssetFactory(Factory)
```

Day Sequence Collection Asset Factory

**C++ Source:**

- **Plugin**: DaySequence
- **Module**: DaySequenceEditor
- **File**: AssetDefinition_DaySequenceCollectionAsset.h
...
<a id="unreal.DaySequenceFactoryNew"></a>