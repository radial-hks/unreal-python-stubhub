## DMMaterialStageExpressionArctangent Objects

```python
class DMMaterialStageExpressionArctangent(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionArctangent2"></a>