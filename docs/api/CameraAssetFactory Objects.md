## CameraAssetFactory Objects

```python
class CameraAssetFactory(Factory)
```
...
- ``camera_director_class`` (type(Class)):  [Read-Write] The type of camera director to create for this asset.
...
<a id="unreal.CameraRigAssetFactory"></a>