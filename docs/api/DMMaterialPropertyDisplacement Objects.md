## DMMaterialPropertyDisplacement Objects

```python
class DMMaterialPropertyDisplacement(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyEmissiveColor"></a>