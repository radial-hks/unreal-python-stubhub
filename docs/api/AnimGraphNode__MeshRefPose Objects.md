## AnimGraphNode\_MeshRefPose Objects

```python
class AnimGraphNode_MeshRefPose(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_MeshRefPose.h
...
- ``node`` (AnimNode_MeshSpaceRefPose):  [Read-Write]
...
<a id="unreal.AnimGraphNode_Mirror"></a>