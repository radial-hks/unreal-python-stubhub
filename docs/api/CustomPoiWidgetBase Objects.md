## CustomPoiWidgetBase Objects

```python
class CustomPoiWidgetBase(CoveringWidgetBase)
```

Custom Poi Widget Base
...
- ``on_button_clicked`` (CustomPoiButtonClickedDelegate):  [Read-Write]
...
<a id="unreal.CustomPoiWidgetBase.on_button_clicked"></a>

#### on\_button\_clicked

```python
@property
def on_button_clicked() -> CustomPoiButtonClickedDelegate
```

(CustomPoiButtonClickedDelegate):  [Read-Write]
...
def on_button_clicked(value: CustomPoiButtonClickedDelegate) -> None
```

<a id="unreal.CustomPoiWidgetBase.parent_widget_component"></a>
...
<a id="unreal.CustomPoiWidgetBase.parent_widget_class"></a>
...
<a id="unreal.CustomPoiWidgetBase.parent_visble2d_atom"></a>
...
<a id="unreal.CustomPoiWidgetBase.set_z_order"></a>
...
<a id="unreal.CustomPoiWidgetBase.setspecific_label_style"></a>
...
<a id="unreal.CustomPoiWidgetBase.set_point"></a>
...
<a id="unreal.CustomPoiWidgetBase.set_poi_entity_actor"></a>

#### set\_poi\_entity\_actor

```python
def set_poi_entity_actor(p_entity: CustomPoiEntity) -> None
```
...
Args:
    p_entity (CustomPoiEntity):

<a id="unreal.CustomPoiWidgetBase.setmarker_visible"></a>
...
<a id="unreal.CustomPoiWidgetBase.setmarker_size"></a>
...
<a id="unreal.CustomPoiWidgetBase.setmarker_offset"></a>
...
<a id="unreal.CustomPoiWidgetBase.setmarker_normal_url"></a>
...
<a id="unreal.CustomPoiWidgetBase.setmarker_activate_url"></a>
...
<a id="unreal.CustomPoiWidgetBase.setlabel_style"></a>

#### setlabel\_style

```python
def setlabel_style(label_style: CustomPoiLabelStyle) -> bool
```

x.setlabel_style(label_style) -> bool
Setlabel Style

Args:
    label_style (CustomPoiLabelStyle): 

Returns:
    bool:

<a id="unreal.CustomPoiWidgetBase.setlabel_content"></a>
...
<a id="unreal.CustomPoiWidgetBase.setgeneral_label_style"></a>
...
<a id="unreal.CustomPoiWidgetBase.reset_z_order"></a>
...
<a id="unreal.CustomPoiWidgetBase.notify_poi_image_load_finished"></a>
...
<a id="unreal.CustomPoiWidgetBase.notify_button_clicked"></a>
...
<a id="unreal.CustomPoiWidgetBase.execute_scale_mode"></a>
...
<a id="unreal.CustomPoiWidgetBase.enable_debugging"></a>
...
<a id="unreal.CustomPoiWidgetBase.do_wdp_pick_action"></a>
...
<a id="unreal.CustomPoiWidgetBase.create_poi"></a>
...
def create_poi(p_widget_component: CoveringWidgetComponent, point: Vector,
               enity_name: Name,
               custom_poi_entity_atom: CustomPoiEntityAtom) -> bool
```

x.create_poi(p_widget_component, point, enity_name, custom_poi_entity_atom) -> bool
Create Poi
...
Args:
    ...
    point (Vector): 
    enity_name (Name): 
    custom_poi_entity_atom (CustomPoiEntityAtom): 

Returns:
    bool:

<a id="unreal.HeatMapEntity"></a>