## GetParticleParams Objects

```python
class GetParticleParams(ResultBase)
```
...
<a id="unreal.GetParticleParams.__init__"></a>
...
<a id="unreal.GetParticleParams.particle_type"></a>
...
<a id="unreal.GetParticleParams.point_entity_eid"></a>
...
<a id="unreal.GetParticleParams.coord_z_ref"></a>
...
<a id="unreal.CreateParticlesParams"></a>