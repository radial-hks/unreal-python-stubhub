## UrbanPlanetSurfaceComponent\_Flat Objects

```python
class UrbanPlanetSurfaceComponent_Flat(UrbanPlanetSurfaceComponent)
```

Urban Planet Surface Component Flat

**C++ Source:**

- **Plugin**: AesRuntime
- **Module**: UrbanPlanet
- **File**: UrbanPlanetSurfaceComponent_Flat.h
...
<a id="unreal.UrbanPlanetSurfaceComponent_Sphere"></a>