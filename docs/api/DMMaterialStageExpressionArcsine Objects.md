## DMMaterialStageExpressionArcsine Objects

```python
class DMMaterialStageExpressionArcsine(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionArcsineFast"></a>