## DMMaterialStageExpressionArccosine Objects

```python
class DMMaterialStageExpressionArccosine(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionArccosineFast"></a>