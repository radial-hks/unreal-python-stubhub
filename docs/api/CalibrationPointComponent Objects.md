## CalibrationPointComponent Objects

```python
class CalibrationPointComponent(ProceduralMeshComponent)
```
...
- ``point_visualization_scale`` (float):  [Read-Write] Scales up/down the size of the point visualization meshes
...
- ``sub_points`` (Map[str, Vector]):  [Read-Write] A way to group many points in a single component
...
- ``visualization_shape`` (CalibrationPointVisualization):  [Read-Write] Shape used to visualize the calibration (sub)points
- ``visualize_points_in_editor`` (bool):  [Read-Write] Draws a visual representation of the calibration points

<a id="unreal.CalibrationPointComponent.sub_points"></a>

#### sub_points

```python
@property
def sub_points() -> Map[str, Vector]
```
...
```python
@sub_points.setter
def sub_points(value: Map[str, Vector]) -> None
```

<a id="unreal.CalibrationPointComponent.visualize_points_in_editor"></a>

#### visualize_points_in_editor

```python
@property
def visualize_points_in_editor() -> bool
```
...
```python
@visualize_points_in_editor.setter
def visualize_points_in_editor(value: bool) -> None
```

<a id="unreal.CalibrationPointComponent.point_visualization_scale"></a>

#### point_visualization_scale

```python
@property
def point_visualization_scale() -> float
```
...
```python
@point_visualization_scale.setter
def point_visualization_scale(value: float) -> None
```

<a id="unreal.CalibrationPointComponent.visualization_shape"></a>

#### visualization_shape

```python
@property
def visualization_shape() -> CalibrationPointVisualization
```
...
```python
@visualization_shape.setter
def visualization_shape(value: CalibrationPointVisualization) -> None
```

<a id="unreal.CalibrationPointComponent.rebuild_vertices"></a>

#### rebuild_vertices

```python
def rebuild_vertices() -> None
```

x.rebuild_vertices() -> None
Rebuilds the point visualization.

<a id="unreal.CalibrationPointComponent.namespaced_subpoint_name"></a>

#### namespaced_subpoint_name

```python
def namespaced_subpoint_name(subpoint_name: str) -> Optional[str]
```
...
<a id="unreal.CalibrationPointComponent.get_world_location"></a>

#### get_world_location

```python
def get_world_location(point_name: str) -> Optional[Vector]
```

x.get_world_location(point_name) -> Vector or None
Returns the World location of the subpoint (or the component) specified by name

Args:
    point_name (str): Name of the point or subpoint. If not namespaced the component name will have priority over subpoint name.

Returns:
    Vector or None: True if successful.

    out_location (Vector): World location of the specified subpoint.

<a id="unreal.CalibrationPointComponent.get_namespaced_point_names"></a>

#### get_namespaced_point_names

```python
def get_namespaced_point_names() -> Array[str]
```
...
<a id="unreal.CameraCalibrationCheckerboard"></a>