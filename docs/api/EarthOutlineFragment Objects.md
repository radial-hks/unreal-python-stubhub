## EarthOutlineFragment Objects

```python
class EarthOutlineFragment(EarthPrimitiveFragment)
```
...
<a id="unreal.EarthOutlineFragment.__init__"></a>
...
<a id="unreal.EarthSplineCurveFragment"></a>