## DCPFocusCameraParams Objects

```python
class DCPFocusCameraParams(StructBase)
```

DCPFocus Camera Params
...
<a id="unreal.DCPFocusCameraParams.__init__"></a>
...
<a id="unreal.DCPFocusCameraParams.rotation"></a>
...
<a id="unreal.DCPFocusCameraParams.distance_factor"></a>
...
<a id="unreal.DCPFocusCameraParams.fly_time"></a>
...
<a id="unreal.DCPNodeFocusParam"></a>