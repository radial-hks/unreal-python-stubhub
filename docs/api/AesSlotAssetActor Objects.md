## AesSlotAssetActor Objects

```python
class AesSlotAssetActor(AesAssetActorBase)
```
...
<a id="unreal.AesSlotAssetActor.tag_data_list"></a>
...
<a id="unreal.ErrorCollectorForWeb"></a>