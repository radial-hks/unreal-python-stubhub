## AesRoadLaneAssetActor Objects

```python
class AesRoadLaneAssetActor(AesAssetActorBase)
```
...
<a id="unreal.AesRoadLaneAssetActor.tag_data"></a>
...
<a id="unreal.AesRoadLaneAssetActor.load_mesh_from_asset"></a>

#### load\_mesh\_from\_asset

```python
def load_mesh_from_asset() -> None
```

x.load_mesh_from_asset() -> None
Load Mesh from Asset

<a id="unreal.AesRoofAssetActor"></a>