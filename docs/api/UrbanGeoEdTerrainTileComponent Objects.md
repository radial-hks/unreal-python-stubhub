## UrbanGeoEdTerrainTileComponent Objects

```python
class UrbanGeoEdTerrainTileComponent(UrbanGeoEdComponent)
```

Urban Geo Ed Terrain Tile Component

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanGeoEd
- **File**: UrbanGeoEdTerrainTileComponent.h
...
<a id="unreal.UrbanGeoEdWayComponent"></a>