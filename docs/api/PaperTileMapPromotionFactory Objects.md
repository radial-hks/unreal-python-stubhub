## PaperTileMapPromotionFactory Objects

```python
class PaperTileMapPromotionFactory(Factory)
```

Paper Tile Map Promotion Factory

**C++ Source:**

- **Plugin**: Paper2D
- **Module**: Paper2DEditor
- **File**: PaperTileMapPromotionFactory.h
...
<a id="unreal.PaperTileSetFactory"></a>