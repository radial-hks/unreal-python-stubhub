## UrbanHoudiniAssetFactory Objects

```python
class UrbanHoudiniAssetFactory(Factory)
```

Urban Houdini Asset Factory

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanHoudiniEngineEditor
- **File**: UrbanHoudiniAssetFactory.h
...
<a id="unreal.UrbanHoudiniOperatorLibraryFactory"></a>