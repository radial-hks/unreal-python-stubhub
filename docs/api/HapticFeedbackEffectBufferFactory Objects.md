## HapticFeedbackEffectBufferFactory Objects

```python
class HapticFeedbackEffectBufferFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: HapticFeedbackEffectBufferFactory.h
...
<a id="unreal.HapticFeedbackEffectCurveFactory"></a>