## MaterialExpressionSamplePhysicsVectorField Objects

```python
class MaterialExpressionSamplePhysicsVectorField(MaterialExpression)
```
...
<a id="unreal.MaterialExpressionSamplePhysicsScalarField"></a>