## EarthCollisionComponentBase Objects

```python
class EarthCollisionComponentBase(PrimitiveComponent)
```

Earth Collision Component Base

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: EarthPrefab
- **File**: EarthCollisionComponentBase.h
...
<a id="unreal.EarthCollisionComponent"></a>