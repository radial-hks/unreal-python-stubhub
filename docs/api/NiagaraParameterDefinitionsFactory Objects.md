## NiagaraParameterDefinitionsFactory Objects

```python
class NiagaraParameterDefinitionsFactory(Factory)
```
...
- **File**: NiagaraParameterDefinitionsFactory.h
...
<a id="unreal.NiagaraSimCacheFactoryNew"></a>