## EarthPropertyItemWidget\_Color Objects

```python
class EarthPropertyItemWidget_Color(EarthPropertyItemWidget)
```

Earth Property Item Widget Color

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: EarthPropertyItem_Color.h
...
<a id="unreal.EarthPropertyItemWidget_Color.set_unique_color_property"></a>

#### set\_unique\_color\_property

```python
def set_unique_color_property(property_value: Color) -> None
```

x.set_unique_color_property(property_value) -> None
Set Unique Color Property

Args:
    property_value (Color):

<a id="unreal.EarthPropertyItemWidget_Color.get_unique_color_property"></a>

#### get\_unique\_color\_property

```python
def get_unique_color_property() -> Optional[Color]
```

x.get_unique_color_property() -> Color or None
Get Unique Color Property

Returns:
    Color or None: 

    out_property_value (Color):

<a id="unreal.EarthPropertyItemWidget_Enum"></a>