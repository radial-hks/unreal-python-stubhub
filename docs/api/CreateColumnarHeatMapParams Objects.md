## CreateColumnarHeatMapParams Objects

```python
class CreateColumnarHeatMapParams(ParamsBase)
```

Create Columnar Heat Map Params
...
<a id="unreal.CreateColumnarHeatMapParams.__init__"></a>
...
<a id="unreal.CreateColumnarHeatMapParams.coord_z_ref"></a>
...
<a id="unreal.CreateColumnarHeatMapParams.coord_z"></a>
...
<a id="unreal.CreateColumnarHeatMapParams.columnar_heat_map_style"></a>
...
<a id="unreal.CreateColumnarHeatMapParams.columnar_heat_map_data"></a>
...
<a id="unreal.GetColumnarHeatMapParams"></a>