## ForceFeedbackAttenuationFactory Objects

```python
class ForceFeedbackAttenuationFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: ForceFeedbackAttenuationFactory.h
...
<a id="unreal.ForceFeedbackEffectFactory"></a>