## NiagaraDataChannelAssetFactoryNew Objects

```python
class NiagaraDataChannelAssetFactoryNew(Factory)
```
...
- **File**: NiagaraDataChannelAssetFactoryNew.h
...
<a id="unreal.NiagaraHierarchyMenuContext"></a>