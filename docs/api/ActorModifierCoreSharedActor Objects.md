## ActorModifierCoreSharedActor Objects

```python
class ActorModifierCoreSharedActor(Actor)
```
...
- **File**: ActorModifierCoreSharedActor.h
...
<a id="unreal.TagCollectionModifierSharedActor"></a>