## ColorCorrectionWindow Objects

```python
class ColorCorrectionWindow(ColorCorrectRegion)
```
...
- ``window_type`` (ColorCorrectWindowType):  [Read-Write] Region type.

<a id="unreal.ColorCorrectionWindow.window_type"></a>

#### window_type

```python
@property
def window_type() -> ColorCorrectWindowType
```

(ColorCorrectWindowType):  [Read-Write] Region type.
...
```python
@window_type.setter
def window_type(value: ColorCorrectWindowType) -> None
```

<a id="unreal.ColorCorrectWindow"></a>