## AnimGraphNode\_LayeredBoneBlend Objects

```python
class AnimGraphNode_LayeredBoneBlend(AnimGraphNode_BlendListBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_LayeredBoneBlend.h
...
- ``node`` (AnimNode_LayeredBoneBlend):  [Read-Write]
...
<a id="unreal.AnimGraphNode_LegIK"></a>