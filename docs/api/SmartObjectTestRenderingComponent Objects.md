## SmartObjectTestRenderingComponent Objects

```python
class SmartObjectTestRenderingComponent(SmartObjectDebugRenderingComponent)
```
...
<a id="unreal.SmartObjectTestingActor"></a>