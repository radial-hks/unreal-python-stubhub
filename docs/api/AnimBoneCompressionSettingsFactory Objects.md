## AnimBoneCompressionSettingsFactory Objects

```python
class AnimBoneCompressionSettingsFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: AnimBoneCompressionSettingsFactory.h
...
<a id="unreal.AnimCompositeFactory"></a>