## VirtualTextureBuilderFactory Objects

```python
class VirtualTextureBuilderFactory(Factory)
```
...
- **File**: VirtualTextureBuilderFactory.h
...
<a id="unreal.MotionControllerComponent"></a>