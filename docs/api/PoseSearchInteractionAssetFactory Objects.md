## PoseSearchInteractionAssetFactory Objects

```python
class PoseSearchInteractionAssetFactory(Factory)
```

Pose Search Interaction Asset Factory

**C++ Source:**

- **Plugin**: PoseSearch
- **Module**: PoseSearchEditor
- **File**: PoseSearchInteractionAssetFactory.h
...
<a id="unreal.PoseSearchMeshComponent"></a>