## TextureRenderTargetFactoryNew Objects

```python
class TextureRenderTargetFactoryNew(Factory)
```
...
- **Module**: UnrealEd
- **File**: TextureRenderTargetFactoryNew.h
...
<a id="unreal.TextureRenderTargetVolumeFactoryNew"></a>