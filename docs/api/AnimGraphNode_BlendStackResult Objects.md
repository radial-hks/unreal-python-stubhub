## AnimGraphNode_BlendStackResult Objects

```python
class AnimGraphNode_BlendStackResult(AnimGraphNode_Root)
```

Anim Graph Node Blend Stack Result

**C++ Source:**

- **Plugin**: BlendStack
- **Module**: BlendStackEditor
- **File**: AnimGraphNode_BlendStackResult.h
...
<a id="unreal.RigVMEditorMenuContext"></a>