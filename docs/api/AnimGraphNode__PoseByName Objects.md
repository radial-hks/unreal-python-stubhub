## AnimGraphNode\_PoseByName Objects

```python
class AnimGraphNode_PoseByName(AnimGraphNode_AssetPlayerBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_PoseByName.h
...
- ``node`` (AnimNode_PoseByName):  [Read-Write]
...
<a id="unreal.AnimGraphNode_PoseDriver"></a>