## RigVMFunction\_MathColorMul Objects

```python
class RigVMFunction_MathColorMul(RigVMFunction_MathColorBinaryAggregateOp)
```
...
<a id="unreal.RigVMFunction_MathColorMul.__init__"></a>
...
<a id="unreal.RigUnit_MathColorMul"></a>