## EarthHierarchicalInstancedStaticMeshComponent Objects

```python
class EarthHierarchicalInstancedStaticMeshComponent(
        HierarchicalInstancedStaticMeshComponent)
```

Earth Hierarchical Instanced Static Mesh Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: EarthPrefab
- **File**: EarthHierarchicalInstancedStaticMeshComponent.h
...
- ``allow_create_physics_state`` (bool):  [Read-Write] 强制设置是否允许创建物理状态，将无视其他碰撞设置
...
- ``local_bounds`` (BoxSphereBounds):  [Read-Write] 包围盒数据
...
<a id="unreal.EarthHierarchicalInstancedStaticMeshComponent.allow_create_physics_state"></a>

#### allow\_create\_physics\_state

```python
@property
def allow_create_physics_state() -> bool
```

(bool):  [Read-Write] 强制设置是否允许创建物理状态，将无视其他碰撞设置
...
```python
@allow_create_physics_state.setter
def allow_create_physics_state(value: bool) -> None
```

<a id="unreal.EarthHierarchicalInstancedStaticMeshComponent.local_bounds"></a>

#### local\_bounds

```python
@property
def local_bounds() -> BoxSphereBounds
```

(BoxSphereBounds):  [Read-Write] 包围盒数据
...
```python
@local_bounds.setter
def local_bounds(value: BoxSphereBounds) -> None
```

<a id="unreal.EarthHierarchicalInstancedStaticMeshComponent.set_bounds"></a>

#### set\_bounds

```python
def set_bounds(bounds: BoxSphereBounds) -> None
```

x.set_bounds(bounds) -> None
Set Bounds

Args:
    bounds (BoxSphereBounds):

<a id="unreal.EarthHipRoofPrefabAlgorithm"></a>