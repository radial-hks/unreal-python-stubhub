## SunMoonDaySequenceActor Objects

```python
class SunMoonDaySequenceActor(BaseDaySequenceActor)
```
...
- **Plugin**: DaySequence
- **Module**: DaySequence
- **File**: SunMoonDaySequenceActor.h
...
- ``moon_component`` (DirectionalLightComponent):  [Read-Only]
...
<a id="unreal.SunMoonDaySequenceActor.moon_component"></a>

#### moon_component

```python
@property
def moon_component() -> DirectionalLightComponent
```

(DirectionalLightComponent):  [Read-Only]

<a id="unreal.DaySequence"></a>