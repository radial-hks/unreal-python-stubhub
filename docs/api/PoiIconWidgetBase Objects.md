## PoiIconWidgetBase Objects

```python
class PoiIconWidgetBase(CoveringWidgetBase)
```

Poi Icon Widget Base

**C++ Source:**

- **Plugin**: CoveringAPI
- **Module**: CoveringAPIEntity
- **File**: PoiIconWidgetBase.h
...
<a id="unreal.PoiIconWidgetBase.set_poi_entity_actor"></a>
...
<a id="unreal.PoiIconWidgetBase.set_icon_visible2d_atom"></a>
...
<a id="unreal.PoiIconWidgetBase.set_icon_url"></a>
...
<a id="unreal.PoiIconWidgetBase.set_icon_size"></a>
...
<a id="unreal.PoiIconWidgetBase.create_icon"></a>
...
<a id="unreal.PointCloudBpActor"></a>