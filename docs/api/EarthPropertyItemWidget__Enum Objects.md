## EarthPropertyItemWidget\_Enum Objects

```python
class EarthPropertyItemWidget_Enum(EarthPropertyItemWidget)
```

Earth Property Item Widget Enum

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: EarthPropertyItem_Enum.h
...
<a id="unreal.EarthPropertyItemWidget_Enum.set_unique_enum_property"></a>

#### set\_unique\_enum\_property

```python
def set_unique_enum_property(property_value_index: int) -> None
```

x.set_unique_enum_property(property_value_index) -> None
Set Unique Enum Property

Args:
    property_value_index (int32):

<a id="unreal.EarthPropertyItemWidget_Enum.get_unique_enum_property"></a>

#### get\_unique\_enum\_property

```python
def get_unique_enum_property() -> Optional[int]
```

x.get_unique_enum_property() -> int32 or None
Get Unique Enum Property
...
<a id="unreal.EarthPropertyItemWidget_Enum.get_display_names"></a>

#### get\_display\_names

```python
def get_display_names() -> Array[str]
```

x.get_display_names() -> Array[str]
Get Display Names

Returns:
    Array[str]:

<a id="unreal.EarthPropertyItem_StringArray"></a>