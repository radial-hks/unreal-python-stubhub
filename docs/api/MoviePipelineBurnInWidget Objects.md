## MoviePipelineBurnInWidget Objects

```python
class MoviePipelineBurnInWidget(UserWidget)
```
...
- **File**: MoviePipelineBurnInWidget.h
...
<a id="unreal.MoviePipelineBurnInWidget.on_output_frame_started"></a>

#### on_output_frame_started

```python
def on_output_frame_started(for_pipeline: MoviePipeline) -> None
```
...
<a id="unreal.MoviePipelineBurnInSetting"></a>