## WdpEditableElementComponent Objects

```python
class WdpEditableElementComponent(PrimitiveComponent)
```

Wdp Editable Element Component

**C++ Source:**

- **Plugin**: WdpApplication
- **Module**: WdpShapeEditor
- **File**: WdpEditableElementComponent.h
...
<a id="unreal.WdpShapeGraphicsActor"></a>