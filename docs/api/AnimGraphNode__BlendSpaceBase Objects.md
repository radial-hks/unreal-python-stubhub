## AnimGraphNode\_BlendSpaceBase Objects

```python
class AnimGraphNode_BlendSpaceBase(AnimGraphNode_AssetPlayerBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendSpaceBase.h
...
<a id="unreal.AnimGraphNode_AimOffsetLookAt"></a>