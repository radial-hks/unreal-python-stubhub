## NiagaraCullProxyComponent Objects
...
- **Plugin**: Niagara
- **Module**: Niagara
- **File**: NiagaraCullProxyComponent.h
...
- ``instances`` (Array[NiagaraCulledComponentInfo]):  [Read-Write] Array of additional instance transforms. This component will be rendered at it's own transform and additionally at each of these transforms.
...
<a id="unreal.NiagaraDataChannelLibrary"></a>