## PCGMetadataBooleanSettings Objects

```python
class PCGMetadataBooleanSettings(PCGMetadataSettingsBase)
```
...
- ``operation`` (PCGMetadataBooleanOperation):  [Read-Write]
...
<a id="unreal.PCGMetadataBooleanSettings.operation"></a>

#### operation

```python
@property
def operation() -> PCGMetadataBooleanOperation
```

(PCGMetadataBooleanOperation):  [Read-Write]
...
```python
@operation.setter
def operation(value: PCGMetadataBooleanOperation) -> None
```

<a id="unreal.PCGMetadataBooleanSettings.input_source1"></a>
...
<a id="unreal.PCGMetadataBooleanSettings.input_source2"></a>
...
<a id="unreal.PCGMetadataBreakTransformSettings"></a>