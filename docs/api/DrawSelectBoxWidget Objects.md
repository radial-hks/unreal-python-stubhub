## DrawSelectBoxWidget Objects

```python
class DrawSelectBoxWidget(UserWidget)
```

Draw Select Box Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorMode
- **File**: DrawSelectBoxWidget.h
...
<a id="unreal.DrawSelectBoxWidget.box_arr"></a>
...
<a id="unreal.DrawSelectBoxWidget.get_lines"></a>
...
<a id="unreal.EarthAssistantActor"></a>