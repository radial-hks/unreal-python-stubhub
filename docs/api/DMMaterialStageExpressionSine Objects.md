## DMMaterialStageExpressionSine Objects

```python
class DMMaterialStageExpressionSine(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionSmoothStep"></a>