## PCGMetadataOperationSettings Objects

```python
class PCGMetadataOperationSettings(PCGCopyAttributesSettings)
```
...
<a id="unreal.PCGMetadataMakeRotatorSettings"></a>