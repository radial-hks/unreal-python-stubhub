## EarthRoadJunctionFragment Objects

```python
class EarthRoadJunctionFragment(EarthEntityFragment)
```

Earth Road Junction Fragment
...
- ``junction_level`` (int32):  [Read-Write] 路口Level
- ``junction_module_definition`` (Map[EarthJunctionLaneType, EarthModuleAsset]):  [Read-Write] 键为路口特殊模块种类，值为路口特殊模块定义
- ``junction_road_module_definition`` (Map[EarthRoadLaneType, EarthModuleAsset]):  [Read-Write] 键为路口道路模块种类，值为路口道路通用模块定义
- ``junction_round_lane_info`` (EarthLaneProfileFragment):  [Read-Write] 子资产引用
...
- ``traffic_light`` (bool):  [Read-Write] 路口是否生成红绿灯
- ``valid`` (bool):  [Read-Write] 数据片段是否有效
- ``validated`` (bool):  [Read-Write] 是否已执行数据有效性验证

<a id="unreal.EarthRoadJunctionFragment.__init__"></a>
...
def __init__(
    ...
    EarthRoadJunctionBuilderType = EarthRoadJunctionBuilderType.REGULAR,
        ...
        junction_module_definition: Map[EarthJunctionLaneType,
                                        EarthModuleAsset] = {},
        junction_road_module_definition: Map[EarthRoadLaneType,
                                             EarthModuleAsset] = {},
        junction_circle_radius: float = 0.000000,
        junction_circle_center: Vector = [0.000000, 0.000000, 0.000000],
        junction_round_lane_info: EarthLaneProfileFragment = [
            "None", [], False, False
        ],
        junction_level: int = 0,
        outer_type: str = "",
        traffic_light: bool = False) -> None
```

<a id="unreal.EarthRoadJunctionFragment.lod_config"></a>
...
<a id="unreal.EarthRoadJunctionFragment.road_junction_builder_type"></a>
...
<a id="unreal.EarthRoadJunctionFragment.junction_connection_infos"></a>
...
<a id="unreal.EarthRoadJunctionFragment.junction_surface_asset"></a>
...
<a id="unreal.EarthRoadJunctionFragment.junction_module_definition"></a>
...
<a id="unreal.EarthRoadJunctionFragment.junction_road_module_definition"></a>
...
) -> Map[EarthRoadLaneType, EarthModuleAsset]
```

(Map[EarthRoadLaneType, EarthModuleAsset]):  [Read-Write] 键为路口道路模块种类，值为路口道路通用模块定义
...
def junction_road_module_definition(
        value: Map[EarthRoadLaneType, EarthModuleAsset]) -> None
```

<a id="unreal.EarthRoadJunctionFragment.junction_circle_radius"></a>
...
<a id="unreal.EarthRoadJunctionFragment.junction_circle_center"></a>
...
<a id="unreal.EarthRoadJunctionFragment.junction_round_lane_info"></a>

#### junction\_round\_lane\_info

```python
@property
def junction_round_lane_info() -> EarthLaneProfileFragment
```

(EarthLaneProfileFragment):  [Read-Write] 子资产引用
...
def junction_round_lane_info(value: EarthLaneProfileFragment) -> None
```

<a id="unreal.EarthRoadJunctionFragment.junction_level"></a>
...
<a id="unreal.EarthRoadJunctionFragment.outer_type"></a>
...
<a id="unreal.EarthRoadJunctionFragment.traffic_light"></a>

#### traffic\_light

```python
@property
def traffic_light() -> bool
```

(bool):  [Read-Write] 路口是否生成红绿灯
...
def traffic_light(value: bool) -> None
```

<a id="unreal.EarthRoadModelerJunctionFragment"></a>