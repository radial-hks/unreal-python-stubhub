## ScreenshotFunctionalTest Objects

```python
class ScreenshotFunctionalTest(ScreenshotFunctionalTestBase)
```
...
- **File**: ScreenshotFunctionalTest.h
...
```python
@property
def camera_cut_on_screenshot_prep() -> bool
```
...
def camera_cut_on_screenshot_prep(value: bool) -> None
```

<a id="unreal.TestPhaseComponent"></a>