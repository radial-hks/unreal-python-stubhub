## RemoteControlTrackerComponent Objects

```python
class RemoteControlTrackerComponent(ActorComponent)
```
...
- **Plugin**: RemoteControlComponents
- **Module**: RemoteControlComponents
- **File**: RemoteControlTrackerComponent.h
