## MassDistanceVisualizationTrait Objects

```python
class MassDistanceVisualizationTrait(MassEntityTraitBase)
```
...
- **File**: MassDistanceVisualizationTrait.h
...
<a id="unreal.MassVisualizationTrait"></a>