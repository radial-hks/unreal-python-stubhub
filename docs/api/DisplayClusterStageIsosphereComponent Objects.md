## DisplayClusterStageIsosphereComponent Objects

```python
class DisplayClusterStageIsosphereComponent(ProceduralMeshComponent)
```
...
- **File**: DisplayClusterStageIsosphereComponent.h
...
<a id="unreal.DisplayClusterSyncTickComponent"></a>