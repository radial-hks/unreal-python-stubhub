## EarthLayerSettingsBase Objects

```python
class EarthLayerSettingsBase(StructBase)
```
...
<a id="unreal.EarthLayerSettingsBase.__init__"></a>
...
<a id="unreal.EarthLayerSettingsBase.use_bake_board"></a>

#### use\_bake\_board

```python
@property
def use_bake_board() -> bool
```
...
```python
@use_bake_board.setter
def use_bake_board(value: bool) -> None
```

<a id="unreal.EarthBuildingSettings"></a>