## MovieGraphImageSequenceOutputNode_PNG Objects

```python
class MovieGraphImageSequenceOutputNode_PNG(MovieGraphImageSequenceOutputNode)
```
...
<a id="unreal.MovieGraphPathTracerRenderPassNode"></a>