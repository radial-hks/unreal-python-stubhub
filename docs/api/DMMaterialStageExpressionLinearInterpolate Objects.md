## DMMaterialStageExpressionLinearInterpolate Objects

```python
class DMMaterialStageExpressionLinearInterpolate(
...
<a id="unreal.DMMaterialStageExpressionLogarithm10"></a>