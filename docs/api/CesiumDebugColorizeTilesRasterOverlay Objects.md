## CesiumDebugColorizeTilesRasterOverlay Objects

```python
class CesiumDebugColorizeTilesRasterOverlay(CesiumRasterOverlay)
```
...
- **File**: CesiumDebugColorizeTilesRasterOverlay.h
