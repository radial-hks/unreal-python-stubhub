## FunctionalUIScreenshotTest Objects

```python
class FunctionalUIScreenshotTest(ScreenshotFunctionalTestBase)
```
...
- ``hide_debug_canvas`` (bool):  [Read-Write]
...
- ``widget_location`` (WidgetTestAppearLocation):  [Read-Write]

<a id="unreal.GroundTruthData"></a>