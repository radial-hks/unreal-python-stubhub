## AesLandmarkAssetActor Objects

```python
class AesLandmarkAssetActor(AesAssetActorBase)
```
...
<a id="unreal.AesLandmarkAssetActor.tag_data"></a>
...
<a id="unreal.AesLandmarkAssetActor.load_data_from_asset"></a>
...
<a id="unreal.AesModularBuildingAssetActor"></a>