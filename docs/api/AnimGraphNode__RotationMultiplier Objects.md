## AnimGraphNode\_RotationMultiplier Objects

```python
class AnimGraphNode_RotationMultiplier(AnimGraphNode_SkeletalControlBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_RotationMultiplier.h
...
- ``node`` (AnimNode_RotationMultiplier):  [Read-Write]
...
<a id="unreal.AnimGraphNode_RotationOffsetBlendSpace"></a>