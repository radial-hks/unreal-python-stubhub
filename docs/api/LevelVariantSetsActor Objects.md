## LevelVariantSetsActor Objects

```python
class LevelVariantSetsActor(Actor)
```
...
- ``level_variant_sets`` (SoftObjectPath):  [Read-Write]
...
```python
@property
def level_variant_sets() -> SoftObjectPath
```
...
<a id="unreal.LevelVariantSetsFunctionDirector"></a>