## DMMaterialStageExpressionLogarithm10 Objects

```python
class DMMaterialStageExpressionLogarithm10(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionLogarithm2"></a>