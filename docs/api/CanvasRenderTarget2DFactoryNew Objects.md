## CanvasRenderTarget2DFactoryNew Objects

```python
class CanvasRenderTarget2DFactoryNew(Factory)
```
...
- **Module**: UnrealEd
- **File**: CanvasRenderTarget2DFactoryNew.h
...
<a id="unreal.ComponentElementsCopy"></a>