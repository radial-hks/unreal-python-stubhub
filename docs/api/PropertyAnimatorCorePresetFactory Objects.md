## PropertyAnimatorCorePresetFactory Objects

```python
class PropertyAnimatorCorePresetFactory(Factory)
```

Property Animator Core Preset Factory

**C++ Source:**

- **Plugin**: PropertyAnimatorCore
- **Module**: PropertyAnimatorCoreEditor
- **File**: PropertyAnimatorCorePresetFactory.h
