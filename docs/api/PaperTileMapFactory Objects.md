## PaperTileMapFactory Objects

```python
class PaperTileMapFactory(Factory)
```

Paper Tile Map Factory

**C++ Source:**

- **Plugin**: Paper2D
- **Module**: Paper2DEditor
- **File**: PaperTileMapFactory.h
...
<a id="unreal.PaperTileMapPromotionFactory"></a>