## AnimGraphNode\_PoseBlendNode Objects

```python
class AnimGraphNode_PoseBlendNode(AnimGraphNode_PoseHandler)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_PoseBlendNode.h
...
- ``node`` (AnimNode_PoseBlendNode):  [Read-Write]
...
<a id="unreal.AnimGraphNode_PoseByName"></a>