## AesInstanceSplineAssetActor Objects

```python
class AesInstanceSplineAssetActor(AesAssetActorBase)
```
...
- **Plugin**: AesWorld
- **Module**: AesAsset
- **File**: AesInstanceSplineAssetActor.h
...
<a id="unreal.AesInstanceSplineAssetActor.tag_data"></a>
...
<a id="unreal.AesInstanceSplineAssetActor.load_data_from_asset"></a>
...
<a id="unreal.AesLandmarkAssetActor"></a>