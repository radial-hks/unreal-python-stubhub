## GizmoLineHandleComponent Objects

```python
class GizmoLineHandleComponent(GizmoBaseComponent)
```
...
- **File**: GizmoLineHandleComponent.h
...
<a id="unreal.GizmoRectangleComponent"></a>