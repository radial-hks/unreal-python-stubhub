## MetaSoundFactory Objects

```python
class MetaSoundFactory(MetaSoundBaseFactory)
```
...
- ``referenced_meta_sound_object`` (Object):  [Read-Write] Set to initialize MetaSound type as Preset,
  using the provided MetaSound as a Reference
- ``supported_class`` (type(Class)):  [Read-Write] The class manufactured by this factory.
- ``text`` (bool):  [Read-Write] true if the factory imports objects from text.

<a id="unreal.MetaSoundSourceFactory"></a>