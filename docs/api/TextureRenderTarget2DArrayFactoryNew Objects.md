## TextureRenderTarget2DArrayFactoryNew Objects

```python
class TextureRenderTarget2DArrayFactoryNew(Factory)
```
...
- **Module**: UnrealEd
- **File**: TextureRenderTarget2DArrayFactoryNew.h
...
<a id="unreal.TextureRenderTargetCubeFactoryNew"></a>