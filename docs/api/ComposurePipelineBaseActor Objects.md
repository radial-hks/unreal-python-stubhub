## ComposurePipelineBaseActor Objects

```python
class ComposurePipelineBaseActor(Actor)
```
...
- **Plugin**: Composure
- **Module**: Composure
- **File**: ComposurePipelineBaseActor.h
...
<a id="unreal.ComposurePipelineBaseActor.auto_run"></a>
...
```python
@auto_run.setter
def auto_run(value: bool) -> None
```

<a id="unreal.ComposurePipelineBaseActor.auto_run_child_elements_and_self"></a>

#### auto_run_child_elements_and_self

```python
@property
def auto_run_child_elements_and_self() -> bool
```
...
```python
@auto_run_child_elements_and_self.setter
def auto_run_child_elements_and_self(value: bool) -> None
```

<a id="unreal.ComposurePipelineBaseActor.is_actively_running"></a>

#### is_actively_running

```python
def is_actively_running() -> bool
```
...
<a id="unreal.ComposurePipelineBaseActor.enqueue_rendering"></a>

#### enqueue_rendering

```python
def enqueue_rendering(camera_cut_this_frame: bool) -> None
```
...
<a id="unreal.CompositingElement"></a>