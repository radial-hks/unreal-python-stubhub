## ReimportHairStrandsFactory Objects

```python
class ReimportHairStrandsFactory(HairStrandsFactory)
```

Reimport Hair Strands Factory

**C++ Source:**

- **Plugin**: HairStrands
- **Module**: HairStrandsEditor
- **File**: ReimportHairStrandsFactory.h
...
<a id="unreal.MobileInstalledContent"></a>