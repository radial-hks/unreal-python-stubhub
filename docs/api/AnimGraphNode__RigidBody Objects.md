## AnimGraphNode\_RigidBody Objects

```python
class AnimGraphNode_RigidBody(AnimGraphNode_SkeletalControlBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_RigidBody.h
...
- ``node`` (AnimNode_RigidBody):  [Read-Write]
...
<a id="unreal.AnimGraphNode_Ragdoll"></a>