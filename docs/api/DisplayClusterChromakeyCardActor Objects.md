## DisplayClusterChromakeyCardActor Objects

```python
class DisplayClusterChromakeyCardActor(DisplayClusterLightCardActor)
```
...
- **File**: DisplayClusterChromakeyCardActor.h
...
<a id="unreal.DisplayClusterStageActorComponent"></a>