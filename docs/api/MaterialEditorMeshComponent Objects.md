## MaterialEditorMeshComponent Objects

```python
class MaterialEditorMeshComponent(StaticMeshComponent)
```
...
- **Module**: UnrealEd
- **File**: MaterialEditorMeshComponent.h
...
<a id="unreal.MaterialFactoryNew"></a>