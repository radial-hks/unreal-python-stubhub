## AesTerrainQuadCollisionComponent Objects

```python
class AesTerrainQuadCollisionComponent(AesCollisionComponentBase)
```

Aes Terrain Quad Collision Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEarth
- **File**: AesTerrainQuadCollisionComponent.h
