## AnimGraphNode\_CurveSource Objects

```python
class AnimGraphNode_CurveSource(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_CurveSource.h
...
- ``node`` (AnimNode_CurveSource):  [Read-Write]
...
<a id="unreal.AnimGraphNode_CustomProperty"></a>