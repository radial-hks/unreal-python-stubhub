## DMMaterialStageExpressionCosine Objects

```python
class DMMaterialStageExpressionCosine(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionCrossProduct"></a>