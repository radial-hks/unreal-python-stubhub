## EditorUtilityMultiLineEditableTextBox Objects

```python
class EditorUtilityMultiLineEditableTextBox(MultiLineEditableTextBox)
```
...
<a id="unreal.EditorUtilityProgressBar"></a>