## DatasmithImportedSequencesActor Objects

```python
class DatasmithImportedSequencesActor(Actor)
```
...
- **File**: DatasmithImportedSequencesActor.h
...
- ``imported_sequences`` (Array[LevelSequence]):  [Read-Write]
...
```python
@property
def imported_sequences() -> Array[LevelSequence]
```
...
def imported_sequences(value: Array[LevelSequence]) -> None
```
...
<a id="unreal.DatasmithOptionsBase"></a>