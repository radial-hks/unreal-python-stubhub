## AnimGraphNode_BlendStack Objects

```python
class AnimGraphNode_BlendStack(AnimGraphNode_BlendStack_Base)
```

Anim Graph Node Blend Stack
...
- ``node`` (AnimNode_BlendStack):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BlendStackInput"></a>