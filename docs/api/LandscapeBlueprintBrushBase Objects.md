## LandscapeBlueprintBrushBase Objects

```python
class LandscapeBlueprintBrushBase(Actor)
```
...
```python
@property
def update_on_property_change() -> bool
```
...
def update_on_property_change(value: bool) -> None
```
...
def affect_heightmap(value: bool) -> None
```
...
def affect_weightmap(value: bool) -> None
```
...
```python
@property
def affect_visibility_layer() -> bool
```
...
def affect_visibility_layer(value: bool) -> None
```
...
```python
@property
def affected_weightmap_layers() -> Array[Name]
```
...
def affected_weightmap_layers(value: Array[Name]) -> None
```
...
x.request_landscape_update(user_triggered=False) -> None
...
```python
def render_layer(
        parameters: LandscapeBrushParameters) -> TextureRenderTarget2D
```

x.render_layer(parameters) -> TextureRenderTarget2D
Render Layer
...
<a id="unreal.LandscapeBlueprintBrushBase.render"></a>

#### render

```python
def render(is_heightmap: bool, combined_result: TextureRenderTarget2D,
           weightmap_layer_name: Name) -> TextureRenderTarget2D
```

x.render(is_heightmap, combined_result, weightmap_layer_name) -> TextureRenderTarget2D
Render
deprecated: Please use RenderLayer instead.
...
<a id="unreal.LandscapeBlueprintBrushBase.initialize"></a>

#### initialize

```python
def initialize(landscape_transform: Transform, landscape_size: IntPoint,
               landscape_render_target_size: IntPoint) -> None
```
...
<a id="unreal.LandscapeNaniteComponent"></a>