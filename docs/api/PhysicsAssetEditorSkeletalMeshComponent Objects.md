## PhysicsAssetEditorSkeletalMeshComponent Objects

```python
class PhysicsAssetEditorSkeletalMeshComponent(DebugSkelMeshComponent)
```

Physics Asset Editor Skeletal Mesh Component

**C++ Source:**

- **Module**: PhysicsAssetEditor
- **File**: PhysicsAssetEditorSkeletalMeshComponent.h
