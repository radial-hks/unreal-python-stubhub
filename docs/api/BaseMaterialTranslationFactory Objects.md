## BaseMaterialTranslationFactory Objects

```python
class BaseMaterialTranslationFactory(Factory)
```

Base Material Translation Factory

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: MaterialBaseTransEditor
- **File**: MaterialBaseTransFactory.h
