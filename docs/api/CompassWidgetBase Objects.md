## CompassWidgetBase Objects

```python
class CompassWidgetBase(UserWidget)
```
...
<a id="unreal.CompassWidgetBase.start_compass"></a>

#### start\_compass

```python
def start_compass(position: Vector2D, size: int, bg_url: str, needle_url: str,
                  anchors: str) -> bool
```

x.start_compass(position, size, bg_url, needle_url, anchors) -> bool
Start Compass
...
<a id="unreal.CompassWidgetBase.end_compass"></a>

#### end\_compass

```python
def end_compass() -> bool
```
...
<a id="unreal.Covering3DWidgetComponent"></a>