## VariableFrameStrippingSettingsFactory Objects

```python
class VariableFrameStrippingSettingsFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: VariableFrameStrippingSettingsFactory.h
...
<a id="unreal.VectorFieldExporter"></a>