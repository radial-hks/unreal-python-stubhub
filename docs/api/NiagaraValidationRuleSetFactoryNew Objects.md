## NiagaraValidationRuleSetFactoryNew Objects

```python
class NiagaraValidationRuleSetFactoryNew(Factory)
```
...
- **File**: NiagaraValidationRuleSetFactoryNew.h
...
<a id="unreal.MovieSceneNiagaraEmitterSectionBase"></a>