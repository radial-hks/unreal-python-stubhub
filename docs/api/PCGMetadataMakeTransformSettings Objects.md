## PCGMetadataMakeTransformSettings Objects

```python
class PCGMetadataMakeTransformSettings(PCGMetadataSettingsBase)
```
...
- **Plugin**: PCG
- **Module**: PCG
- **File**: PCGMetadataMakeTransform.h
...
<a id="unreal.PCGMetadataMakeVectorSettings"></a>