## LocalizedOverlaysFactoryNew Objects

```python
class LocalizedOverlaysFactoryNew(Factory)
```
...
- **File**: LocalizedOverlaysFactoryNew.h
...
<a id="unreal.ReimportBasicOverlaysFactory"></a>