## RemoteControlPresetFactory Objects

```python
class RemoteControlPresetFactory(Factory)
```
...
- **File**: RemoteControlPresetFactory.h
...
<a id="unreal.SkeletonFromStaticMeshFactory"></a>