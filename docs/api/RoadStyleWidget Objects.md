## RoadStyleWidget Objects

```python
class RoadStyleWidget(UserWidget)
```
...
<a id="unreal.RoadStyleWidget.set_f_class_and_prefab_id"></a>

#### set\_f\_class\_and\_prefab\_id

```python
def set_f_class_and_prefab_id(class_: str, prefab_id: str) -> None
```

x.set_f_class_and_prefab_id(class_, prefab_id) -> None
Set FClass and Prefab Id

Args:
    class_ (str): 
    prefab_id (str):

<a id="unreal.RoadStyleWidget.get_prefab_id"></a>

#### get\_prefab\_id

```python
def get_prefab_id() -> str
```
...
<a id="unreal.RoadStyleWidget.get_f_class"></a>
