## MagicCesiumGeoreference Objects

```python
class MagicCesiumGeoreference(CesiumGeoreference)
```

Magic Cesium Georeference

**C++ Source:**

- **Plugin**: GISCesium
- **Module**: MagicCesium
- **File**: MagicCesiumGeoreference.h
...
- ``longitude_latitude_height`` (Vector):  [Read-Write]
...
<a id="unreal.MagicCesiumLayerViewActor"></a>