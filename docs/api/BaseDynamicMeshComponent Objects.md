## BaseDynamicMeshComponent Objects
...
(bool):  [Read-Write] If true, render the Wireframe on top of the Shaded Mesh
...
x.set_enable_wireframe_render_pass(enable) -> None
...
x.get_dynamic_mesh() -> DynamicMesh
