## UrbanPlanetSurfaceComponent Objects

```python
class UrbanPlanetSurfaceComponent(PrimitiveComponent)
```

Urban Planet Surface Component

**C++ Source:**

- **Plugin**: AesRuntime
- **Module**: UrbanPlanet
- **File**: UrbanPlanetSurfaceComponent.h
...
<a id="unreal.UrbanPlanetSurfaceComponent_Flat"></a>