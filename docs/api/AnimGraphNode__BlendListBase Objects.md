## AnimGraphNode\_BlendListBase Objects

```python
class AnimGraphNode_BlendListBase(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendListBase.h
...
<a id="unreal.AnimGraphNode_BlendListByBool"></a>