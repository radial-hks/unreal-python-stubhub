## DMMaterialStageExpressionSubtract Objects

```python
class DMMaterialStageExpressionSubtract(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionTangent"></a>