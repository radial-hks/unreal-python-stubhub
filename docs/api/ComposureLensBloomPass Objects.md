## ComposureLensBloomPass Objects

```python
class ComposureLensBloomPass(ComposurePostProcessPass)
```
...
<a id="unreal.ComposureLensBloomPass.settings"></a>
...
<a id="unreal.ComposureLensBloomPass.set_tonemapper_replacing_material"></a>

#### set_tonemapper_replacing_material

```python
def set_tonemapper_replacing_material(
...
<a id="unreal.ComposureLensBloomPass.bloom_to_render_target"></a>

#### bloom_to_render_target

```python
def bloom_to_render_target() -> None
```

x.bloom_to_render_target() -> None
Blurs the input into the output.

<a id="unreal.ComposurePostProcessPassPolicy"></a>