## RigVMFunction\_MathColorBinaryOp Objects

```python
class RigVMFunction_MathColorBinaryOp(RigVMFunction_MathColorBase)
```
...
<a id="unreal.RigVMFunction_MathColorBinaryOp.__init__"></a>
...
<a id="unreal.RigVMFunction_MathColorBinaryOp.a"></a>
...
<a id="unreal.RigVMFunction_MathColorBinaryOp.b"></a>
...
<a id="unreal.RigVMFunction_MathColorBinaryOp.result"></a>
...
<a id="unreal.RigUnit_MathColorBinaryOp"></a>