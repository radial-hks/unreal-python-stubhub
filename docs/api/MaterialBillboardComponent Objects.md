## MaterialBillboardComponent Objects
...
- ``elements`` (Array[MaterialSpriteElement]):  [Read-Write] Current array of material billboard elements
...
<a id="unreal.MaterialBillboardComponent.elements"></a>

#### elements

```python
@property
def elements() -> Array[MaterialSpriteElement]
```
...
def add_element(material: MaterialInterface,
                ...
                size_is_in_screen_space: bool, base_size_x: float,
                base_size_y: float,
                distance_to_size_curve: CurveFloat) -> None
```
...
<a id="unreal.MaterialSpriteComponent"></a>