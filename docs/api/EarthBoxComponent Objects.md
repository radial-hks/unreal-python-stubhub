## EarthBoxComponent Objects

```python
class EarthBoxComponent(BoxComponent)
```
...
- ``box_extent`` (Vector):  [Read-Write] The extents (radii dimensions) of the box *
...
<a id="unreal.EarthBoxComponent.spatial_data"></a>
...
<a id="unreal.EarthBoxComponent.feature_id"></a>
...
<a id="unreal.EarthBoxComponent.prefab_asset"></a>
...
<a id="unreal.EarthBoxComponent.update_spatial_data"></a>
...
<a id="unreal.EarthBoxComponent.set_spatial_data_type"></a>
...
<a id="unreal.EarthBoxComponent.set_spatial_data"></a>
...
<a id="unreal.EarthBoxComponent.get_spatial_data_type"></a>
...
<a id="unreal.EarthBoxComponent.get_spatial_data"></a>
...
<a id="unreal.EarthPrefabAlgorithm"></a>