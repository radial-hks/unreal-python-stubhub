## EarthNestTabContentWidget Objects

```python
class EarthNestTabContentWidget(EarthTabContentWidget)
```

Earth Nest Tab Content Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: EarthNestTabContent.h
...
- ``tab_list`` (EarthTabListWidget):  [Read-Write]
...
<a id="unreal.EarthNestTabContentWidget.tab_list"></a>

#### tab\_list

```python
@property
def tab_list() -> EarthTabListWidget
```

(EarthTabListWidget):  [Read-Write]
...
```python
@tab_list.setter
def tab_list(value: EarthTabListWidget) -> None
```

<a id="unreal.EarthPropertyItemWidget"></a>