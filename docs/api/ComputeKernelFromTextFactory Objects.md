## ComputeKernelFromTextFactory Objects

```python
class ComputeKernelFromTextFactory(Factory)
```

Compute Kernel from Text Factory

**C++ Source:**

- **Plugin**: ComputeFramework
- **Module**: ComputeFrameworkEditor
- **File**: ComputeKernelFromTextFactory.h
...
<a id="unreal.IllegalPluginDependenciesValidator"></a>