## AvfFileMediaSourceFactory Objects

```python
class AvfFileMediaSourceFactory(Factory)
```
...
- **Plugin**: AvfMedia
- **Module**: AvfMediaEditor
- **File**: AvfFileMediaSourceFactory.h
...
<a id="unreal.ImgMediaSourceFactory"></a>