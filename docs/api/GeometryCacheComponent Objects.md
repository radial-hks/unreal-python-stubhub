## GeometryCacheComponent Objects
...
- ``geometry_cache`` (GeometryCache):  [Read-Write] Geometry Cache instance referenced by the component
...
x.get_override_wireframe_color() -> bool
