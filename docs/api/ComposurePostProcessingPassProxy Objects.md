## ComposurePostProcessingPassProxy Objects

```python
class ComposurePostProcessingPassProxy(ComposurePostProcessPass)
```
...
<a id="unreal.ComposurePostProcessingPassProxy.execute"></a>

#### execute

```python
def execute(pre_pass_input: Texture,
            post_process_pass: ComposurePostProcessPassPolicy) -> None
```
...
<a id="unreal.ComposureTonemapperPass"></a>