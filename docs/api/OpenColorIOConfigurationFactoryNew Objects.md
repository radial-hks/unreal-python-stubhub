## OpenColorIOConfigurationFactoryNew Objects

```python
class OpenColorIOConfigurationFactoryNew(Factory)
```
...
- **File**: OpenColorIOConfigurationFactoryNew.h
...
<a id="unreal.OpenColorIOEditorBlueprintLibrary"></a>