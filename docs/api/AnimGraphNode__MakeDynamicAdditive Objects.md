## AnimGraphNode\_MakeDynamicAdditive Objects

```python
class AnimGraphNode_MakeDynamicAdditive(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_MakeDynamicAdditive.h
...
- ``node`` (AnimNode_MakeDynamicAdditive):  [Read-Write]
...
<a id="unreal.AnimGraphNode_MeshRefPose"></a>