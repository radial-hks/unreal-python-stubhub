## ControlRigLayerInstance Objects

```python
class ControlRigLayerInstance(AnimInstance)
```
...
- **Plugin**: ControlRig
- **Module**: ControlRig
- **File**: ControlRigLayerInstance.h
...
<a id="unreal.MovieSceneControlRigParameterSection"></a>