## DMMaterialPropertyRefraction Objects

```python
class DMMaterialPropertyRefraction(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyRoughness"></a>