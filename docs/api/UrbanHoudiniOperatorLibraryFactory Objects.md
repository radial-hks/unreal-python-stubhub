## UrbanHoudiniOperatorLibraryFactory Objects

```python
class UrbanHoudiniOperatorLibraryFactory(Factory)
```

Urban Houdini Operator Library Factory

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanHoudiniEngineEditor
- **File**: UrbanHoudiniOperatorLibraryFactory.h
...
<a id="unreal.UrbanEntityAssetFactory"></a>