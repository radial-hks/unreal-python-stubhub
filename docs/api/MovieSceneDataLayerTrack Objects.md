## MovieSceneDataLayerTrack Objects

```python
class MovieSceneDataLayerTrack(MovieSceneNameableTrack)
```
...
- **File**: MovieSceneDataLayerTrack.h
...
<a id="unreal.MovieSceneDoubleTrack"></a>