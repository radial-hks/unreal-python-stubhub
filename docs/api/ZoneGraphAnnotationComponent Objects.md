## ZoneGraphAnnotationComponent Objects

```python
class ZoneGraphAnnotationComponent(DebugDrawComponent)
```
...
- **File**: ZoneGraphAnnotationComponent.h
...
<a id="unreal.ZoneGraphAnnotationTestingComponent"></a>