## MiniMapWidgetBase Objects

```python
class MiniMapWidgetBase(UserWidget)
```

Mini Map Widget Base

**C++ Source:**

- **Plugin**: CoveringAPI
- **Module**: CoveringAPIEntity
- **File**: MiniMapWidgetBase.h
...
<a id="unreal.MiniMapWidgetBase.start_mini_map"></a>

#### start\_mini\_map

```python
def start_mini_map(position: Vector2D, size: float, bg_url: str,
                   needle_url: str, mask_url: str, frame_url: str,
                   mapping_anchors_a: Vector, mapping_anchors_b: Vector,
                   anchors: str) -> bool
```

x.start_mini_map(position, size, bg_url, needle_url, mask_url, frame_url, mapping_anchors_a, mapping_anchors_b, anchors) -> bool
Start Mini Map
...
Args:
    ...
    mask_url (str): 
    frame_url (str): 
    mapping_anchors_a (Vector): 
    mapping_anchors_b (Vector): 
    anchors (str): 

Returns:
    bool:

<a id="unreal.MiniMapWidgetBase.end_mini_map"></a>

#### end\_mini\_map

```python
def end_mini_map() -> bool
```
...
<a id="unreal.MoveAlongPathEntity"></a>