## AnimCurveCompressionSettingsFactory Objects

```python
class AnimCurveCompressionSettingsFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: AnimCurveCompressionSettingsFactory.h
...
<a id="unreal.AnimMontageFactory"></a>