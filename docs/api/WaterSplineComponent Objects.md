## WaterSplineComponent Objects

```python
class WaterSplineComponent(SplineComponent)
```
...
- ``water_spline_defaults`` (WaterSplineCurveDefaults):  [Read-Write] Defaults which are used to propagate values to spline points on instances of this in the world
