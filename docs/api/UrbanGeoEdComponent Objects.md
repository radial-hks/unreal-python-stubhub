## UrbanGeoEdComponent Objects

```python
class UrbanGeoEdComponent(PrimitiveComponent)
```

Urban Geo Ed Component

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanGeoEd
- **File**: UrbanGeoEdComponent.h
...
<a id="unreal.UrbanGeoEdEntityComponent"></a>