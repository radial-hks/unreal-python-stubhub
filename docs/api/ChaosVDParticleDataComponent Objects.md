## ChaosVDParticleDataComponent Objects

```python
class ChaosVDParticleDataComponent(ActorComponent)
```
...
- **Plugin**: ChaosVD
- **Module**: ChaosVD
- **File**: ChaosVDParticleDataComponent.h
...
<a id="unreal.ChaosVDSceneQueryDataComponent"></a>