## ImgMediaSourceFactoryNew Objects

```python
class ImgMediaSourceFactoryNew(Factory)
```
...
- **Plugin**: ImgMedia
- **Module**: ImgMediaEditor
- **File**: ImgMediaSourceFactoryNew.h
...
<a id="unreal.WebMPlatFileMediaSourceFactory"></a>