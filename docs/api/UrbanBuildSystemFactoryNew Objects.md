## UrbanBuildSystemFactoryNew Objects

```python
class UrbanBuildSystemFactoryNew(Factory)
```

Urban Build System Factory New

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanBuilderEditor
- **File**: UrbanBuildSystemFactoryNew.h
...
<a id="unreal.BaseMaterialTranslationFactory"></a>