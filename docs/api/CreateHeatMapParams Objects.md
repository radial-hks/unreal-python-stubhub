## CreateHeatMapParams Objects

```python
class CreateHeatMapParams(ParamsBase)
```

Create Heat Map Params
...
<a id="unreal.CreateHeatMapParams.__init__"></a>
...
<a id="unreal.CreateHeatMapParams.coord_z_ref"></a>
...
<a id="unreal.CreateHeatMapParams.coord_z"></a>
...
<a id="unreal.CreateHeatMapParams.heat_map_style"></a>
...
<a id="unreal.CreateHeatMapParams.heat_map_data"></a>
...
<a id="unreal.GetHeatMapParams"></a>