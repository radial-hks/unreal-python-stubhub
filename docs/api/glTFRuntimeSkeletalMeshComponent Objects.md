## glTFRuntimeSkeletalMeshComponent Objects

```python
class glTFRuntimeSkeletalMeshComponent(SkeletalMeshComponent)
```

Gl TFRuntime Skeletal Mesh Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: glTFRuntime
- **File**: glTFRuntimeSkeletalMeshComponent.h
...
<a id="unreal.glTFRuntimeSoundWave"></a>