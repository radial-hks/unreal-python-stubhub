## DataflowEditorCollectionComponent Objects

```python
class DataflowEditorCollectionComponent(DynamicMeshComponent)
```
...
- **File**: DataflowEditorCollectionComponent.h
...
<a id="unreal.GeometryCollectionCacheFactory"></a>