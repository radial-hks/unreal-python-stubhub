## WaterBodyInfoMeshComponent Objects

```python
class WaterBodyInfoMeshComponent(WaterBodyMeshComponent)
```
...
- **Plugin**: Water
- **Module**: Water
- **File**: WaterBodyInfoMeshComponent.h
