## EarthTextureOverlayerSettings Objects

```python
class EarthTextureOverlayerSettings(StructBase)
```

Earth Texture Overlayer Settings
...
<a id="unreal.EarthTextureOverlayerSettings.__init__"></a>
...
<a id="unreal.EarthDomOverlayerSettings"></a>