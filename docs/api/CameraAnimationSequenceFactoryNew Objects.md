## CameraAnimationSequenceFactoryNew Objects

```python
class CameraAnimationSequenceFactoryNew(Factory)
```
...
- **File**: CameraAnimationSequenceFactoryNew.h
...
<a id="unreal.TemplateSequenceFactoryNew"></a>