## UrbanGeoEdWayComponent Objects

```python
class UrbanGeoEdWayComponent(UrbanGeoEdComponent)
```

Urban Geo Ed Way Component

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanGeoEd
- **File**: UrbanGeoEdWayComponent.h
