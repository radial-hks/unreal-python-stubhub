## AnimGraphNode\_TransitionResult Objects

```python
class AnimGraphNode_TransitionResult(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_TransitionResult.h
...
- ``node`` (AnimNode_TransitionResult):  [Read-Write]
...
<a id="unreal.AnimGraphNode_TwistCorrectiveNode"></a>