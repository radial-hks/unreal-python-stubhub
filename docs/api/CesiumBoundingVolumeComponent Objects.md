## CesiumBoundingVolumeComponent Objects

```python
class CesiumBoundingVolumeComponent(PrimitiveComponent)
```

Cesium Bounding Volume Component
...
<a id="unreal.CesiumCameraManager"></a>