## EarthSplineCurveFragment Objects

```python
class EarthSplineCurveFragment(EarthPrimitiveFragment)
```
...
- ``spline_curve`` (EarthSplineCurves):  [Read-Write] 样条线
- ``valid`` (bool):  [Read-Write] 数据片段是否有效
- ``validated`` (bool):  [Read-Write] 是否已执行数据有效性验证
- ``vertices`` (Array[Vector]):  [Read-Write] 顶点数组

<a id="unreal.EarthSplineCurveFragment.__init__"></a>
...
<a id="unreal.EarthSplineCurves"></a>