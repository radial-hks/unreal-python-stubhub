## PoseSearchDatabaseFactory Objects

```python
class PoseSearchDatabaseFactory(Factory)
```
...
- **File**: PoseSearchDatabaseFactory.h
...
<a id="unreal.PoseSearchInteractionAssetFactory"></a>