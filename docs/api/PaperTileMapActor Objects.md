## PaperTileMapActor Objects

```python
class PaperTileMapActor(Actor)
```
...
- ``render_component`` (PaperTileMapComponent):  [Read-Only]
...
```python
@property
def render_component() -> PaperTileMapComponent
```

(PaperTileMapComponent):  [Read-Only]

<a id="unreal.PaperTileMapComponent"></a>