## HeatMapFilterParam Objects

```python
class HeatMapFilterParam(ParamsBase)
```

Heat Map Filter Param
...
<a id="unreal.HeatMapFilterParam.__init__"></a>
...
<a id="unreal.HeatMapFilterParam.eid"></a>
...
<a id="unreal.HeatMapFilterParam.filter_value_range"></a>
...
<a id="unreal.UnHeatMapFilterParam"></a>