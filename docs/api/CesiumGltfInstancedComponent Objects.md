## CesiumGltfInstancedComponent Objects

```python
class CesiumGltfInstancedComponent(InstancedStaticMeshComponent)
```

Cesium Gltf Instanced Component

**C++ Source:**

- **Plugin**: CesiumForUnreal
- **Module**: CesiumRuntime
- **File**: CesiumGltfPrimitiveComponent.h
...
<a id="unreal.CesiumIonRasterOverlay"></a>