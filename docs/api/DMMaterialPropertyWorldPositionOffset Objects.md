## DMMaterialPropertyWorldPositionOffset Objects

```python
class DMMaterialPropertyWorldPositionOffset(DMMaterialProperty)
```
...
- **File**: DMMPWorldPositionOffset.h
...
<a id="unreal.DMMaterialStageBlendAdd"></a>