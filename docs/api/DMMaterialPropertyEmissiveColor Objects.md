## DMMaterialPropertyEmissiveColor Objects

```python
class DMMaterialPropertyEmissiveColor(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyMetallic"></a>