## AnimGraphNode\_ScaleChainLength Objects

```python
class AnimGraphNode_ScaleChainLength(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_ScaleChainLength.h
...
- ``node`` (AnimNode_ScaleChainLength):  [Read-Write]
...
<a id="unreal.AnimGraphNode_SequenceEvaluator"></a>