## AnimGraphNode\_IdentityPose Objects

```python
class AnimGraphNode_IdentityPose(AnimGraphNode_RefPoseBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_IdentityPose.h
...
<a id="unreal.AnimGraphNode_Inertialization"></a>