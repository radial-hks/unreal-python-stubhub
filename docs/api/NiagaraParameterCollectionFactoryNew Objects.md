## NiagaraParameterCollectionFactoryNew Objects

```python
class NiagaraParameterCollectionFactoryNew(Factory)
```
...
<a id="unreal.NiagaraParameterCollectionInstanceFactoryNew"></a>