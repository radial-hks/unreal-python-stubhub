## AnimGraphNode\_ApplyMeshSpaceAdditive Objects

```python
class AnimGraphNode_ApplyMeshSpaceAdditive(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_ApplyMeshSpaceAdditive.h
...
- ``node`` (AnimNode_ApplyMeshSpaceAdditive):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BlendBoneByChannel"></a>