## GeometryCollectionRenderLevelSetActor Objects

```python
class GeometryCollectionRenderLevelSetActor(Actor)
```
...
- **File**: GeometryCollectionRenderLevelSetActor.h
...
- ``enabled`` (bool):  [Read-Write] Enable or disable rendering
...
- ``render_volume_bounding_box`` (bool):  [Read-Write] Enable or disable rendering
...
- ``target_volume_texture`` (VolumeTexture):  [Read-Write] Volume texture to fill
...
```python
@property
def target_volume_texture() -> VolumeTexture
```

(VolumeTexture):  [Read-Write] Volume texture to fill
...
def target_volume_texture(value: VolumeTexture) -> None
```
...
```python
@property
def ray_march_material() -> Material
```

(Material):  [Read-Write] Material that performs ray marching.  Note this must have certain parameters in order
to work correctly
...
def ray_march_material(value: Material) -> None
```
...
```python
@property
def surface_tolerance() -> float
```

(float):  [Read-Write] Surface tolerance used for rendering.  When surface reconstruction is noisy,
try tweaking this value
...
def surface_tolerance(value: float) -> None
```

<a id="unreal.GeometryCollectionRenderLevelSetActor.isovalue"></a>
...
(float):  [Read-Write] Isovalue of the level set to use for surface reconstruction.  Generally you want
this to be zero, but it can be useful for exploring the distance values to make
this negative to see the interior structure of the levelset
...
```python
@isovalue.setter
def isovalue(value: float) -> None
```

<a id="unreal.GeometryCollectionRenderLevelSetActor.enabled"></a>
...
(bool):  [Read-Write] Enable or disable rendering
...
```python
@property
def render_volume_bounding_box() -> bool
```
...
def render_volume_bounding_box(value: bool) -> None
```

<a id="unreal.GeometryCollectionISMPoolDebugDrawComponent"></a>