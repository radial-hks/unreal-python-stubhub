## InterchangeImportTestPlanFactory Objects

```python
class InterchangeImportTestPlanFactory(Factory)
```

Interchange Import Test Plan Factory

**C++ Source:**

- **Plugin**: InterchangeTests
- **Module**: InterchangeTestEditor
- **File**: InterchangeImportTestPlanFactory.h
...
<a id="unreal.EditorFunctionalTest"></a>