## LandmassErosionBrushBase Objects

```python
class LandmassErosionBrushBase(LandscapeBlueprintBrushBase)
```
...
- **File**: LandmassErosionBrushBase.h
...
<a id="unreal.LandmassManagerBase"></a>