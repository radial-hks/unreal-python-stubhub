...
```python
@property
def authority_game_mode() -> GameModeBase
```
...
```python
@property
def player_array() -> Array[PlayerState]
```
...
x.get_server_world_time_seconds() -> double
