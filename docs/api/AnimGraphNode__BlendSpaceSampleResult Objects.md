## AnimGraphNode\_BlendSpaceSampleResult Objects

```python
class AnimGraphNode_BlendSpaceSampleResult(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendSpaceSampleResult.h
...
- ``node`` (AnimNode_BlendSpaceSampleResult):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BoneDrivenController"></a>