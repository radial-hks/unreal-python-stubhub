## DMMaterialStageExpressionSmoothStep Objects

```python
class DMMaterialStageExpressionSmoothStep(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionSquareRoot"></a>