## AnimGraphNode\_RandomPlayer Objects

```python
class AnimGraphNode_RandomPlayer(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_RandomPlayer.h
...
- ``node`` (AnimNode_RandomPlayer):  [Read-Write]
...
<a id="unreal.AnimGraphNode_ResetRoot"></a>