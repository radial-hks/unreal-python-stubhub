...
- ``on_clicked`` (OnWdpButtonClickedEvent):  [Read-Write] Called when the button is clicked
- ``on_double_clicked`` (OnWdpButtonClickedEvent):  [Read-Write]
- ``on_hovered`` (OnWdpButtonHoverEvent):  [Read-Write]
- ``on_pressed`` (OnWdpButtonPressedEvent):  [Read-Write] Called when the button is pressed
- ``on_released`` (OnWdpButtonReleasedEvent):  [Read-Write] Called when the button is released
- ``on_unhovered`` (OnWdpButtonHoverEvent):  [Read-Write]
...
<a id="unreal.WdpButton.widget_style"></a>
...
<a id="unreal.WdpButton.color_and_opacity"></a>
...
<a id="unreal.WdpButton.background_color"></a>
...
<a id="unreal.WdpButton.click_method"></a>
...
<a id="unreal.WdpButton.touch_method"></a>
...
<a id="unreal.WdpButton.press_method"></a>
...
<a id="unreal.WdpButton.is_focusable"></a>
...
<a id="unreal.WdpButton.on_clicked"></a>

#### on\_clicked

```python
@property
def on_clicked() -> OnWdpButtonClickedEvent
```

(OnWdpButtonClickedEvent):  [Read-Write] Called when the button is clicked
...
```python
@on_clicked.setter
def on_clicked(value: OnWdpButtonClickedEvent) -> None
```

<a id="unreal.WdpButton.on_double_clicked"></a>

#### on\_double\_clicked

```python
@property
def on_double_clicked() -> OnWdpButtonClickedEvent
```

(OnWdpButtonClickedEvent):  [Read-Write]
...
def on_double_clicked(value: OnWdpButtonClickedEvent) -> None
```

<a id="unreal.WdpButton.on_pressed"></a>

#### on\_pressed

```python
@property
def on_pressed() -> OnWdpButtonPressedEvent
```

(OnWdpButtonPressedEvent):  [Read-Write] Called when the button is pressed
...
```python
@on_pressed.setter
def on_pressed(value: OnWdpButtonPressedEvent) -> None
```

<a id="unreal.WdpButton.on_released"></a>

#### on\_released

```python
@property
def on_released() -> OnWdpButtonReleasedEvent
```

(OnWdpButtonReleasedEvent):  [Read-Write] Called when the button is released
...
```python
@on_released.setter
def on_released(value: OnWdpButtonReleasedEvent) -> None
```

<a id="unreal.WdpButton.on_hovered"></a>

#### on\_hovered

```python
@property
def on_hovered() -> OnWdpButtonHoverEvent
```

(OnWdpButtonHoverEvent):  [Read-Write]
...
```python
@on_hovered.setter
def on_hovered(value: OnWdpButtonHoverEvent) -> None
```

<a id="unreal.WdpButton.on_unhovered"></a>

#### on\_unhovered

```python
@property
def on_unhovered() -> OnWdpButtonHoverEvent
```
...
```python
@on_unhovered.setter
def on_unhovered(value: OnWdpButtonHoverEvent) -> None
```

<a id="unreal.WdpButton.set_touch_method"></a>
...
<a id="unreal.WdpButton.set_style"></a>
...
<a id="unreal.WdpButton.set_press_method"></a>
...
<a id="unreal.WdpButton.set_color_and_opacity"></a>
...
<a id="unreal.WdpButton.set_click_method"></a>
...
<a id="unreal.WdpButton.set_background_color"></a>
...
<a id="unreal.WdpButton.is_pressed"></a>
