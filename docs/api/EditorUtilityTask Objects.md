## EditorUtilityTask Objects

```python
class EditorUtilityTask(Object)
```
...
x.receive_cancel_requested() -> None
Receive Cancel Requested
...
x.get_task_title_override() -> Text
Get Task Title Override
...
<a id="unreal.EditorUtilityToolMenuEntry"></a>