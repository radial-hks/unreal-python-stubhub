## UrbanGeoEdNodeComponent Objects

```python
class UrbanGeoEdNodeComponent(UrbanGeoEdComponent)
```

Urban Geo Ed Node Component

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanGeoEd
- **File**: UrbanGeoEdNodeComponent.h
...
<a id="unreal.UrbanGeoEdTerrainTileComponent"></a>