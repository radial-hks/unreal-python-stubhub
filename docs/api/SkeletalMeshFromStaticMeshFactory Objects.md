## SkeletalMeshFromStaticMeshFactory Objects

```python
class SkeletalMeshFromStaticMeshFactory(Factory)
```

Skeletal Mesh from Static Mesh Factory

**C++ Source:**

- **Plugin**: SkeletalMeshModelingTools
- **Module**: SkeletalMeshModelingTools
- **File**: SkeletalMeshModelingToolsMeshConverter.h
...
<a id="unreal.MetaHumanComponentBase"></a>