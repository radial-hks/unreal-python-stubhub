## UrbanEntityAssetManagerFactory Objects

```python
class UrbanEntityAssetManagerFactory(Factory)
```

Urban Entity Asset Manager Factory

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanEntityEditor
- **File**: UrbanEntityAssetManagerFactory.h
...
<a id="unreal.UrbanEntityEditorBp"></a>