## ResonanceAudioReverbPluginPresetFactory Objects

```python
class ResonanceAudioReverbPluginPresetFactory(Factory)
```

Resonance Audio Reverb Plugin Preset Factory

**C++ Source:**

- **Plugin**: ResonanceAudio
- **Module**: ResonanceAudioEditor
- **File**: ResonanceAudioReverbPluginPresetFactory.h
...
<a id="unreal.ResonanceAudioSpatializationSourceSettingsFactory"></a>