## AnimationSharingSetupFactory Objects

```python
class AnimationSharingSetupFactory(Factory)
```

Animation Sharing Setup Factory

**C++ Source:**

- **Plugin**: AnimationSharing
- **Module**: AnimationSharingEd
- **File**: AnimationSharingSetupFactory.h
