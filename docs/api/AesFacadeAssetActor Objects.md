## AesFacadeAssetActor Objects

```python
class AesFacadeAssetActor(AesAssetActorBase)
```
...
<a id="unreal.AesFacadeAssetActor.tag_data"></a>
...
<a id="unreal.AesGridLayoutAssetActor"></a>