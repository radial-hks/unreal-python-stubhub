## SVGDynamicMeshComponent Objects

```python
class SVGDynamicMeshComponent(SVGBaseDynamicMeshComponent)
```
...
- ``extrude`` (float):  [Read-Write]
- ``extrude_type`` (SVGExtrudeType):  [Read-Only]
...
<a id="unreal.SVGDynamicMeshComponent.color"></a>
...
<a id="unreal.SVGDynamicMeshComponent.extrude"></a>
...
<a id="unreal.SVGDynamicMeshComponent.set_color"></a>
...
<a id="unreal.SVGFillComponent"></a>