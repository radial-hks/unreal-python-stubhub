## AesCollisionComponentBase Objects

```python
class AesCollisionComponentBase(PrimitiveComponent)
```

Aes Collision Component Base

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesRenderResource
- **File**: AesCollisionComponentBase.h
...
<a id="unreal.AesCollisionComponent"></a>