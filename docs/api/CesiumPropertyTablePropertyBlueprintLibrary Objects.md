## CesiumPropertyTablePropertyBlueprintLibrary Objects

```python
class CesiumPropertyTablePropertyBlueprintLibrary(BlueprintFunctionLibrary)
```

Cesium Property Table Property Blueprint Library
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.is_normalized"></a>

#### is\_normalized

```python
@classmethod
def is_normalized(cls, property_: CesiumPropertyTableProperty) -> bool
```
...
Args:
    property_ (CesiumPropertyTableProperty): 

Returns:
    bool: Whether this property is normalized.

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_vector4"></a>

#### get\_vector4

```python
@classmethod
def get_vector4(cls, property_: CesiumPropertyTableProperty, feature_id: int,
                default_value: Vector4) -> Vector4
```

X.get_vector4(property_, feature_id, default_value) -> Vector4
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_vector3f"></a>

#### get\_vector3f

```python
@classmethod
def get_vector3f(cls, property_: CesiumPropertyTableProperty, feature_id: int,
                 default_value: Vector3f) -> Vector3f
```

X.get_vector3f(property_, feature_id, default_value) -> Vector3f
...
Args:
    property_ (CesiumPropertyTableProperty): 
    feature_id (int64): The ID of the feature.
    default_value (Vector3f): The default value to fall back on.

Returns:
    Vector3f: The property value as a FVector3f.

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_vector2d"></a>

#### get\_vector2d

```python
@classmethod
def get_vector2d(cls, property_: CesiumPropertyTableProperty, feature_id: int,
                 default_value: Vector2D) -> Vector2D
```

X.get_vector2d(property_, feature_id, default_value) -> Vector2D
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_vector"></a>

#### get\_vector

```python
@classmethod
def get_vector(cls, property_: CesiumPropertyTableProperty, feature_id: int,
               default_value: Vector) -> Vector
```

X.get_vector(property_, feature_id, default_value) -> Vector
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_value_type"></a>
...
def get_value_type(
        cls,
        property_: CesiumPropertyTableProperty) -> CesiumMetadataValueType
```
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_value"></a>

#### get\_value

```python
@classmethod
def get_value(cls, property_: CesiumPropertyTableProperty,
              feature_id: int) -> CesiumMetadataValue
```

X.get_value(property_, feature_id) -> CesiumMetadataValue
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_true_type"></a>
...
@classmethod
def get_true_type(
        cls, value: CesiumPropertyTableProperty
...
Args:
    value (CesiumPropertyTableProperty): 

Returns:
    CesiumMetadataTrueType_DEPRECATED:

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_true_component_type"></a>
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_string"></a>
...
X.get_string(property_, feature_id, default_value="") -> str
...
Args:
    property_ (CesiumPropertyTableProperty): 
    feature_id (int64): The ID of the feature.
    default_value (str): The default value to fall back on.

Returns:
    str: The property value as a FString.

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_scale"></a>
...
@classmethod
def get_scale(cls,
              property_: CesiumPropertyTableProperty) -> CesiumMetadataValue
```
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_raw_value"></a>

#### get\_raw\_value

```python
@classmethod
def get_raw_value(cls, property_: CesiumPropertyTableProperty,
                  feature_id: int) -> CesiumMetadataValue
```

X.get_raw_value(property_, feature_id) -> CesiumMetadataValue
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_property_table_property_status"></a>

#### get\_property\_table\_property\_status

```python
@classmethod
def get_property_table_property_status(
    cls, property_: CesiumPropertyTableProperty
) -> CesiumPropertyTablePropertyStatus
```

X.get_property_table_property_status(property_) -> CesiumPropertyTablePropertyStatus
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_property_size"></a>

#### get\_property\_size

```python
@classmethod
def get_property_size(cls, property_: CesiumPropertyTableProperty) -> int
```

X.get_property_size(property_) -> int64
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_offset"></a>
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_number_of_features"></a>

#### get\_number\_of\_features

```python
@classmethod
def get_number_of_features(cls, property_: CesiumPropertyTableProperty) -> int
```

X.get_number_of_features(property_) -> int64
Gets the number of values in this property.
deprecated: Use GetPropertySize instead.
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_no_data_value"></a>
...
def get_no_data_value(
        cls, property_: CesiumPropertyTableProperty) -> CesiumMetadataValue
```
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_minimum_value"></a>
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_maximum_value"></a>
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_matrix"></a>

#### get\_matrix

```python
@classmethod
def get_matrix(cls, property_: CesiumPropertyTableProperty, feature_id: int,
               default_value: Matrix) -> Matrix
```

X.get_matrix(property_, feature_id, default_value) -> Matrix
...
Args:
    property_ (CesiumPropertyTableProperty): 
    feature_id (int64): The ID of the feature.
    default_value (Matrix): The default value to fall back on.

Returns:
    Matrix: The property value as a FMatrix.

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_int_vector"></a>

#### get\_int\_vector

```python
@classmethod
def get_int_vector(cls, property_: CesiumPropertyTableProperty,
                   feature_id: int, default_value: IntVector) -> IntVector
```

X.get_int_vector(property_, feature_id, default_value) -> IntVector
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_int_point"></a>

#### get\_int\_point

```python
@classmethod
def get_int_point(cls, property_: CesiumPropertyTableProperty, feature_id: int,
                  default_value: IntPoint) -> IntPoint
```

X.get_int_point(property_, feature_id, default_value) -> IntPoint
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_integer64"></a>
...
X.get_integer64(property_, feature_id, default_value=0) -> int64
...
Args:
    property_ (CesiumPropertyTableProperty): 
    feature_id (int64): The ID of the feature.
    default_value (int64): The default value to fall back on.

Returns:
    int64: The property value as an Integer64.

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_integer"></a>
...
X.get_integer(property_, feature_id, default_value=0) -> int32
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_generic_value"></a>

#### get\_generic\_value

```python
@classmethod
def get_generic_value(cls, property_: CesiumPropertyTableProperty,
                      feature_id: int) -> CesiumMetadataValue
```

X.get_generic_value(property_, feature_id) -> CesiumMetadataValue
Retrieves the value of the property for the given feature. This allows the
value to be acted on more generically; its true value can be retrieved
later as a specific Blueprints type.
deprecated: Function 'GetGenericValue' is deprecated.
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_float64"></a>
...
X.get_float64(property_, feature_id, default_value=0.000000) -> double
...
Returns:
    double: The property value as a Float64.

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_float"></a>
...
X.get_float(property_, feature_id, default_value=0.000000) -> float
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_default_value"></a>
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_component_count"></a>

#### get\_component\_count

```python
@classmethod
def get_component_count(cls, property_: CesiumPropertyTableProperty) -> int
```
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_byte"></a>
...
X.get_byte(property_, feature_id, default_value=0) -> uint8
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_boolean"></a>
...
X.get_boolean(property_, feature_id, default_value=False) -> bool
...
Returns:
    bool: The property value as a Boolean.

<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_blueprint_type"></a>
...
def get_blueprint_type(
        cls,
        property_: CesiumPropertyTableProperty) -> CesiumMetadataBlueprintType
```
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_blueprint_component_type"></a>
...
X.get_blueprint_component_type(property_) -> CesiumMetadataBlueprintType
...
returns None.
deprecated: Use GetArrayElementBlueprintType instead.
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_array_size"></a>

#### get\_array\_size

```python
@classmethod
def get_array_size(cls, property_: CesiumPropertyTableProperty) -> int
```
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_array_element_blueprint_type"></a>
...
<a id="unreal.CesiumPropertyTablePropertyBlueprintLibrary.get_array"></a>

#### get\_array

```python
@classmethod
def get_array(cls, property_: CesiumPropertyTableProperty,
              feature_id: int) -> CesiumPropertyArray
```

X.get_array(property_, feature_id) -> CesiumPropertyArray
...
<a id="unreal.CesiumMetadataPropertyBlueprintLibrary"></a>