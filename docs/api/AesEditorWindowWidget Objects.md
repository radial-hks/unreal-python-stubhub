## AesEditorWindowWidget Objects

```python
class AesEditorWindowWidget(UserWidget)
```

Aes Editor Window Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: AesEditorWindow.h
...
- ``widget_container`` (WidgetSwitcher):  [Read-Write]

<a id="unreal.AesEditorWindowWidget.widget_container"></a>

#### widget\_container

```python
@property
def widget_container() -> WidgetSwitcher
```
...
```python
@widget_container.setter
def widget_container(value: WidgetSwitcher) -> None
```

<a id="unreal.AesEditorWindowWidget.get_widget"></a>
...
<a id="unreal.EarthColorPicker"></a>