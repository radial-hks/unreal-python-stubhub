## HLODInstancedStaticMeshComponent Objects

```python
class HLODInstancedStaticMeshComponent(InstancedStaticMeshComponent)
```

HLODInstanced Static Mesh Component

**C++ Source:**

- **Module**: Engine
- **File**: HLODInstancedStaticMeshComponent.h
...
<a id="unreal.HierarchicalLODSetup"></a>