## MovieSceneAnimatorTrack Objects

```python
class MovieSceneAnimatorTrack(MovieSceneNameableTrack)
```
...
- **File**: MovieSceneAnimatorTrack.h
...
<a id="unreal.PropertyAnimatorCorePresetBase"></a>