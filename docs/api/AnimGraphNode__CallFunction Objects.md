## AnimGraphNode\_CallFunction Objects

```python
class AnimGraphNode_CallFunction(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_CallFunction.h
...
- ``node`` (AnimNode_CallFunction):  [Read-Write]
...
<a id="unreal.AnimGraphNode_CCDIK"></a>