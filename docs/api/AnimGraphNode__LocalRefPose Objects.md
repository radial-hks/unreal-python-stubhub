## AnimGraphNode\_LocalRefPose Objects

```python
class AnimGraphNode_LocalRefPose(AnimGraphNode_RefPoseBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_LocalRefPose.h
...
- ``node`` (AnimNode_RefPose):  [Read-Write]
...
<a id="unreal.AnimGraphNode_LocalToComponentSpace"></a>