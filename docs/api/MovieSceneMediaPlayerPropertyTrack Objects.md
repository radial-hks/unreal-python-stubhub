## MovieSceneMediaPlayerPropertyTrack Objects

```python
class MovieSceneMediaPlayerPropertyTrack(MovieScenePropertyTrack)
```
...
- **File**: MovieSceneMediaPlayerPropertyTrack.h
...
<a id="unreal.MovieSceneMediaSection"></a>