## DMMaterialStageExpressionMultiply Objects

```python
class DMMaterialStageExpressionMultiply(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionObjectBounds"></a>