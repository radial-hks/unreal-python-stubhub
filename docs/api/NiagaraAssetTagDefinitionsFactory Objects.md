## NiagaraAssetTagDefinitionsFactory Objects

```python
class NiagaraAssetTagDefinitionsFactory(Factory)
```
...
- **File**: NiagaraAssetTagDefinitionsFactory.h
...
<a id="unreal.NiagaraDataChannelAssetFactoryNew"></a>