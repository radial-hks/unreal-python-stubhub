## FoliageInstancedStaticMeshComponent Objects
...
- ``on_instance_take_point_damage`` (InstancePointDamageSignature):  [Read-Write]
- ``on_instance_take_radial_damage`` (InstanceRadialDamageSignature):  [Read-Write]
...
```python
@property
def on_instance_take_point_damage() -> InstancePointDamageSignature
```

(InstancePointDamageSignature):  [Read-Write]
...
def on_instance_take_point_damage(value: InstancePointDamageSignature) -> None
```
...
```python
@property
def on_instance_take_radial_damage() -> InstanceRadialDamageSignature
```

(InstanceRadialDamageSignature):  [Read-Write]
...
def on_instance_take_radial_damage(
        value: InstanceRadialDamageSignature) -> None
```

<a id="unreal.FoliageType"></a>