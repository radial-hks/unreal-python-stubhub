## MaterialExpressionTextureSampleParameterAnim Objects

```python
class MaterialExpressionTextureSampleParameterAnim(
        MaterialExpressionTextureSampleParameter)
```

Material Expression Texture Sample Parameter Anim

**C++ Source:**

- **Plugin**: CoveringAPI
- **Module**: CoveringAPIEntity
- **File**: MaterialExpressionTextureSampleParameterAnim.h
