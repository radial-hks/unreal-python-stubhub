## AnimGraphNode\_ControlRig Objects

```python
class AnimGraphNode_ControlRig(AnimGraphNode_CustomProperty)
```
...
- **File**: AnimGraphNode_ControlRig.h
...
- ``node`` (AnimNode_ControlRig):  [Read-Write]
...
<a id="unreal.ControlRigBlueprint"></a>