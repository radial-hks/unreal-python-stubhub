## NiagaraEmitterFactoryNew Objects

```python
class NiagaraEmitterFactoryNew(Factory)
```
...
- **File**: NiagaraEmitterFactoryNew.h
...
<a id="unreal.NiagaraParameterCollectionFactoryNew"></a>