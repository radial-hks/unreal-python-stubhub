## WaterBodyCustomComponent Objects

```python
class WaterBodyCustomComponent(WaterBodyComponent)
```
...
- **Plugin**: Water
- **Module**: Water
- **File**: WaterBodyCustomComponent.h
...
<a id="unreal.WaterBodyExclusionVolume"></a>