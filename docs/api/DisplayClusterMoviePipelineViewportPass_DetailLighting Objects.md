## DisplayClusterMoviePipelineViewportPass_DetailLighting Objects

```python
class DisplayClusterMoviePipelineViewportPass_DetailLighting(
...
<a id="unreal.DisplayClusterMoviePipelineViewportPass_LightingOnly"></a>