## MonoWaveTableSynthPresetFactory Objects

```python
class MonoWaveTableSynthPresetFactory(Factory)
```

Mono Wave Table Synth Preset Factory

**C++ Source:**

- **Plugin**: Synthesis
- **Module**: SynthesisEditor
- **File**: MonoWaveTablePresetBank.h
