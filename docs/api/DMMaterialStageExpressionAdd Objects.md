## DMMaterialStageExpressionAdd Objects

```python
class DMMaterialStageExpressionAdd(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionArccosine"></a>