## SmartObjectContainerRenderingComponent Objects

```python
class SmartObjectContainerRenderingComponent(PrimitiveComponent)
```
...
- **File**: SmartObjectContainerRenderingComponent.h
...
<a id="unreal.SmartObjectDebugRenderingComponent"></a>