## AnimGraphNode\_BlendSpaceGraph Objects

```python
class AnimGraphNode_BlendSpaceGraph(AnimGraphNode_BlendSpaceGraphBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_BlendSpaceGraph.h
...
- ``node`` (AnimNode_BlendSpaceGraph):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BlendSpacePlayer"></a>