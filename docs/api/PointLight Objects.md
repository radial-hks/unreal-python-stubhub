...
- ``point_light_component`` (PointLightComponent):  [Read-Only]
...
```python
@property
def point_light_component() -> PointLightComponent
```

(PointLightComponent):  [Read-Only]
...
<a id="unreal.PointLightMovable"></a>