## MassStationaryDistanceVisualizationTrait Objects

```python
class MassStationaryDistanceVisualizationTrait(MassDistanceVisualizationTrait)
```
...
- **File**: MassStationaryDistanceVisualizationTrait.h
...
<a id="unreal.MassStationaryVisualizationTrait"></a>