## EarthCollisionComponent Objects

```python
class EarthCollisionComponent(EarthCollisionComponentBase)
```

Earth Collision Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: EarthPrefab
- **File**: EarthCollisionComponent.h
...
- ``index_buffer`` (Array[int32]):  [Read-Write] 本地空间的包围盒数据
...
- ``local_bounds`` (BoxSphereBounds):  [Read-Write] 本地空间的包围盒数据
...
- ``use_async_cook`` (bool):  [Read-Write] 是否使用异步烘焙碰撞
- ``use_attach_parent_bound`` (bool):  [Read-Write] If true, this component uses its parents bounds when attached.
  This can be a significant optimization with many components attached together.
- ``vertex_buffer`` (Array[Vector3f]):  [Read-Write] 本地空间的包围盒数据
...
<a id="unreal.EarthCollisionComponent.override_wireframe_color"></a>
...
<a id="unreal.EarthCollisionComponent.wireframe_color_override"></a>
...
<a id="unreal.EarthCollisionComponent.use_async_cook"></a>

#### use\_async\_cook

```python
@property
def use_async_cook() -> bool
```

(bool):  [Read-Only] 是否使用异步烘焙碰撞

<a id="unreal.EarthCollisionComponent.local_bounds"></a>
...
(BoxSphereBounds):  [Read-Write] 本地空间的包围盒数据
...
<a id="unreal.EarthCollisionComponent.vertex_buffer"></a>
...
(Array[Vector3f]):  [Read-Write] 本地空间的包围盒数据
...
<a id="unreal.EarthCollisionComponent.index_buffer"></a>
...
(Array[int32]):  [Read-Write] 本地空间的包围盒数据
...
<a id="unreal.EarthDataTypeLibrary"></a>