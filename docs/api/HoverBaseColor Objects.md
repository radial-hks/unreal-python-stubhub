## HoverBaseColor Objects

```python
class HoverBaseColor(ParamsBase)
```
...
<a id="unreal.HoverBaseColor.__init__"></a>
...
<a id="unreal.HoverBaseColor.entity_type"></a>
...
<a id="unreal.HoverBaseColor.base_color"></a>
...
<a id="unreal.EntitySelectionChangedEventArgs"></a>