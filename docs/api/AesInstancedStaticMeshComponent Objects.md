## AesInstancedStaticMeshComponent Objects

```python
class AesInstancedStaticMeshComponent(InstancedStaticMeshComponent)
```

Aes Instanced Static Mesh Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesRenderResource
- **File**: AesInstancedStaticMeshComponent.h
...
- ``collision_data`` (KAggregateGeom):  [Read-Write] 碰撞数据
...
<a id="unreal.AesInstancedStaticMeshComponent.allow_create_physics_state"></a>
...
<a id="unreal.AesInstancedStaticMeshComponent.local_bounds"></a>
...
<a id="unreal.AesInstancedStaticMeshComponent.set_bounds"></a>
...
<a id="unreal.AesLandmarkActor"></a>