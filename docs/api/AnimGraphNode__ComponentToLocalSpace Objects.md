## AnimGraphNode\_ComponentToLocalSpace Objects

```python
class AnimGraphNode_ComponentToLocalSpace(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_ComponentToLocalSpace.h
...
- ``node`` (AnimNode_ConvertComponentToLocalSpace):  [Read-Write]
...
<a id="unreal.AnimGraphNode_Constraint"></a>