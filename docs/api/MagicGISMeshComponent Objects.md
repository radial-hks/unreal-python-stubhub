## MagicGISMeshComponent Objects

```python
class MagicGISMeshComponent(MeshComponent)
```

Magic GISMesh Component

**C++ Source:**

- **Plugin**: GISDataAPI
- **Module**: MagicGISCore
- **File**: MagicGISMeshComponent.h
...
<a id="unreal.MagicGISViewActor"></a>