## SharedMemoryMediaOutputFactory Objects

```python
class SharedMemoryMediaOutputFactory(Factory)
```
...
- **File**: SharedMemoryMediaOutputFactory.h
...
<a id="unreal.SharedMemoryMediaSourceFactory"></a>