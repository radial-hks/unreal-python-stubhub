## AnimGraphNode\_ResetRoot Objects

```python
class AnimGraphNode_ResetRoot(AnimGraphNode_SkeletalControlBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_ResetRoot.h
...
- ``node`` (AnimNode_ResetRoot):  [Read-Write]
...
<a id="unreal.AnimGraphNode_RigidBody"></a>