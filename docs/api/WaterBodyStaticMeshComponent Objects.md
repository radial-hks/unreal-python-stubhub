## WaterBodyStaticMeshComponent Objects

```python
class WaterBodyStaticMeshComponent(WaterBodyMeshComponent)
```
...
- **Plugin**: Water
- **Module**: Water
- **File**: WaterBodyStaticMeshComponent.h
...
<a id="unreal.WaterTerrainComponent"></a>