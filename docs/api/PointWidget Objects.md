...
- ``data`` (PointGraphicsData):  [Read-Write]
...
<a id="unreal.PointWidget.data"></a>

#### data

```python
@property
def data() -> PointGraphicsData
```

(PointGraphicsData):  [Read-Write]
...
```python
@data.setter
def data(value: PointGraphicsData) -> None
```

<a id="unreal.PointWidget.set_image_color"></a>

#### set\_image\_color

```python
def set_image_color(in_color: LinearColor) -> None
```

x.set_image_color(in_color) -> None
Set Image Color

Args:
    in_color (LinearColor):

<a id="unreal.PointWidget.set_data"></a>

#### set\_data

```python
def set_data(new_data: PointGraphicsData) -> None
```

x.set_data(new_data) -> None
Set Data

Args:
    new_data (PointGraphicsData):

<a id="unreal.PointWidget.refresh_widget"></a>
...
x.refresh_widget() -> None
Refresh Widget

<a id="unreal.PointWidget.on_close_clicked"></a>
...
x.on_close_clicked() -> None
On Close Clicked

<a id="unreal.PointWidget.get_data"></a>

#### get\_data

```python
def get_data() -> PointGraphicsData
```

x.get_data() -> PointGraphicsData
Get Data

Returns:
    PointGraphicsData:

<a id="unreal.PolygonsGraphicsEntity"></a>