## CreateWindowsParams Objects

```python
class CreateWindowsParams(StructBase)
```

Create Windows Params
...
<a id="unreal.CreateWindowsParams.__init__"></a>
...
<a id="unreal.CreateWindowsParams.point_entity_eid"></a>
...
<a id="unreal.CreateWindowsParams.window_style"></a>
...
<a id="unreal.CreateWindowsParams.coord_z_ref"></a>
...
<a id="unreal.CreateWindowParams_Batch"></a>