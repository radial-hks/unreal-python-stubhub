## SparseVolumeTextureFactory Objects

```python
class SparseVolumeTextureFactory(Factory)
```
...
- **Module**: SparseVolumeTexture
- **File**: SparseVolumeTextureFactory.h
...
<a id="unreal.NiagaraAssetTagDefinitionsFactory"></a>