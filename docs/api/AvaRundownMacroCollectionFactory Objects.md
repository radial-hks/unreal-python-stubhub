## AvaRundownMacroCollectionFactory Objects

```python
class AvaRundownMacroCollectionFactory(Factory)
```

Ava Rundown Macro Collection Factory

**C++ Source:**

- **Plugin**: Avalanche
- **Module**: AvalancheMediaEditor
- **File**: AvaRundownMacroCollectionFactory.h
