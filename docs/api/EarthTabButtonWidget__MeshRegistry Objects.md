## EarthTabButtonWidget\_MeshRegistry Objects

```python
class EarthTabButtonWidget_MeshRegistry(EarthTabButtonWidget)
```

Earth Tab Button Widget Mesh Registry

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: EarthTabButton_MeshRegistry.h
...
<a id="unreal.EarthTabButtonWidget_MeshRegistry.execute_command"></a>
...
<a id="unreal.EarthTabListWidget"></a>