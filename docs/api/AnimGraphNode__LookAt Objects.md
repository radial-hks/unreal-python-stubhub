## AnimGraphNode\_LookAt Objects

```python
class AnimGraphNode_LookAt(AnimGraphNode_SkeletalControlBase)
```
...
- ``node`` (AnimNode_LookAt):  [Read-Write]
...
<a id="unreal.AnimGraphNode_MakeDynamicAdditive"></a>