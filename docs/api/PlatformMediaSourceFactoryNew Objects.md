## PlatformMediaSourceFactoryNew Objects

```python
class PlatformMediaSourceFactoryNew(Factory)
```
...
- **File**: PlatformMediaSourceFactoryNew.h
...
<a id="unreal.StreamMediaSourceFactoryNew"></a>