## Basic3DPointSetComponent Objects

```python
class Basic3DPointSetComponent(BasicPointSetComponentBase)
```
...
<a id="unreal.BasicTriangleSetComponentBase"></a>