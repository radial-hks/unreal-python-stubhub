## AnimGraphNode\_MultiWayBlend Objects

```python
class AnimGraphNode_MultiWayBlend(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_MultiWayBlend.h
...
- ``node`` (AnimNode_MultiWayBlend):  [Read-Write]
...
<a id="unreal.AnimGraphNode_ObserveBone"></a>