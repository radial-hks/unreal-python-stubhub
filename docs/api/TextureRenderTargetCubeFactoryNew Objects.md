## TextureRenderTargetCubeFactoryNew Objects

```python
class TextureRenderTargetCubeFactoryNew(Factory)
```
...
- **Module**: UnrealEd
- **File**: TextureRenderTargetCubeFactoryNew.h
...
<a id="unreal.TextureRenderTargetFactoryNew"></a>