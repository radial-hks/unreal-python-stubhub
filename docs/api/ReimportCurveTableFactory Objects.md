## ReimportCurveTableFactory Objects

```python
class ReimportCurveTableFactory(CSVImportFactory)
```
...
- **Module**: UnrealEd
- **File**: ReimportCurveTableFactory.h
...
<a id="unreal.ReimportDataTableFactory"></a>