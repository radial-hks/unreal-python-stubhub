...
- ``capture_component2d`` (SceneCaptureComponent2D):  [Read-Only] Scene capture component.
...
```python
@property
def capture_component2d() -> SceneCaptureComponent2D
```
...
<a id="unreal.SceneCaptureComponent2D"></a>