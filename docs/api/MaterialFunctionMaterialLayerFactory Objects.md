## MaterialFunctionMaterialLayerFactory Objects

```python
class MaterialFunctionMaterialLayerFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: MaterialFunctionMaterialLayerFactory.h
...
<a id="unreal.MaterialImportHelpers"></a>