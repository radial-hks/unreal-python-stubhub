## EarthPropertyItem\_StringArray Objects

```python
class EarthPropertyItem_StringArray(EarthPropertyItemWidget)
```

Earth Property Item String Array

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: EarthPropertyItem_StringArray.h
...
<a id="unreal.EarthPropertyItem_StringArray.set_display_names"></a>

#### set\_display\_names

```python
def set_display_names(display_names: Array[str]) -> None
```

x.set_display_names(display_names) -> None
Set Display Names

Args:
    display_names (Array[str]):

<a id="unreal.EarthPropertyItem_StringArray.get_display_names"></a>
...
<a id="unreal.EarthPropertyItem_TextureArray"></a>