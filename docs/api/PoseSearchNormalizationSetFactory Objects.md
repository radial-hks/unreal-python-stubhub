## PoseSearchNormalizationSetFactory Objects

```python
class PoseSearchNormalizationSetFactory(Factory)
```

Pose Search Normalization Set Factory

**C++ Source:**

- **Plugin**: PoseSearch
- **Module**: PoseSearchEditor
- **File**: PoseSearchNormalizationSetFactory.h
...
<a id="unreal.PoseSearchSchemaFactory"></a>