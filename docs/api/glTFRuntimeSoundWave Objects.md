## glTFRuntimeSoundWave Objects

```python
class glTFRuntimeSoundWave(SoundWave)
```

Gl TFRuntime Sound Wave

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: glTFRuntime
- **File**: glTFRuntimeSoundWave.h
...
<a id="unreal.TestBTDecorator_Blueprint"></a>