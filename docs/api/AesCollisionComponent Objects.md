## AesCollisionComponent Objects

```python
class AesCollisionComponent(AesCollisionComponentBase)
```

Aes Collision Component

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesRenderResource
- **File**: AesCollisionComponent.h
...
<a id="unreal.AesCollisionComponent.override_wireframe_color"></a>
...
<a id="unreal.AesCollisionComponent.wireframe_color_override"></a>
...
<a id="unreal.AesCollisionComponent.local_bounds"></a>
...
<a id="unreal.AesCollisionComponent.vertex_buffer"></a>
...
<a id="unreal.AesCollisionComponent.index_buffer"></a>
...
<a id="unreal.AesDynamicMeshComponent"></a>