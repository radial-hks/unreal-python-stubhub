## CreateRastersParams Objects

```python
class CreateRastersParams(StructBase)
```

Create Rasters Params
...
<a id="unreal.CreateRastersParams.__init__"></a>
...
<a id="unreal.CreateRastersParams.coord_z_ref"></a>
...
<a id="unreal.CreateRastersParams.coord_z"></a>
...
<a id="unreal.CreateRastersParams.raster_style"></a>
...
<a id="unreal.CreateRasterParams_Batch"></a>