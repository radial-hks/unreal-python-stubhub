## GeometryCollectionFactory Objects

```python
class GeometryCollectionFactory(Factory)
```
...
- **File**: GeometryCollectionFactory.h
...
<a id="unreal.MovieSceneGeometryCollectionSection"></a>