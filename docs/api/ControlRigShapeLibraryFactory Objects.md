## ControlRigShapeLibraryFactory Objects

```python
class ControlRigShapeLibraryFactory(Factory)
```
...
- **File**: ControlRigGizmoLibraryFactory.h
...
<a id="unreal.ControlRigSequencerLibrary"></a>