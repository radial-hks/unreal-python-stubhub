## LandscapeSplinesComponent Objects

```python
class LandscapeSplinesComponent(PrimitiveComponent)
```
...
- **Module**: Landscape
- **File**: LandscapeSplinesComponent.h
...
<a id="unreal.LandscapeSplineControlPoint"></a>