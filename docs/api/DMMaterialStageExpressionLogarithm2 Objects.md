## DMMaterialStageExpressionLogarithm2 Objects

```python
class DMMaterialStageExpressionLogarithm2(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionMax"></a>