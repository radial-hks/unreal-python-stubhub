## AnimGraphNode\_LegIK Objects

```python
class AnimGraphNode_LegIK(AnimGraphNode_SkeletalControlBase)
```
...
- ``node`` (AnimNode_LegIK):  [Read-Write]
...
<a id="unreal.AnimGraphNode_LinkedAnimGraphBase"></a>