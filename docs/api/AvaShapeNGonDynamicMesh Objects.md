## AvaShapeNGonDynamicMesh Objects

```python
class AvaShapeNGonDynamicMesh(AvaShapeRoundedPolygonDynamicMesh)
```
...
<a id="unreal.AvaShapeNGonDynamicMesh.num_sides"></a>
...
<a id="unreal.AvaToolboxNGonDynamicMesh"></a>