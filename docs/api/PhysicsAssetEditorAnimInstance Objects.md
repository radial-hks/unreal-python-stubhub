## PhysicsAssetEditorAnimInstance Objects

```python
class PhysicsAssetEditorAnimInstance(AnimPreviewInstance)
```

Physics Asset Editor Anim Instance

**C++ Source:**

- **Module**: PhysicsAssetEditor
- **File**: PhysicsAssetEditorAnimInstance.h
...
<a id="unreal.PhysicsAssetEditorPhysicsHandleComponent"></a>