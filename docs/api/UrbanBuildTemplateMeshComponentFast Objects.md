## UrbanBuildTemplateMeshComponentFast Objects

```python
class UrbanBuildTemplateMeshComponentFast(MeshComponent)
```

Urban Build Template Mesh Component Fast

**C++ Source:**

- **Plugin**: AesBuilderCommon
- **Module**: UrbanBaseBuilder
- **File**: UrbanBuildTemplateMeshComponent.h
...
- ``build_settings`` (MeshBuildSettings):  [Read-Write]
...
- ``mesh_mobility`` (ComponentMobility):  [Read-Write]
...
<a id="unreal.UrbanBuildTemplateMeshComponentFast.mesh_mobility"></a>

#### mesh\_mobility

```python
@property
def mesh_mobility() -> ComponentMobility
```

(ComponentMobility):  [Read-Only]

<a id="unreal.UrbanBuildDataAsset"></a>