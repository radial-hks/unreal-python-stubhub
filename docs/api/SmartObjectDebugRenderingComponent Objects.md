## SmartObjectDebugRenderingComponent Objects

```python
class SmartObjectDebugRenderingComponent(DebugDrawComponent)
```
...
- **File**: SmartObjectDebugRenderingComponent.h
...
<a id="unreal.SmartObjectDefinition"></a>