## AnimGraphNode\_CopyBoneDelta Objects

```python
class AnimGraphNode_CopyBoneDelta(AnimGraphNode_SkeletalControlBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_CopyBoneDelta.h
...
- ``node`` (AnimNode_CopyBoneDelta):  [Read-Write]
...
<a id="unreal.AnimGraphNode_CopyPoseFromMesh"></a>