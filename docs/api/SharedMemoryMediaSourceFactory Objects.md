## SharedMemoryMediaSourceFactory Objects

```python
class SharedMemoryMediaSourceFactory(Factory)
```
...
- **File**: SharedMemoryMediaSourceFactory.h
...
<a id="unreal.DisplayClusterMoviePipelineSettings"></a>