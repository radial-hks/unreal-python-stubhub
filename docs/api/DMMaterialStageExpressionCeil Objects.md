## DMMaterialStageExpressionCeil Objects

```python
class DMMaterialStageExpressionCeil(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionClamp"></a>