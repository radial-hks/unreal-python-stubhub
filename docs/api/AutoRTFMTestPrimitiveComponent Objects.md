## AutoRTFMTestPrimitiveComponent Objects

```python
class AutoRTFMTestPrimitiveComponent(PrimitiveComponent)
```

Auto RTFMTest Primitive Component

**C++ Source:**

- **Module**: Engine
- **File**: AutoRTFMTestPrimitiveComponent.h
