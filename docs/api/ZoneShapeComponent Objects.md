## ZoneShapeComponent Objects

```python
class ZoneShapeComponent(PrimitiveComponent)
```
...
- ``per_point_lane_profiles`` (Array[ZoneLaneProfileRef]):  [Read-Only] Array of lane templates indexed by the points when the shape is polygon.
...
<a id="unreal.ZoneShapeComponent.lane_profile"></a>
...
<a id="unreal.ZoneShapeComponent.lane_template"></a>

#### lane\_template

```python
@property
def lane_template() -> ZoneLaneProfileRef
```
...
def lane_template(value: ZoneLaneProfileRef) -> None
```

<a id="unreal.ZoneShapeComponent.reverse_lane_profile"></a>
...
<a id="unreal.ZoneShapeComponent.points"></a>
...
<a id="unreal.ZoneShapeComponent.shape_type"></a>
...
<a id="unreal.ZoneShapeComponent.polygon_routing_type"></a>
...
<a id="unreal.ZoneShapeComponent.tags"></a>
...
<a id="unreal.ZoneShapeComponent.set_tags"></a>

#### set\_tags

```python
def set_tags(new_tags: ZoneGraphTagMask) -> None
```

x.set_tags(new_tags) -> None
Sets shape tags.

Args:
    new_tags (ZoneGraphTagMask): New tags to set.

<a id="unreal.ZoneShapeComponent.set_shape_type"></a>

#### set\_shape\_type

```python
def set_shape_type(type: FZoneShapeType) -> None
```

x.set_shape_type(type) -> None
Sets shape type.

Args:
    type (FZoneShapeType): New shape type.

<a id="unreal.ZoneShapeComponent.set_reverse_lane_profile"></a>

#### set\_reverse\_lane\_profile

```python
def set_reverse_lane_profile(reverse: bool) -> bool
```

x.set_reverse_lane_profile(reverse) -> bool
Set whether common lane profile should be reversed.

Args:
    reverse (bool): Reverse state

Returns:
    bool: Newly set reversed state.

<a id="unreal.ZoneShapeComponent.set_polygon_routing_type"></a>

#### set\_polygon\_routing\_type

```python
def set_polygon_routing_type(new_type: ZoneShapePolygonRoutingType) -> None
```

x.set_polygon_routing_type(new_type) -> None
Sets the polygon routing type.

Args:
    new_type (ZoneShapePolygonRoutingType):

<a id="unreal.ZoneShapeComponent.is_lane_profile_reversed"></a>

#### is\_lane\_profile\_reversed

```python
def is_lane_profile_reversed() -> bool
```

x.is_lane_profile_reversed() -> bool


Returns:
    bool: True if common lane profile is reversed.

<a id="unreal.ZoneShapeComponent.get_tags"></a>

#### get\_tags

```python
def get_tags() -> ZoneGraphTagMask
```

x.get_tags() -> ZoneGraphTagMask


Returns:
    ZoneGraphTagMask: Shape's tags.

<a id="unreal.ZoneShapeComponent.get_shape_type"></a>

#### get\_shape\_type

```python
def get_shape_type() -> FZoneShapeType
```

x.get_shape_type() -> FZoneShapeType


Returns:
    FZoneShapeType: Shape type.

<a id="unreal.EarthBoxComponent"></a>