## PaperSpriteActor Objects

```python
class PaperSpriteActor(Actor)
```
...
- ``render_component`` (PaperSpriteComponent):  [Read-Only]
...
```python
@property
def render_component() -> PaperSpriteComponent
```

(PaperSpriteComponent):  [Read-Only]

<a id="unreal.PaperRenderActor"></a>