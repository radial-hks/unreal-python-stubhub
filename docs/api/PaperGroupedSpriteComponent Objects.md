## PaperGroupedSpriteComponent Objects

```python
class PaperGroupedSpriteComponent(MeshComponent)
```
...
- ``per_instance_sprite_data`` (Array[SpriteInstanceData]):  [Read-Write] Array of instances
...
def update_instance_transform(instance_index: int,
                              ...
                              mark_render_state_dirty: bool = True,
...
def update_instance_color(instance_index: int,
                          ...
                          mark_render_state_dirty: bool = True) -> bool
```
...
def add_instance(
        ...
        sprite: PaperSprite,
        world_space: bool = False,
        color: LinearColor = [1.000000, 1.000000, 1.000000, 1.000000]) -> int
```

x.add_instance(transform, sprite, world_space=False, color=[1.000000, 1.000000, 1.000000, 1.000000]) -> int32
