## InsightsSkeletalMeshComponent Objects

```python
class InsightsSkeletalMeshComponent(SkeletalMeshComponent)
```

Insights Skeletal Mesh Component

**C++ Source:**

- **Plugin**: GameplayInsights
- **Module**: GameplayInsightsEditor
- **File**: InsightsSkeletalMeshComponent.h
...
<a id="unreal.AnimGraphNode_MotionMatching"></a>