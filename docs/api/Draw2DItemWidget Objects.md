## Draw2DItemWidget Objects

```python
class Draw2DItemWidget(UserWidget)
```
...
- **Module**: WdpPickAction
- **File**: Draw2DItemWidget.h
...
- ``style`` (RectangleStyle):  [Read-Only]
...
<a id="unreal.Draw2DItemWidget.box_arr"></a>

#### box\_arr

```python
@property
def box_arr() -> Array[Box2D]
```

(Array[Box2D]):  [Read-Only]

<a id="unreal.Draw2DItemWidget.style"></a>

#### style

```python
@property
def style() -> RectangleStyle
```

(RectangleStyle):  [Read-Only]

<a id="unreal.Draw2DItemWidget.get_lines"></a>

#### get\_lines

```python
def get_lines() -> Array[Vector2D]
```

x.get_lines() -> Array[Vector2D]
Get Lines

Returns:
    Array[Vector2D]:

<a id="unreal.RectPickActionParams"></a>