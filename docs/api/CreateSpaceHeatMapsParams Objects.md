## CreateSpaceHeatMapsParams Objects

```python
class CreateSpaceHeatMapsParams(StructBase)
```

Create Space Heat Maps Params
...
<a id="unreal.CreateSpaceHeatMapsParams.__init__"></a>
...
<a id="unreal.CreateSpaceHeatMapsParams.coord_z_ref"></a>
...
<a id="unreal.CreateSpaceHeatMapsParams.space_heat_map_style"></a>
...
<a id="unreal.CreateSpaceHeatMapsParams.space_heat_map_data"></a>
...
<a id="unreal.CreateSpaceHeatMapParams_Batch"></a>