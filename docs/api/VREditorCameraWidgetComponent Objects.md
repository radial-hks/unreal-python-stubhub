## VREditorCameraWidgetComponent Objects

```python
class VREditorCameraWidgetComponent(VREditorWidgetComponent)
```
...
- **Module**: VREditor
- **File**: VREditorCameraWidgetComponent.h
...
<a id="unreal.VREditorFloatingUI"></a>