## EarthWeightedSubAssetInfo Objects

```python
class EarthWeightedSubAssetInfo(EarthSubAssetInfo)
```
...
<a id="unreal.EarthWeightedSubAssetInfo.__init__"></a>
...
<a id="unreal.EarthWeightedSubAssetInfo.weight"></a>
...
<a id="unreal.EarthRoadSubAssetInfo"></a>