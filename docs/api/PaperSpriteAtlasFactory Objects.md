## PaperSpriteAtlasFactory Objects

```python
class PaperSpriteAtlasFactory(Factory)
```

Paper Sprite Atlas Factory

**C++ Source:**

- **Plugin**: Paper2D
- **Module**: Paper2DEditor
- **File**: PaperSpriteAtlasFactory.h
...
<a id="unreal.PaperFlipbookFactory"></a>