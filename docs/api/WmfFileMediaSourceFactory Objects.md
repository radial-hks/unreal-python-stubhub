## WmfFileMediaSourceFactory Objects

```python
class WmfFileMediaSourceFactory(Factory)
```
...
- **Plugin**: WmfMedia
- **Module**: WmfMediaEditor
- **File**: WmfFileMediaSourceFactory.h
...
<a id="unreal.CameraAnimationSequenceFactoryNew"></a>