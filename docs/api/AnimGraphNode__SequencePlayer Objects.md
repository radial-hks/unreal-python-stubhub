## AnimGraphNode\_SequencePlayer Objects

```python
class AnimGraphNode_SequencePlayer(AnimGraphNode_AssetPlayerBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_SequencePlayer.h
...
- ``node`` (AnimNode_SequencePlayer):  [Read-Write]
...
<a id="unreal.AnimGraphNode_Slot"></a>