## Basic3DLineSetComponent Objects

```python
class Basic3DLineSetComponent(BasicLineSetComponentBase)
```
...
<a id="unreal.BasicPointSetComponentBase"></a>