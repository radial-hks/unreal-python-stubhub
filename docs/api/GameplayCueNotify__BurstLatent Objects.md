## GameplayCueNotify\_BurstLatent Objects

```python
class GameplayCueNotify_BurstLatent(GameplayCueNotify_Actor)
```
...
- **File**: GameplayCueNotify_BurstLatent.h
...
- ``burst_spawn_results`` (GameplayCueNotify_SpawnResult):  [Read-Write] Results of spawned burst effects.
...
<a id="unreal.GameplayCueNotify_BurstLatent.default_spawn_condition"></a>
...
<a id="unreal.GameplayCueNotify_BurstLatent.default_placement_info"></a>
...
<a id="unreal.GameplayCueNotify_BurstLatent.burst_effects"></a>
...
<a id="unreal.GameplayCueNotify_BurstLatent.burst_spawn_results"></a>

#### burst\_spawn\_results

```python
@property
def burst_spawn_results() -> GameplayCueNotify_SpawnResult
```

(GameplayCueNotify_SpawnResult):  [Read-Only] Results of spawned burst effects.

<a id="unreal.GameplayCueNotify_BurstLatent.on_burst"></a>
...
<a id="unreal.GameplayCueNotify_HitImpact"></a>