## MagicGISInstancedStaticMeshComponent Objects

```python
class MagicGISInstancedStaticMeshComponent(InstancedStaticMeshComponent)
```

Magic GISInstanced Static Mesh Component

**C++ Source:**

- **Plugin**: GISDataAPI
- **Module**: MagicGISCore
- **File**: MagicGISInstancedStaticMeshComponent.h
...
<a id="unreal.MagicGISLineDecalComponent"></a>