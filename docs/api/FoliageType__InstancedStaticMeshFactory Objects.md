## FoliageType\_InstancedStaticMeshFactory Objects

```python
class FoliageType_InstancedStaticMeshFactory(Factory)
```
...
<a id="unreal.FoliageType_ActorFactory"></a>