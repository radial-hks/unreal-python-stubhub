## NavMeshRenderingComponent Objects

```python
class NavMeshRenderingComponent(DebugDrawComponent)
```
...
- **File**: NavMeshRenderingComponent.h
...
<a id="unreal.NavTestRenderingComponent"></a>