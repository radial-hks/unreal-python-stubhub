## AesModularBuildingAssetActor Objects

```python
class AesModularBuildingAssetActor(AesAssetActorBase)
```
...
- **Plugin**: AesWorld
- **Module**: AesAsset
- **File**: AesModularBuildingAssetActor.h
...
- ``save_outlines`` (bool):  [Read-Write] 是否将轮廓线点位保存到库中
...
<a id="unreal.AesModularBuildingAssetActor.tag_data"></a>
...
<a id="unreal.AesModularBuildingAssetActor.save_outlines"></a>

#### save\_outlines

```python
@property
def save_outlines() -> bool
```

(bool):  [Read-Write] 是否将轮廓线点位保存到库中
...
```python
@save_outlines.setter
def save_outlines(value: bool) -> None
```

<a id="unreal.AesModularBuildingAssetActor.load_data_from_asset"></a>

#### load\_data\_from\_asset

```python
def load_data_from_asset() -> None
```

x.load_data_from_asset() -> None
Load Data from Asset

<a id="unreal.AesObjectAssetActor"></a>