## AnimGraphNode\_PoseSnapshot Objects

```python
class AnimGraphNode_PoseSnapshot(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_PoseSnapshot.h
...
- ``node`` (AnimNode_PoseSnapshot):  [Read-Write]
...
<a id="unreal.AnimGraphNode_RandomPlayer"></a>