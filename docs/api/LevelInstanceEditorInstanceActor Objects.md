## LevelInstanceEditorInstanceActor Objects

```python
class LevelInstanceEditorInstanceActor(Actor)
```
...
- **Module**: Engine
- **File**: LevelInstanceEditorInstanceActor.h
...
<a id="unreal.LevelStreamingLevelInstanceEditor"></a>