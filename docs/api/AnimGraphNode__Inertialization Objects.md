## AnimGraphNode\_Inertialization Objects

```python
class AnimGraphNode_Inertialization(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_Inertialization.h
...
- ``node`` (AnimNode_Inertialization):  [Read-Write]
...
<a id="unreal.AnimGraphNode_LayeredBoneBlend"></a>