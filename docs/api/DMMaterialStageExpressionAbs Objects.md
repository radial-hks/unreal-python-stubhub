## DMMaterialStageExpressionAbs Objects

```python
class DMMaterialStageExpressionAbs(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionActorPositionWS"></a>