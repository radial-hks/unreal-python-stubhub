## SmartObjectSubsystemRenderingComponent Objects

```python
class SmartObjectSubsystemRenderingComponent(SmartObjectDebugRenderingComponent
                                             )
```
...
- **File**: SmartObjectSubsystemRenderingActor.h
...
<a id="unreal.SmartObjectSubsystemRenderingActor"></a>