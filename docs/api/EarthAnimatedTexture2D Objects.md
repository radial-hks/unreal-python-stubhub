## EarthAnimatedTexture2D Objects

```python
class EarthAnimatedTexture2D(Texture)
```

Earth Animated Texture 2D

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: EarthAnimatedTexture
- **File**: EarthAnimatedTexture2D.h
...
<a id="unreal.EarthAnimatedTexture2D.address_x"></a>
...
<a id="unreal.EarthAnimatedTexture2D.address_y"></a>
...
<a id="unreal.EarthAnimatedTexture2D.supports_transparency"></a>
...
<a id="unreal.EarthAnimatedTexture2D.default_frame_delay"></a>
...
<a id="unreal.EarthAnimatedTexture2D.play_rate"></a>
...
<a id="unreal.EarthAnimatedTexture2D.looping"></a>
...
<a id="unreal.EarthAnimatedTexture2D.stop"></a>
...
<a id="unreal.EarthAnimatedTexture2D.set_play_rate"></a>
...
<a id="unreal.EarthAnimatedTexture2D.set_looping"></a>
...
<a id="unreal.EarthAnimatedTexture2D.play_from_start"></a>
...
<a id="unreal.EarthAnimatedTexture2D.play"></a>
...
<a id="unreal.EarthAnimatedTexture2D.is_playing"></a>
...
<a id="unreal.EarthAnimatedTexture2D.is_looping"></a>
...
<a id="unreal.EarthAnimatedTexture2D.get_play_rate"></a>
...
<a id="unreal.EarthAnimatedTexture2D.get_animation_length"></a>
...
<a id="unreal.AnimatedTexture2D"></a>