## Covering3DWidgetComponent Objects

```python
class Covering3DWidgetComponent(MeshComponent)
```
...
- ``blend_mode`` (CoveringWidgetBlendMode):  [Read-Write] The blend mode for the widget.
...
- ``geometry_mode`` (CoveringWidgetGeometryMode):  [Read-Write] Controls the geometry of the widget component. See ECoveringWidgetGeometryMode.
...
- ``space`` (CoveringWidgetSpace):  [Read-Write] The coordinate space in which to render the widget
...
- ``tick_mode`` (CoveringTickMode):  [Read-Write]
- ``tick_when_offscreen`` (bool):  [Read-Write] Should the component tick the widget when it's off screen?
- ``timing_policy`` (CoveringWidgetTimingPolicy):  [Read-Write] How this widget should deal with timing, pausing, etc.
...
- ``window_visibility`` (CoveringWindowVisibility):  [Read-Write] The visibility of the virtual window created to host the widget

<a id="unreal.Covering3DWidgetComponent.set_window_visibility"></a>

#### set\_window\_visibility

```python
def set_window_visibility(visibility: CoveringWindowVisibility) -> None
```
...
Args:
    visibility (CoveringWindowVisibility):

<a id="unreal.Covering3DWidgetComponent.set_window_focusable"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_widget_space"></a>

#### set\_widget\_space

```python
def set_widget_space(new_space: CoveringWidgetSpace) -> None
```
...
Args:
    new_space (CoveringWidgetSpace):

<a id="unreal.Covering3DWidgetComponent.set_widget"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_two_sided"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_tint_color_and_opacity"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_tick_when_offscreen"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_tick_mode"></a>

#### set\_tick\_mode

```python
def set_tick_mode(tick_mode: CoveringTickMode) -> None
```
...
Args:
    tick_mode (CoveringTickMode):

<a id="unreal.Covering3DWidgetComponent.set_redraw_time"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_pivot"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_owner_player"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_manually_redraw"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_geometry_mode"></a>

#### set\_geometry\_mode

```python
def set_geometry_mode(geometry_mode: CoveringWidgetGeometryMode) -> None
```
...
Args:
    geometry_mode (CoveringWidgetGeometryMode):

<a id="unreal.Covering3DWidgetComponent.set_draw_size"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_draw_at_desired_size"></a>
...
<a id="unreal.Covering3DWidgetComponent.set_cylinder_arc_angle"></a>
...
Defines the curvature of the widget component when using ECoveringWidgetGeometryMode::Cylinder; ignored otherwise.

Args:
    cylinder_arc_angle (float):

<a id="unreal.Covering3DWidgetComponent.set_background_color"></a>
...
Sets the background color and opacity scale for this widget

Args:
    new_background_color (LinearColor):

<a id="unreal.Covering3DWidgetComponent.request_redraw"></a>
...
<a id="unreal.Covering3DWidgetComponent.is_widget_visible"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_window_visibility"></a>

#### get\_window\_visibility

```python
def get_window_visibility() -> CoveringWindowVisibility
```

x.get_window_visibility() -> CoveringWindowVisibility
Gets the visibility of the virtual window created to host the widget focusable.

Returns:
    CoveringWindowVisibility:

<a id="unreal.Covering3DWidgetComponent.get_window_focusable"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_widget_space"></a>

#### get\_widget\_space

```python
def get_widget_space() -> CoveringWidgetSpace
```

x.get_widget_space() -> CoveringWidgetSpace
Get Widget Space

Returns:
    CoveringWidgetSpace:

<a id="unreal.Covering3DWidgetComponent.get_widget"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_user_widget_object"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_two_sided"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_tick_when_offscreen"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_render_target"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_redraw_time"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_pivot"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_owner_player"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_material_instance"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_manually_redraw"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_geometry_mode"></a>

#### get\_geometry\_mode

```python
def get_geometry_mode() -> CoveringWidgetGeometryMode
```

x.get_geometry_mode() -> CoveringWidgetGeometryMode
See: ECoveringWidgetGeometryMode, See: GetCylinderArcAngle()

Returns:
    CoveringWidgetGeometryMode:

<a id="unreal.Covering3DWidgetComponent.get_draw_size"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_draw_at_desired_size"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_cylinder_arc_angle"></a>
...
<a id="unreal.Covering3DWidgetComponent.get_current_draw_size"></a>
...
<a id="unreal.Covering3DWidgetComponent.change_screen_layer"></a>

#### change\_screen\_layer

```python
def change_screen_layer(source_layer_name: Name,
                        target_layer_name: Name) -> None
```

x.change_screen_layer(source_layer_name, target_layer_name) -> None
Change Screen Layer
