## EarthGetLocation Objects

```python
class EarthGetLocation(UserWidget)
```
...
- ``location_text_block`` (EditableTextBox):  [Read-Write]
...
- ``search_location_button`` (Button):  [Read-Write]
- ``search_tips_list_view`` (ListView):  [Read-Write]
...
<a id="unreal.EarthGetLocation.location_text_block"></a>

#### location\_text\_block

```python
@property
def location_text_block() -> EditableTextBox
```

(EditableTextBox):  [Read-Write]
...
```python
@location_text_block.setter
def location_text_block(value: EditableTextBox) -> None
```

<a id="unreal.EarthGetLocation.search_tips_list_view"></a>

#### search\_tips\_list\_view

```python
@property
def search_tips_list_view() -> ListView
```

(ListView):  [Read-Only]

<a id="unreal.EarthGetLocation.search_location_button"></a>

#### search\_location\_button

```python
@property
def search_location_button() -> Button
```

(Button):  [Read-Only]

<a id="unreal.EarthGetLocationListView"></a>