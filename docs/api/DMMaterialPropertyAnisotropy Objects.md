## DMMaterialPropertyAnisotropy Objects

```python
class DMMaterialPropertyAnisotropy(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyBaseColor"></a>