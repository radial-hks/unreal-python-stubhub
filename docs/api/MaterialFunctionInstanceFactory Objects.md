## MaterialFunctionInstanceFactory Objects

```python
class MaterialFunctionInstanceFactory(Factory)
```
...
- **Module**: UnrealEd
- **File**: MaterialFunctionInstanceFactory.h
...
<a id="unreal.MaterialFunctionMaterialLayerInstanceFactory"></a>