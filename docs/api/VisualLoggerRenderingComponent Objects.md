## VisualLoggerRenderingComponent Objects

```python
class VisualLoggerRenderingComponent(DebugDrawComponent)
```
...
- **File**: VisualLoggerRenderingComponent.h
...
<a id="unreal.VisualLoggerCameraController"></a>