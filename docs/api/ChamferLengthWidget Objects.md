## ChamferLengthWidget Objects

```python
class ChamferLengthWidget(UserWidget)
```

Chamfer Length Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorMode
- **File**: ChamferLengthWidget.h
...
<a id="unreal.ChamferLengthWidget.set_chamfer_length"></a>

#### set\_chamfer\_length

```python
def set_chamfer_length(chamfer_length: float) -> None
```

x.set_chamfer_length(chamfer_length) -> None
Set Chamfer Length

Args:
    chamfer_length (double):

<a id="unreal.ChamferLengthWidget.get_chamfer_length"></a>

#### get\_chamfer\_length

```python
def get_chamfer_length() -> float
```

x.get_chamfer_length() -> double
Get Chamfer Length

Returns:
    double:

<a id="unreal.DrawSelectBoxWidget"></a>