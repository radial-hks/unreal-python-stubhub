## AnimGraphNode\_ModifyCurve Objects

```python
class AnimGraphNode_ModifyCurve(AnimGraphNode_Base)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_ModifyCurve.h
...
- ``node`` (AnimNode_ModifyCurve):  [Read-Write]
...
<a id="unreal.AnimGraphNode_MultiWayBlend"></a>