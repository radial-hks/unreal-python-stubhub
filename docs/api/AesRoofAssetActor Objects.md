## AesRoofAssetActor Objects

```python
class AesRoofAssetActor(AesAssetActorBase)
```
...
<a id="unreal.AesRoofAssetActor.tag_data"></a>
...
<a id="unreal.AesSlotAssetActor"></a>