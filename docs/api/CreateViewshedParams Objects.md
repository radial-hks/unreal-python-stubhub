## CreateViewshedParams Objects

```python
class CreateViewshedParams(ParamsBase)
```

Create Viewshed Params
...
<a id="unreal.CreateViewshedParams.__init__"></a>
...
<a id="unreal.CreateViewshedParams.point_entity_eid"></a>
...
<a id="unreal.CreateViewshedParams.coord_z_ref"></a>
...
<a id="unreal.CreateViewshedParams.viewshed_style"></a>
...
<a id="unreal.GetViewshedParams"></a>