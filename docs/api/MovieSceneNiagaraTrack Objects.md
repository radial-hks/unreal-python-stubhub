## MovieSceneNiagaraTrack Objects

```python
class MovieSceneNiagaraTrack(MovieSceneNameableTrack)
```
...
<a id="unreal.MovieSceneNiagaraSystemTrack"></a>