## EarthRegionOutline Objects

```python
class EarthRegionOutline(StructBase)
```
...
<a id="unreal.EarthRegionOutline.__init__"></a>
...
<a id="unreal.EarthRegionOutline.outline"></a>
...
<a id="unreal.EarthRegionOutline.hole"></a>
...
<a id="unreal.PrefabAssetNameAssets"></a>