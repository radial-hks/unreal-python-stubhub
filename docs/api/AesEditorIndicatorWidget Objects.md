## AesEditorIndicatorWidget Objects

```python
class AesEditorIndicatorWidget(UserWidget)
```

Aes Editor Indicator Widget

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorMode
- **File**: AesEditorIndicatorWidget.h
...
- ``glyph_image`` (Image):  [Read-Write]
- ``glyph_type`` (AesEditorIndicatorGlyphType):  [Read-Write]
...
- ``text`` (TextBlock):  [Read-Write]
- ``text_string`` (str):  [Read-Write]
...
<a id="unreal.AesEditorIndicatorWidget.glyph_image"></a>

#### glyph\_image

```python
@property
def glyph_image() -> Image
```
...
```python
@glyph_image.setter
def glyph_image(value: Image) -> None
```

<a id="unreal.AesEditorIndicatorWidget.text"></a>
...
```python
@text.setter
def text(value: TextBlock) -> None
```

<a id="unreal.AesEditorIndicatorWidget.glyph_type"></a>

#### glyph\_type

```python
@property
def glyph_type() -> AesEditorIndicatorGlyphType
```

(AesEditorIndicatorGlyphType):  [Read-Write]
...
```python
@glyph_type.setter
def glyph_type(value: AesEditorIndicatorGlyphType) -> None
```

<a id="unreal.AesEditorIndicatorWidget.text_string"></a>
...
<a id="unreal.AesHeightModifyGizmoInterface"></a>