## GeoLayerUpdateParams Objects

```python
class GeoLayerUpdateParams(ParamsBase)
```

Geo Layer Update Params
...
<a id="unreal.GeoLayerUpdateParams.__init__"></a>
...
<a id="unreal.GeoLayerUpdateParams.geo_layer_url"></a>
...
<a id="unreal.GeoLayerUpdateParams.geo_layer_params"></a>
...
<a id="unreal.GeoLayerUpdateParams.geo_feature_style"></a>
...
<a id="unreal.GeoLayerUpdateParams.geo_layer_symbol"></a>
...
<a id="unreal.GeoLayerUpdateParams.geo_layer_operation"></a>
...
<a id="unreal.GeoLayerInfoParams"></a>