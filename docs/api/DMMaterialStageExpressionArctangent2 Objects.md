## DMMaterialStageExpressionArctangent2 Objects

```python
class DMMaterialStageExpressionArctangent2(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionArctangent2Fast"></a>