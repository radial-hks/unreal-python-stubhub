## GetViewshedParams Objects

```python
class GetViewshedParams(ResultBase)
```
...
<a id="unreal.GetViewshedParams.__init__"></a>
...
<a id="unreal.GetViewshedParams.point_entity_eid"></a>
...
<a id="unreal.GetViewshedParams.coord_z_ref"></a>
...
<a id="unreal.GetViewshedParams.viewshed_style"></a>
...
<a id="unreal.CreateViewshedsParams"></a>