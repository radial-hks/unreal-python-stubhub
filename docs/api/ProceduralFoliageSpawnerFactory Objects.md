## ProceduralFoliageSpawnerFactory Objects

```python
class ProceduralFoliageSpawnerFactory(Factory)
```
...
- **Module**: FoliageEdit
- **File**: ProceduralFoliageSpawnerFactory.h
...
<a id="unreal.GizmoBaseComponent"></a>