...
- ``thruster_component`` (PhysicsThrusterComponent):  [Read-Only] Thruster component
...
```python
@property
def thruster_component() -> PhysicsThrusterComponent
```

(PhysicsThrusterComponent):  [Read-Only] Thruster component

<a id="unreal.RB_Thruster"></a>