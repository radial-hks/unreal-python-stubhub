## LandscapeMeshProxyComponent Objects

```python
class LandscapeMeshProxyComponent(StaticMeshComponent)
```
...
- **Module**: Landscape
- **File**: LandscapeMeshProxyComponent.h
...
<a id="unreal.LandscapeSplinesComponent"></a>