...
- ``decal`` (DecalComponent):  [Read-Only] The decal component for this decal actor
...
<a id="unreal.DecalActor.decal"></a>

#### decal

```python
@property
def decal() -> DecalComponent
```
