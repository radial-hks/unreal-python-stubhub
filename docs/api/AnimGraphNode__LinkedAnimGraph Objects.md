## AnimGraphNode\_LinkedAnimGraph Objects

```python
class AnimGraphNode_LinkedAnimGraph(AnimGraphNode_LinkedAnimGraphBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_LinkedAnimGraph.h
...
- ``node`` (AnimNode_LinkedAnimGraph):  [Read-Write]
...
<a id="unreal.AnimGraphNode_SubInstance"></a>