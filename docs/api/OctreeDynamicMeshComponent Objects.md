## OctreeDynamicMeshComponent Objects

```python
class OctreeDynamicMeshComponent(BaseDynamicMeshComponent)
```
...
- **File**: OctreeDynamicMeshComponent.h
...
<a id="unreal.LineSetComponent"></a>