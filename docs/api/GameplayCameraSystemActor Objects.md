## GameplayCameraSystemActor Objects

```python
class GameplayCameraSystemActor(Actor)
```
...
- **File**: GameplayCameraSystemActor.h
...
- ``camera_system_component`` (GameplayCameraSystemComponent):  [Read-Only]
...
```python
@property
def camera_system_component() -> GameplayCameraSystemComponent
```

(GameplayCameraSystemComponent):  [Read-Only]
...
```python
@classmethod
def get_auto_spawned_camera_system_actor(
        cls,
        player_controller: PlayerController,
        force_spawn: bool = False) -> GameplayCameraSystemActor
```

X.get_auto_spawned_camera_system_actor(player_controller, force_spawn=False) -> GameplayCameraSystemActor
...
```python
@classmethod
def auto_manage_active_view_target(
        cls, player_controller: PlayerController) -> None
```

X.auto_manage_active_view_target(player_controller) -> None
...
<a id="unreal.GameplayCameraSystemComponent"></a>