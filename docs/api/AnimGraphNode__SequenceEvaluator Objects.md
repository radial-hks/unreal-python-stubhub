## AnimGraphNode\_SequenceEvaluator Objects

```python
class AnimGraphNode_SequenceEvaluator(AnimGraphNode_AssetPlayerBase)
```
...
- **Module**: AnimGraph
- **File**: AnimGraphNode_SequenceEvaluator.h
...
- ``node`` (AnimNode_SequenceEvaluator):  [Read-Write]
...
<a id="unreal.AnimGraphNode_SequencePlayer"></a>