## AesObjectAssetActor Objects

```python
class AesObjectAssetActor(AesAssetActorBase)
```
...
<a id="unreal.AesObjectAssetActor.tag_data"></a>
...
<a id="unreal.AesObjectAssetActor.load_data_from_asset"></a>
...
<a id="unreal.AesObjectAssetCollector"></a>