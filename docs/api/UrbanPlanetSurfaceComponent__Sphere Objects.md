## UrbanPlanetSurfaceComponent\_Sphere Objects

```python
class UrbanPlanetSurfaceComponent_Sphere(UrbanPlanetSurfaceComponent)
```

Urban Planet Surface Component Sphere

**C++ Source:**

- **Plugin**: AesRuntime
- **Module**: UrbanPlanet
- **File**: UrbanPlanetSurfaceComponent_Sphere.h
...
<a id="unreal.UrbanModelerRender"></a>