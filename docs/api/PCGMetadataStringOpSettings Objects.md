## PCGMetadataStringOpSettings Objects

```python
class PCGMetadataStringOpSettings(PCGMetadataSettingsBase)
```
...
- ``operation`` (PCGMetadataStringOperation):  [Read-Write]
...
<a id="unreal.PCGMetadataStringOpSettings.operation"></a>

#### operation

```python
@property
def operation() -> PCGMetadataStringOperation
```

(PCGMetadataStringOperation):  [Read-Write]
...
```python
@operation.setter
def operation(value: PCGMetadataStringOperation) -> None
```

<a id="unreal.PCGMetadataStringOpSettings.input_source1"></a>
...
<a id="unreal.PCGMetadataStringOpSettings.input_source2"></a>
...
<a id="unreal.PCGMetadataStringOpSettings.input_source3"></a>
...
<a id="unreal.PCGMetadataTransformSettings"></a>