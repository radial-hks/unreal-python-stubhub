## CreateRealTimeVideoParams Objects

```python
class CreateRealTimeVideoParams(ParamsBase)
```

Create Real Time Video Params
...
<a id="unreal.CreateRealTimeVideoParams.__init__"></a>
...
<a id="unreal.CreateRealTimeVideoParams.point_entity_eid"></a>
...
<a id="unreal.CreateRealTimeVideoParams.real_time_video_style"></a>
...
<a id="unreal.CreateRealTimeVideoParams.coord_z_ref"></a>
...
<a id="unreal.GetRealTimeVideoParams"></a>