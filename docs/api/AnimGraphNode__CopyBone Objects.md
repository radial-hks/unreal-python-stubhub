## AnimGraphNode\_CopyBone Objects

```python
class AnimGraphNode_CopyBone(AnimGraphNode_SkeletalControlBase)
```
...
- ``node`` (AnimNode_CopyBone):  [Read-Write]
...
<a id="unreal.AnimGraphNode_CopyBoneDelta"></a>