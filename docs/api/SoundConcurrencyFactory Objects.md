## SoundConcurrencyFactory Objects

```python
class SoundConcurrencyFactory(Factory)
```

Sound Concurrency Factory

**C++ Source:**

- **Module**: AudioEditor
- **File**: SoundConcurrencyFactory.h
...
<a id="unreal.SoundCueFactoryNew"></a>