## AnimGraphNode_BlendStackInput Objects

```python
class AnimGraphNode_BlendStackInput(AnimGraphNode_Base)
```

Anim Graph Node Blend Stack Input

**C++ Source:**

- **Plugin**: BlendStack
- **Module**: BlendStackEditor
- **File**: AnimGraphNode_BlendStackInput.h
...
- ``node`` (AnimNode_BlendStackInput):  [Read-Write]
...
<a id="unreal.AnimGraphNode_BlendStackResult"></a>