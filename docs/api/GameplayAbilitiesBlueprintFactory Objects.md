## GameplayAbilitiesBlueprintFactory Objects

```python
class GameplayAbilitiesBlueprintFactory(Factory)
```

Gameplay Abilities Blueprint Factory

**C++ Source:**

- **Plugin**: GameplayAbilities
- **Module**: GameplayAbilitiesEditor
- **File**: GameplayAbilitiesBlueprintFactory.h
