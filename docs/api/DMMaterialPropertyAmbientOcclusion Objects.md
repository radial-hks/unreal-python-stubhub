## DMMaterialPropertyAmbientOcclusion Objects

```python
class DMMaterialPropertyAmbientOcclusion(DMMaterialProperty)
```
...
<a id="unreal.DMMaterialPropertyAnisotropy"></a>