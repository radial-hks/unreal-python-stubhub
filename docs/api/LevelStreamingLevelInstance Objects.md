## LevelStreamingLevelInstance Objects

```python
class LevelStreamingLevelInstance(LevelStreamingDynamic)
```

Level Streaming Level Instance

**C++ Source:**

- **Module**: Engine
- **File**: LevelInstanceLevelStreaming.h
...
<a id="unreal.LevelScriptActor"></a>