## UrbanEntityAssetFactory Objects

```python
class UrbanEntityAssetFactory(Factory)
```

Urban Entity Asset Factory

**C++ Source:**

- **Plugin**: AesEditor
- **Module**: UrbanEntityEditor
- **File**: UrbanEntityAssetFactory.h
...
<a id="unreal.UrbanEntityAssetManagerFactory"></a>