## PaperSpriteSheetImportFactory Objects

```python
class PaperSpriteSheetImportFactory(Factory)
```
...
- **File**: PaperSpriteSheetImportFactory.h
...
<a id="unreal.PaperSpriteSheetReimportFactory"></a>