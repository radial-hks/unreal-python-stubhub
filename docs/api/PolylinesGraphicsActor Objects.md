## PolylinesGraphicsActor Objects

```python
class PolylinesGraphicsActor(WdpStandardActorEntity)
```

Polylines Graphics Actor

**C++ Source:**

- **Plugin**: WdpDataModel
- **Module**: WdpGraphicsEntity
- **File**: PolylinesGraphicsActor.h
...
<a id="unreal.PolylinesGraphicsActor.set_polylines"></a>
...
<a id="unreal.PolylinesGraphicsActor.remove_polylines"></a>
...
<a id="unreal.PolylinesGraphicsActor.remove_entities"></a>
...
<a id="unreal.PolylinesGraphicsActor.get_polyline"></a>
...
<a id="unreal.PolylinesGraphicsActor.clear"></a>
...
<a id="unreal.PolylinesGraphicsActor.add_entities"></a>
...
x.add_entities(eids, coord_z_ref=Coord_Z_Ref.ALTITUDE) -> None
Add Entities
...
<a id="unreal.PolylinesGraphicsEntity"></a>