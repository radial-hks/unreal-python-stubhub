## DMMaterialStageExpressionClamp Objects

```python
class DMMaterialStageExpressionClamp(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionCosine"></a>