...
def world_origin_location_changed(old_origin_location: IntVector,
                                  new_origin_location: IntVector) -> None
```
...
def set_cinematic_mode(cinematic_mode: bool,
                       ...
                       affects_turning: bool = False) -> None
```
...
<a id="unreal.LightmassCharacterIndirectDetailVolume"></a>