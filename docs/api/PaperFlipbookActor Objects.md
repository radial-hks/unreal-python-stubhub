## PaperFlipbookActor Objects

```python
class PaperFlipbookActor(Actor)
```
...
- ``render_component`` (PaperFlipbookComponent):  [Read-Only]
...
```python
@property
def render_component() -> PaperFlipbookComponent
```

(PaperFlipbookComponent):  [Read-Only]

<a id="unreal.PaperFlipbookComponent"></a>