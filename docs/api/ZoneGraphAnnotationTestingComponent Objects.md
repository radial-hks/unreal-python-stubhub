## ZoneGraphAnnotationTestingComponent Objects

```python
class ZoneGraphAnnotationTestingComponent(DebugDrawComponent)
```
...
- ``tests`` (Array[ZoneGraphAnnotationTest]):  [Read-Write]
...
<a id="unreal.ZoneGraphBehaviorTestingComponent"></a>