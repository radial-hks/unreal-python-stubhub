## PCGProceduralISMComponent Objects

```python
class PCGProceduralISMComponent(StaticMeshComponent)
```
...
x.set_num_instances(num_instances) -> None
Set Num Instances
...
x.set_local_bounds(local_bounds) -> None
...
x.get_num_custom_data_floats() -> int32
Get Num Custom Data Floats
...
<a id="unreal.PCGManagedProceduralISMComponent"></a>