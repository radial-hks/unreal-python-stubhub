## PoseSearchDatabaseAnimMontage Objects

```python
class PoseSearchDatabaseAnimMontage(PoseSearchDatabaseAnimationAssetBase)
```
...
<a id="unreal.PoseSearchDatabaseAnimMontage.__init__"></a>
...
<a id="unreal.PoseSearchDatabaseMultiAnimAsset"></a>