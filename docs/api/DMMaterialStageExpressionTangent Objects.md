## DMMaterialStageExpressionTangent Objects

```python
class DMMaterialStageExpressionTangent(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionTextureCoordinate"></a>