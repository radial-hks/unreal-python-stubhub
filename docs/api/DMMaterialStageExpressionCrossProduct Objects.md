## DMMaterialStageExpressionCrossProduct Objects

```python
class DMMaterialStageExpressionCrossProduct(DMMaterialStageExpressionMathBase)
```
...
<a id="unreal.DMMaterialStageExpressionDeltaTime"></a>