## AndroidFileMediaSourceFactory Objects

```python
class AndroidFileMediaSourceFactory(Factory)
```
...
- **Plugin**: AndroidMedia
- **Module**: AndroidMediaEditor
- **File**: AndroidFileMediaSourceFactory.h
...
<a id="unreal.AvfFileMediaSourceFactory"></a>