## DisplayClusterLightCardStageActorComponent Objects

```python
class DisplayClusterLightCardStageActorComponent(
...
- **File**: DisplayClusterLightCardStageActorComponent.h
...
<a id="unreal.DisplayClusterOriginComponent"></a>