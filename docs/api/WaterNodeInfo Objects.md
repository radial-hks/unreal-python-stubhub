## WaterNodeInfo Objects

```python
class WaterNodeInfo(StructBase)
```
...
<a id="unreal.WaterNodeInfo.__init__"></a>
...
<a id="unreal.WaterNodeInfo.local_to_parent_transform"></a>
...
<a id="unreal.WaterNodeInfo.corner_radius"></a>
...
<a id="unreal.WaterNodeInfo.corner_split_seg_num"></a>
