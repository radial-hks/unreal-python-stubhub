## EarthPropertyItem\_TextureArray Objects

```python
class EarthPropertyItem_TextureArray(EarthPropertyItemWidget)
```

Earth Property Item Texture Array

**C++ Source:**

- **Plugin**: AesWorld
- **Module**: AesEditorUI
- **File**: EarthPropertyItem_TextureArray.h
...
<a id="unreal.EarthPropertyItem_TextureArray.set_texture_items"></a>

#### set\_texture\_items

```python
def set_texture_items(
        texture_items: Array[EarthPropertyTextureItemInfo]) -> None
```

x.set_texture_items(texture_items) -> None
Set Texture Items

Args:
    texture_items (Array[EarthPropertyTextureItemInfo]):

<a id="unreal.EarthPropertyItem_TextureArray.get_texture_items"></a>

#### get\_texture\_items

```python
def get_texture_items() -> Array[EarthPropertyTextureItemInfo]
```

x.get_texture_items() -> Array[EarthPropertyTextureItemInfo]
Get Texture Items

Returns:
    Array[EarthPropertyTextureItemInfo]:

<a id="unreal.EarthPropertyListWidget"></a>