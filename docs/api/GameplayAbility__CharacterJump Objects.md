## GameplayAbility\_CharacterJump Objects

```python
class GameplayAbility_CharacterJump(GameplayAbility)
```
...
- **File**: GameplayAbility_CharacterJump.h
...
<a id="unreal.GameplayAbility_Montage"></a>