## ProceduralFoliageBlockingVolume Objects

```python
class ProceduralFoliageBlockingVolume(Volume)
```
...
- **Module**: Foliage
- **File**: ProceduralFoliageBlockingVolume.h
...
- ``procedural_foliage_volume`` (ProceduralFoliageVolume):  [Read-Write]
...
<a id="unreal.ProceduralFoliageComponent"></a>