## InteractiveToolsPresetCollectionAssetFactory Objects

```python
class InteractiveToolsPresetCollectionAssetFactory(Factory)
```

Interactive Tools Preset Collection Asset Factory
