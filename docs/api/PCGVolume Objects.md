...
- ``pcg_component`` (PCGComponent):  [Read-Write]
...
```python
@property
def pcg_component() -> PCGComponent
```

(PCGComponent):  [Read-Write]
...
def pcg_component(value: PCGComponent) -> None
```

<a id="unreal.PCGWorldActor"></a>